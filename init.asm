...
create_vcs(void)
{
  ...
  int i, fd;
  char *dname = "vc0";
   6:	c7 45 f0 06 0a 00 00 	movl   $0xa06,-0x10(%ebp)
...
main(void)
{
  ...
  86:	00 
  87:	c7 04 24 0a 0a 00 00 	movl   $0xa0a,(%esp)
  ...
  a6:	00 
  a7:	c7 04 24 0a 0a 00 00 	movl   $0xa0a,(%esp)
  ae:	e8 75 03 00 00       	call   428 <mknod>
    open("console", O_RDWR);
  b3:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  ba:	00 
  bb:	c7 04 24 0a 0a 00 00 	movl   $0xa0a,(%esp)
  ...
  e4:	c7 44 24 04 12 0a 00 	movl   $0xa12,0x4(%esp)
  eb:	00 
  ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f3:	e8 45 05 00 00       	call   63d <printf>
    pid = fork();
 ...
 108:	c7 44 24 04 25 0a 00 	movl   $0xa25,0x4(%esp)
 10f:	00 
 110:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 117:	e8 21 05 00 00       	call   63d <printf>
      exit();
 ...
 126:	75 2d                	jne    155 <main+0xdf>
      exec("sh", argv);
 128:	c7 44 24 04 c4 0c 00 	movl   $0xcc4,0x4(%esp)
 12f:	00 
 130:	c7 04 24 03 0a 00 00 	movl   $0xa03,(%esp)
 137:	e8 dc 02 00 00       	call   418 <exec>
      printf(1, "init: exec sh failed\n");
 13c:	c7 44 24 04 38 0a 00 	movl   $0xa38,0x4(%esp)
 143:	00 
 144:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 14b:	e8 ed 04 00 00       	call   63d <printf>
      exit();
 ...
 155:	eb 14                	jmp    16b <main+0xf5>
      printf(1, "zombie!\n");
 157:	c7 44 24 04 4e 0a 00 	movl   $0xa4e,0x4(%esp)
 15e:	00 
 15f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 166:	e8 d2 04 00 00       	call   63d <printf>
    if(pid == 0){
      exec("sh", argv);
      printf(1, "init: exec sh failed\n");
      exit();
...
putc(int fd, char c)
{
 ...
 581:	e8 7a fe ff ff       	call   400 <write>
}
 586:	c9                   	leave  
 587:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5d9:	8a 80 cc 0c 00 00    	mov    0xccc(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 732:	75 09                	jne    73d <printf+0x100>
          s = "(null)";
 734:	c7 45 f4 57 0a 00 00 	movl   $0xa57,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7fb:	a1 e8 0c 00 00       	mov    0xce8,%eax
...
free(void *ap)
{
 ...
 8c6:	a3 e8 0c 00 00       	mov    %eax,0xce8
}
 8cb:	c9                   	leave  
 8cc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8ec:	e8 77 fb ff ff       	call   468 <sbrk>
 ...
 919:	e8 ce fe ff ff       	call   7ec <free>
  return freep;
 91e:	a1 e8 0c 00 00       	mov    0xce8,%eax
}
 923:	c9                   	leave  
 924:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 935:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 938:	a1 e8 0c 00 00       	mov    0xce8,%eax
 93d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 940:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 944:	75 23                	jne    969 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 946:	c7 45 f0 e0 0c 00 00 	movl   $0xce0,-0x10(%ebp)
 94d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 950:	a3 e8 0c 00 00       	mov    %eax,0xce8
 955:	a1 e8 0c 00 00       	mov    0xce8,%eax
 95a:	a3 e0 0c 00 00       	mov    %eax,0xce0
    base.s.size = 0;
 95f:	c7 05 e4 0c 00 00 00 	movl   $0x0,0xce4
 966:	00 00 00 
  }
 ...
 9bc:	a3 e8 0c 00 00       	mov    %eax,0xce8
      return (void*)(p + 1);
 ...
 9c7:	eb 38                	jmp    a01 <malloc+0xdc>
    ...
    if(p == freep)
 9c9:	a1 e8 0c 00 00       	mov    0xce8,%eax
