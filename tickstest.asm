...
main(int argc, char *argv[])
{
  ...
  if (argc != 2) {
   ...
   f:	c7 44 24 04 6b 09 00 	movl   $0x96b,0x4(%esp)
  16:	00 
  ...
  eb:	c7 44 24 04 a3 09 00 	movl   $0x9a3,0x4(%esp)
  f2:	00 
  f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fa:	e8 a6 04 00 00       	call   5a5 <printf>
...
putc(int fd, char c)
{
 ...
 4e9:	e8 8a fe ff ff       	call   378 <write>
}
 4ee:	c9                   	leave  
 4ef:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 541:	8a 80 fc 0b 00 00    	mov    0xbfc(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 69a:	75 09                	jne    6a5 <printf+0x100>
          s = "(null)";
 69c:	c7 45 f4 af 09 00 00 	movl   $0x9af,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 763:	a1 18 0c 00 00       	mov    0xc18,%eax
...
free(void *ap)
{
 ...
 82e:	a3 18 0c 00 00       	mov    %eax,0xc18
}
 833:	c9                   	leave  
 834:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 854:	e8 87 fb ff ff       	call   3e0 <sbrk>
 ...
 881:	e8 ce fe ff ff       	call   754 <free>
  return freep;
 886:	a1 18 0c 00 00       	mov    0xc18,%eax
}
 88b:	c9                   	leave  
 88c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 89d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8a0:	a1 18 0c 00 00       	mov    0xc18,%eax
 8a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8ac:	75 23                	jne    8d1 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 8ae:	c7 45 f0 10 0c 00 00 	movl   $0xc10,-0x10(%ebp)
 8b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8b8:	a3 18 0c 00 00       	mov    %eax,0xc18
 8bd:	a1 18 0c 00 00       	mov    0xc18,%eax
 8c2:	a3 10 0c 00 00       	mov    %eax,0xc10
    base.s.size = 0;
 8c7:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 8ce:	00 00 00 
  }
 ...
 924:	a3 18 0c 00 00       	mov    %eax,0xc18
      return (void*)(p + 1);
 ...
 92f:	eb 38                	jmp    969 <malloc+0xdc>
    ...
    if(p == freep)
 931:	a1 18 0c 00 00       	mov    0xc18,%eax
