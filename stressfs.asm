...
main(int argc, char *argv[])
{
  ...
  16:	bb 56 0a 00 00       	mov    $0xa56,%ebx
  ...
  28:	c7 44 24 04 33 0a 00 	movl   $0xa33,0x4(%esp)
  2f:	00 
  30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  37:	e8 31 06 00 00       	call   66d <printf>
  ...
  8c:	c7 44 24 04 46 0a 00 	movl   $0xa46,0x4(%esp)
  93:	00 
  94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  9b:	e8 cd 05 00 00       	call   66d <printf>
...
//    printf(fd, "%d\n", i);
 ...
 11e:	e8 05 03 00 00       	call   428 <close>
  ...
  printf(1, "read\n");
 123:	c7 44 24 04 50 0a 00 	movl   $0xa50,0x4(%esp)
 12a:	00 
 12b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 132:	e8 36 05 00 00       	call   66d <printf>
...
putc(int fd, char c)
{
 ...
 5b1:	e8 6a fe ff ff       	call   420 <write>
}
 5b6:	c9                   	leave  
 5b7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 609:	8a 80 b0 0c 00 00    	mov    0xcb0(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 762:	75 09                	jne    76d <printf+0x100>
          s = "(null)";
 764:	c7 45 f4 60 0a 00 00 	movl   $0xa60,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 82b:	a1 cc 0c 00 00       	mov    0xccc,%eax
...
free(void *ap)
{
 ...
 8f6:	a3 cc 0c 00 00       	mov    %eax,0xccc
}
 8fb:	c9                   	leave  
 8fc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 91c:	e8 67 fb ff ff       	call   488 <sbrk>
 ...
 949:	e8 ce fe ff ff       	call   81c <free>
  return freep;
 94e:	a1 cc 0c 00 00       	mov    0xccc,%eax
}
 953:	c9                   	leave  
 954:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 965:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 968:	a1 cc 0c 00 00       	mov    0xccc,%eax
 96d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 970:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 974:	75 23                	jne    999 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 976:	c7 45 f0 c4 0c 00 00 	movl   $0xcc4,-0x10(%ebp)
 97d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 980:	a3 cc 0c 00 00       	mov    %eax,0xccc
 985:	a1 cc 0c 00 00       	mov    0xccc,%eax
 98a:	a3 c4 0c 00 00       	mov    %eax,0xcc4
    base.s.size = 0;
 98f:	c7 05 c8 0c 00 00 00 	movl   $0x0,0xcc8
 996:	00 00 00 
  }
 ...
 9ec:	a3 cc 0c 00 00       	mov    %eax,0xccc
      return (void*)(p + 1);
 ...
 9f7:	eb 38                	jmp    a31 <malloc+0xdc>
    ...
    if(p == freep)
 9f9:	a1 cc 0c 00 00       	mov    0xccc,%eax
