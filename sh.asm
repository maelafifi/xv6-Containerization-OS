...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      76:	e8 de 10 00 00       	call   1159 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      c9:	e8 8b 10 00 00       	call   1159 <printf>
      exit();
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 64 15 00 	movl   $0x1564,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 34 0f 00 00       	call   1159 <printf>
  memset(buf, 0, nbuf);
     ...
     286:	eb 1f                	jmp    2a7 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     28f:	00 
     290:	c7 04 24 67 15 00 00 	movl   $0x1567,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ac:	a0 c0 1a 00 00       	mov    0x1ac0,%al
     2b1:	3c 63                	cmp    $0x63,%al
     2b3:	75 56                	jne    30b <main+0xa3>
     2b5:	a0 c1 1a 00 00       	mov    0x1ac1,%al
     2ba:	3c 64                	cmp    $0x64,%al
     2bc:	75 4d                	jne    30b <main+0xa3>
     2be:	a0 c2 1a 00 00       	mov    0x1ac2,%al
     2c3:	3c 20                	cmp    $0x20,%al
     2c5:	75 44                	jne    30b <main+0xa3>
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2c7:	c7 04 24 c0 1a 00 00 	movl   $0x1ac0,(%esp)
     2ce:	e8 98 0a 00 00       	call   d6b <strlen>
     2d3:	48                   	dec    %eax
     2d4:	c6 80 c0 1a 00 00 00 	movb   $0x0,0x1ac0(%eax)
      if(chdir(buf+3) < 0)
     2db:	c7 04 24 c3 1a 00 00 	movl   $0x1ac3,(%esp)
     2e2:	e8 bd 0c 00 00       	call   fa4 <chdir>
     2e7:	85 c0                	test   %eax,%eax
     2e9:	79 1e                	jns    309 <main+0xa1>
        printf(2, "cannot cd %s\n", buf+3);
     2eb:	c7 44 24 08 c3 1a 00 	movl   $0x1ac3,0x8(%esp)
     2f2:	00 
     2f3:	c7 44 24 04 6f 15 00 	movl   $0x156f,0x4(%esp)
     2fa:	00 
     2fb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     302:	e8 52 0e 00 00       	call   1159 <printf>
      continue;
    ...
    if(fork1() == 0)
     ...
     312:	75 14                	jne    328 <main+0xc0>
      runcmd(parsecmd(buf));
     314:	c7 04 24 c0 1a 00 00 	movl   $0x1ac0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     334:	00 
     335:	c7 04 24 c0 1a 00 00 	movl   $0x1ac0,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     35b:	c7 44 24 04 7d 15 00 	movl   $0x157d,0x4(%esp)
     362:	00 
     363:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     36a:	e8 ea 0d 00 00       	call   1159 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     388:	c7 04 24 81 15 00 00 	movl   $0x1581,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3a6:	e8 96 10 00 00       	call   1441 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3e4:	e8 58 10 00 00       	call   1441 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     44f:	e8 ed 0f 00 00       	call   1441 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     49f:	e8 9d 0f 00 00       	call   1441 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4ef:	e8 4d 0f 00 00       	call   1441 <malloc>
     ...
     539:	ff 45 f4             	incl   -0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     550:	c7 04 24 98 1a 00 00 	movl   $0x1a98,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5f2:	c7 04 24 98 1a 00 00 	movl   $0x1a98,(%esp)
     ...
     60e:	c7 04 24 9e 1a 00 00 	movl   $0x1a9e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     64a:	c7 04 24 98 1a 00 00 	movl   $0x1a98,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     68e:	c7 04 24 98 1a 00 00 	movl   $0x1a98,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     707:	c7 44 24 08 86 15 00 	movl   $0x1586,0x8(%esp)
     70e:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     730:	c7 44 24 04 87 15 00 	movl   $0x1587,0x4(%esp)
     737:	00 
     738:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     73f:	e8 15 0a 00 00       	call   1159 <printf>
    panic("syntax");
     744:	c7 04 24 96 15 00 00 	movl   $0x1596,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7b1:	c7 44 24 08 9d 15 00 	movl   $0x159d,0x8(%esp)
     7b8:	00 
  ...
  if(peek(ps, es, ";")){
     7cf:	c7 44 24 08 9f 15 00 	movl   $0x159f,0x8(%esp)
     7d6:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     853:	c7 44 24 08 a1 15 00 	movl   $0x15a1,0x8(%esp)
     85a:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     911:	c7 04 24 a3 15 00 00 	movl   $0x15a3,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9bd:	c7 44 24 08 c0 15 00 	movl   $0x15c0,0x8(%esp)
     9c4:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     9ea:	c7 44 24 08 c3 15 00 	movl   $0x15c3,0x8(%esp)
     9f1:	00 
    ...
    panic("parseblock");
     a08:	c7 04 24 c5 15 00 00 	movl   $0x15c5,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a4b:	c7 44 24 08 d0 15 00 	movl   $0x15d0,0x8(%esp)
     a52:	00 
    ...
    panic("syntax - missing )");
     a69:	c7 04 24 d2 15 00 00 	movl   $0x15d2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     abe:	c7 44 24 08 c3 15 00 	movl   $0x15c3,0x8(%esp)
     ac5:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b5b:	74 0c                	je     b69 <parseexec+0xb1>
      panic("syntax");
     b5d:	c7 04 24 96 15 00 00 	movl   $0x1596,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     b8d:	7e 0c                	jle    b9b <parseexec+0xe3>
      panic("too many args");
     b8f:	c7 04 24 e5 15 00 00 	movl   $0x15e5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bb7:	c7 44 24 08 f3 15 00 	movl   $0x15f3,0x8(%esp)
     bbe:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c21:	8b 04 85 f8 15 00 00 	mov    0x15f8(,%eax,4),%eax
     c28:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    109d:	e8 b2 fe ff ff       	call   f54 <write>
}
    10a2:	c9                   	leave  
    10a3:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    10ac:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    10b3:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    10b7:	74 17                	je     10d0 <printint+0x2c>
    10b9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    10bd:	79 11                	jns    10d0 <printint+0x2c>
    neg = 1;
    10bf:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    10c6:	8b 45 0c             	mov    0xc(%ebp),%eax
    10c9:	f7 d8                	neg    %eax
    10cb:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10ce:	eb 06                	jmp    10d6 <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    10d6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    10dd:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    10e0:	8d 41 01             	lea    0x1(%ecx),%eax
    10e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10e6:	8b 5d 10             	mov    0x10(%ebp),%ebx
    10e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10ec:	ba 00 00 00 00       	mov    $0x0,%edx
    10f1:	f7 f3                	div    %ebx
    10f3:	89 d0                	mov    %edx,%eax
    10f5:	8a 80 a8 1a 00 00    	mov    0x1aa8(%eax),%al
    10fb:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    10ff:	8b 75 10             	mov    0x10(%ebp),%esi
    1102:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1105:	ba 00 00 00 00       	mov    $0x0,%edx
    110a:	f7 f6                	div    %esi
    110c:	89 45 ec             	mov    %eax,-0x14(%ebp)
    110f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1113:	75 c8                	jne    10dd <printint+0x39>
  if(neg)
    1115:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1119:	74 10                	je     112b <printint+0x87>
    buf[i++] = '-';
    111b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    111e:	8d 50 01             	lea    0x1(%eax),%edx
    1121:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1124:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    1129:	eb 1e                	jmp    1149 <printint+0xa5>
    112b:	eb 1c                	jmp    1149 <printint+0xa5>
    putc(fd, buf[i]);
    112d:	8d 55 dc             	lea    -0x24(%ebp),%edx
    1130:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1133:	01 d0                	add    %edx,%eax
    1135:	8a 00                	mov    (%eax),%al
    1137:	0f be c0             	movsbl %al,%eax
    113a:	89 44 24 04          	mov    %eax,0x4(%esp)
    113e:	8b 45 08             	mov    0x8(%ebp),%eax
    1141:	89 04 24             	mov    %eax,(%esp)
    1144:	e8 33 ff ff ff       	call   107c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    1149:	ff 4d f4             	decl   -0xc(%ebp)
    114c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1150:	79 db                	jns    112d <printint+0x89>
    putc(fd, buf[i]);
}
    1152:	83 c4 30             	add    $0x30,%esp
    1155:	5b                   	pop    %ebx
    1156:	5e                   	pop    %esi
    1157:	5d                   	pop    %ebp
    1158:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    1166:	8d 45 0c             	lea    0xc(%ebp),%eax
    1169:	83 c0 04             	add    $0x4,%eax
    116c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    116f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1176:	e9 77 01 00 00       	jmp    12f2 <printf+0x199>
    c = fmt[i] & 0xff;
    117b:	8b 55 0c             	mov    0xc(%ebp),%edx
    117e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1181:	01 d0                	add    %edx,%eax
    1183:	8a 00                	mov    (%eax),%al
    1185:	0f be c0             	movsbl %al,%eax
    1188:	25 ff 00 00 00       	and    $0xff,%eax
    118d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    1190:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1194:	75 2c                	jne    11c2 <printf+0x69>
      if(c == '%'){
    1196:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    119a:	75 0c                	jne    11a8 <printf+0x4f>
        state = '%';
    119c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    11a3:	e9 47 01 00 00       	jmp    12ef <printf+0x196>
      } else {
        putc(fd, c);
    ...
    11b8:	e8 bf fe ff ff       	call   107c <putc>
    11bd:	e9 2d 01 00 00       	jmp    12ef <printf+0x196>
      }
    } else if(state == '%'){
    11c2:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    11c6:	0f 85 23 01 00 00    	jne    12ef <printf+0x196>
      if(c == 'd'){
    11cc:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    11d0:	75 2d                	jne    11ff <printf+0xa6>
        printint(fd, *ap, 10, 1);
    11d2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11d5:	8b 00                	mov    (%eax),%eax
    11d7:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    11de:	00 
    11df:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    11e6:	00 
    11e7:	89 44 24 04          	mov    %eax,0x4(%esp)
    11eb:	8b 45 08             	mov    0x8(%ebp),%eax
    11ee:	89 04 24             	mov    %eax,(%esp)
    11f1:	e8 ae fe ff ff       	call   10a4 <printint>
        ap++;
    11f6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11fa:	e9 e9 00 00 00       	jmp    12e8 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    11ff:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    1203:	74 06                	je     120b <printf+0xb2>
    1205:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    1209:	75 2d                	jne    1238 <printf+0xdf>
        printint(fd, *ap, 16, 0);
    120b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    120e:	8b 00                	mov    (%eax),%eax
    1210:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    1217:	00 
    1218:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    121f:	00 
    1220:	89 44 24 04          	mov    %eax,0x4(%esp)
    1224:	8b 45 08             	mov    0x8(%ebp),%eax
    1227:	89 04 24             	mov    %eax,(%esp)
    122a:	e8 75 fe ff ff       	call   10a4 <printint>
        ap++;
    122f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1233:	e9 b0 00 00 00       	jmp    12e8 <printf+0x18f>
      } else if(c == 's'){
    1238:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    123c:	75 42                	jne    1280 <printf+0x127>
        s = (char*)*ap;
    ...
    124e:	75 09                	jne    1259 <printf+0x100>
          s = "(null)";
    1250:	c7 45 f4 10 16 00 00 	movl   $0x1610,-0xc(%ebp)
        while(*s != 0){
    1257:	eb 1c                	jmp    1275 <printf+0x11c>
    1259:	eb 1a                	jmp    1275 <printf+0x11c>
          putc(fd, *s);
    ...
    126d:	e8 0a fe ff ff       	call   107c <putc>
          s++;
    1272:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    1278:	8a 00                	mov    (%eax),%al
    127a:	84 c0                	test   %al,%al
    127c:	75 dd                	jne    125b <printf+0x102>
    127e:	eb 68                	jmp    12e8 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1280:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1284:	75 1d                	jne    12a3 <printf+0x14a>
        putc(fd, *ap);
    ...
    1298:	e8 df fd ff ff       	call   107c <putc>
        ap++;
    129d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    12a1:	eb 45                	jmp    12e8 <printf+0x18f>
      } else if(c == '%'){
    12a3:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    12a7:	75 17                	jne    12c0 <printf+0x167>
        putc(fd, c);
    12a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    12ac:	0f be c0             	movsbl %al,%eax
    12af:	89 44 24 04          	mov    %eax,0x4(%esp)
    12b3:	8b 45 08             	mov    0x8(%ebp),%eax
    12b6:	89 04 24             	mov    %eax,(%esp)
    12b9:	e8 be fd ff ff       	call   107c <putc>
    12be:	eb 28                	jmp    12e8 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    12c0:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    12c7:	00 
    12c8:	8b 45 08             	mov    0x8(%ebp),%eax
    12cb:	89 04 24             	mov    %eax,(%esp)
    12ce:	e8 a9 fd ff ff       	call   107c <putc>
        putc(fd, c);
    ...
    12e3:	e8 94 fd ff ff       	call   107c <putc>
      }
      state = 0;
    12e8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1317:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    13ef:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13f6:	77 07                	ja     13ff <morecore+0x16>
    nu = 4096;
    13f8:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13ff:	8b 45 08             	mov    0x8(%ebp),%eax
    1402:	c1 e0 03             	shl    $0x3,%eax
    1405:	89 04 24             	mov    %eax,(%esp)
    1408:	e8 af fb ff ff       	call   fbc <sbrk>
    140d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    1410:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1414:	75 07                	jne    141d <morecore+0x34>
    return 0;
    1416:	b8 00 00 00 00       	mov    $0x0,%eax
    141b:	eb 22                	jmp    143f <morecore+0x56>
  hp = (Header*)p;
    141d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1420:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1423:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1426:	8b 55 08             	mov    0x8(%ebp),%edx
    1429:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    142c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    142f:	83 c0 08             	add    $0x8,%eax
    1432:	89 04 24             	mov    %eax,(%esp)
    1435:	e8 ce fe ff ff       	call   1308 <free>
  return freep;
    143a:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
}
    143f:	c9                   	leave  
    1440:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    144a:	83 c0 07             	add    $0x7,%eax
    144d:	c1 e8 03             	shr    $0x3,%eax
    1450:	40                   	inc    %eax
    1451:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1454:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1459:	89 45 f0             	mov    %eax,-0x10(%ebp)
    145c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1460:	75 23                	jne    1485 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1462:	c7 45 f0 24 1b 00 00 	movl   $0x1b24,-0x10(%ebp)
    1469:	8b 45 f0             	mov    -0x10(%ebp),%eax
    146c:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    1471:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1476:	a3 24 1b 00 00       	mov    %eax,0x1b24
    base.s.size = 0;
    147b:	c7 05 28 1b 00 00 00 	movl   $0x0,0x1b28
    1482:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1518:	e9 70 ff ff ff       	jmp    148d <malloc+0x4c>
}
    151d:	c9                   	leave  
    151e:	c3                   	ret    
