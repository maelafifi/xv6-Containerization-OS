...
void copy_files(char* loc, char* src){
	...
	if(fd_write < 0){
      ...
      6b:	c7 44 24 04 60 12 00 	movl   $0x1260,0x4(%esp)
      72:	00 
      73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      7a:	e8 1a 0e 00 00       	call   e99 <printf>
		return;
	...
	if(fd_read < 0){
      ...
      9e:	79 16                	jns    b6 <copy_files+0x70>
		printf(1, "Invalid file location.\n");
      a0:	c7 44 24 04 60 12 00 	movl   $0x1260,0x4(%esp)
      a7:	00 
      a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      af:	e8 e5 0d 00 00       	call   e99 <printf>
		return;
...
void name(){
	...
	printf(1, "0: %s - %d SIZE: %d, 1: %s - %d, 2: %s - %d, 3: %s - %d\n", x, b, s, y, c, z, d, a, e);
     ...
     1fe:	c7 44 24 04 78 12 00 	movl   $0x1278,0x4(%esp)
     205:	00 
     206:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     20d:	e8 87 0c 00 00       	call   e99 <printf>
}
     212:	c9                   	leave  
     213:	c3                   	ret    
...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
     ...
     272:	c7 04 24 34 18 00 00 	movl   $0x1834,(%esp)
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
     ...
     29d:	05 34 18 00 00       	add    $0x1834,%eax
  ...
  return buf;
     2b6:	b8 34 18 00 00       	mov    $0x1834,%eax
}
...
add_file_size(char *path, char *c_name)
{
  ...
  printf(1, "PATH: %s  C_NAME: %s",path, c_name);
     ...
     2d8:	c7 44 24 04 b1 12 00 	movl   $0x12b1,0x4(%esp)
     2df:	00 
     2e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     2e7:	e8 ad 0b 00 00       	call   e99 <printf>
  ...
  if((fd = open(path, 0)) < 0){
    ...
    printf(2, "ls: cannot open %s\n", path);
     ...
     30f:	c7 44 24 04 c6 12 00 	movl   $0x12c6,0x4(%esp)
     316:	00 
     317:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     31e:	e8 76 0b 00 00       	call   e99 <printf>
    return;
  ...
  if(fstat(fd, &st) < 0){
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     348:	c7 44 24 04 da 12 00 	movl   $0x12da,0x4(%esp)
     34f:	00 
     350:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     357:	e8 3d 0b 00 00       	call   e99 <printf>
    close(fd);
  ...
  case T_FILE:
  	printf(1, "HERE \n");
     385:	c7 44 24 04 ee 12 00 	movl   $0x12ee,0x4(%esp)
     38c:	00 
     38d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     394:	e8 00 0b 00 00       	call   e99 <printf>
  	z = find(c_name);
     ...
     3ae:	c7 44 24 04 f5 12 00 	movl   $0x12f5,0x4(%esp)
     3b5:	00 
     3b6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3bd:	e8 d7 0a 00 00       	call   e99 <printf>
  	if(z >= 0){
     ...
     3e7:	c7 44 24 04 fd 12 00 	movl   $0x12fd,0x4(%esp)
     3ee:	00 
     3ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3f6:	e8 9e 0a 00 00       	call   e99 <printf>
	}
    break;
  ...
  case T_DIR:
  	printf(1, "HERE2 \n");
     405:	c7 44 24 04 09 13 00 	movl   $0x1309,0x4(%esp)
     40c:	00 
     40d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     414:	e8 80 0a 00 00       	call   e99 <printf>
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     42e:	c7 44 24 04 11 13 00 	movl   $0x1311,0x4(%esp)
     435:	00 
     436:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     43d:	e8 57 0a 00 00       	call   e99 <printf>
      break;
     442:	e9 65 01 00 00       	jmp    5ac <add_file_size+0x2eb>
    }
    printf(1, "HERE3 \n");
     447:	c7 44 24 04 24 13 00 	movl   $0x1324,0x4(%esp)
     44e:	00 
     44f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     456:	e8 3e 0a 00 00       	call   e99 <printf>
    strcpy(buf, path);
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     4f9:	c7 44 24 04 da 12 00 	movl   $0x12da,0x4(%esp)
     500:	00 
     501:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     508:	e8 8c 09 00 00       	call   e99 <printf>
        continue;
     50d:	eb 76                	jmp    585 <add_file_size+0x2c4>
      }
      printf(1, "HERE4 \n");
     50f:	c7 44 24 04 2c 13 00 	movl   $0x132c,0x4(%esp)
     516:	00 
     517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     51e:	e8 76 09 00 00       	call   e99 <printf>
      int z = find(c_name);
     ...
     538:	c7 44 24 04 f5 12 00 	movl   $0x12f5,0x4(%esp)
     53f:	00 
     540:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     547:	e8 4d 09 00 00       	call   e99 <printf>
  	  if(z >= 0){
     ...
     571:	c7 44 24 04 fd 12 00 	movl   $0x12fd,0x4(%esp)
     578:	00 
     579:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     580:	e8 14 09 00 00       	call   e99 <printf>
    }
    printf(1, "HERE3 \n");
    strcpy(buf, path);
    p = buf+strlen(buf);
...
void create(char *c_args[]){
	...
	for(i = 1; i < x; i++){
     ...
     613:	c7 44 24 04 34 13 00 	movl   $0x1334,0x4(%esp)
     61a:	00 
     61b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     622:	e8 72 08 00 00       	call   e99 <printf>
     ...
     674:	c7 44 24 04 39 13 00 	movl   $0x1339,0x4(%esp)
     67b:	00 
     ...
     6ae:	c7 44 24 04 3b 13 00 	movl   $0x133b,0x4(%esp)
     6b5:	00 
     6b6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6bd:	e8 d7 07 00 00       	call   e99 <printf>
...
void attach_vc(char* vc, char* dir, char* file, int vc_num){
	...
	if (id == 0){
     ...
     755:	c7 04 24 39 13 00 00 	movl   $0x1339,(%esp)
     ...
     7cd:	c7 44 24 04 4a 13 00 	movl   $0x134a,0x4(%esp)
     7d4:	00 
     7d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7dc:	e8 b8 06 00 00       	call   e99 <printf>
		exit();
...
void start(char *s_args[]){
	...
	if((index = is_full()) < 0){
     ...
     803:	c7 44 24 04 60 13 00 	movl   $0x1360,0x4(%esp)
     80a:	00 
     80b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     812:	e8 82 06 00 00       	call   e99 <printf>
		return;
	...
	if(find(dir) == 0){
     ...
     866:	c7 44 24 04 7a 13 00 	movl   $0x137a,0x4(%esp)
     86d:	00 
     86e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     875:	e8 1f 06 00 00       	call   e99 <printf>
		return;
...
void stop(char *c_name[]){
	...
	printf(1, "trying to stop container %s\n", c_name[0]);
     ...
     8d4:	c7 44 24 04 95 13 00 	movl   $0x1395,0x4(%esp)
     8db:	00 
     8dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8e3:	e8 b1 05 00 00       	call   e99 <printf>
	cstop(c_name[0]);
...
int main(int argc, char *argv[]){
	...
	if(strcmp(argv[1], "init") == 0){
     ...
     90d:	c7 44 24 04 b2 13 00 	movl   $0x13b2,0x4(%esp)
     914:	00 
     ...
     92d:	c7 44 24 04 b7 13 00 	movl   $0x13b7,0x4(%esp)
     934:	00 
     ...
     941:	c7 44 24 04 be 13 00 	movl   $0x13be,0x4(%esp)
     948:	00 
     949:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     950:	e8 44 05 00 00       	call   e99 <printf>
		create(&argv[2]);
     ...
     970:	c7 44 24 04 ce 13 00 	movl   $0x13ce,0x4(%esp)
     977:	00 
     ...
     99c:	c7 44 24 04 d4 13 00 	movl   $0x13d4,0x4(%esp)
     9a3:	00 
	...
	// }
     ...
     9bf:	c7 44 24 04 d9 13 00 	movl   $0x13d9,0x4(%esp)
     9c6:	00 
	...
	// }
     ...
     9e3:	c7 44 24 04 e0 13 00 	movl   $0x13e0,0x4(%esp)
     9ea:	00 
     9eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9f2:	e8 a2 04 00 00       	call   e99 <printf>
	}
	printf(1, "Done with ctool\n");
     9f7:	c7 44 24 04 1b 14 00 	movl   $0x141b,0x4(%esp)
     9fe:	00 
     9ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a06:	e8 8e 04 00 00       	call   e99 <printf>
...
putc(int fd, char c)
{
     ...
     dc5:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     dc8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     dcf:	00 
     dd0:	8d 45 f4             	lea    -0xc(%ebp),%eax
     dd3:	89 44 24 04          	mov    %eax,0x4(%esp)
     dd7:	8b 45 08             	mov    0x8(%ebp),%eax
     dda:	89 04 24             	mov    %eax,(%esp)
     ddd:	e8 a2 fe ff ff       	call   c84 <write>
}
     de2:	c9                   	leave  
     de3:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     dec:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     df3:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     df7:	74 17                	je     e10 <printint+0x2c>
     df9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     dfd:	79 11                	jns    e10 <printint+0x2c>
    neg = 1;
     dff:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     e06:	8b 45 0c             	mov    0xc(%ebp),%eax
     e09:	f7 d8                	neg    %eax
     e0b:	89 45 ec             	mov    %eax,-0x14(%ebp)
     e0e:	eb 06                	jmp    e16 <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     e1d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     e20:	8d 41 01             	lea    0x1(%ecx),%eax
     e23:	89 45 f4             	mov    %eax,-0xc(%ebp)
     e26:	8b 5d 10             	mov    0x10(%ebp),%ebx
     e29:	8b 45 ec             	mov    -0x14(%ebp),%eax
     e2c:	ba 00 00 00 00       	mov    $0x0,%edx
     e31:	f7 f3                	div    %ebx
     e33:	89 d0                	mov    %edx,%eax
     e35:	8a 80 20 18 00 00    	mov    0x1820(%eax),%al
     e3b:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
     e3f:	8b 75 10             	mov    0x10(%ebp),%esi
     e42:	8b 45 ec             	mov    -0x14(%ebp),%eax
     e45:	ba 00 00 00 00       	mov    $0x0,%edx
     e4a:	f7 f6                	div    %esi
     e4c:	89 45 ec             	mov    %eax,-0x14(%ebp)
     e4f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     e53:	75 c8                	jne    e1d <printint+0x39>
  if(neg)
     e55:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     e59:	74 10                	je     e6b <printint+0x87>
    buf[i++] = '-';
     e5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
     e5e:	8d 50 01             	lea    0x1(%eax),%edx
     e61:	89 55 f4             	mov    %edx,-0xc(%ebp)
     e64:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
     e69:	eb 1e                	jmp    e89 <printint+0xa5>
     e6b:	eb 1c                	jmp    e89 <printint+0xa5>
    putc(fd, buf[i]);
     e6d:	8d 55 dc             	lea    -0x24(%ebp),%edx
     e70:	8b 45 f4             	mov    -0xc(%ebp),%eax
     e73:	01 d0                	add    %edx,%eax
     e75:	8a 00                	mov    (%eax),%al
     e77:	0f be c0             	movsbl %al,%eax
     e7a:	89 44 24 04          	mov    %eax,0x4(%esp)
     e7e:	8b 45 08             	mov    0x8(%ebp),%eax
     e81:	89 04 24             	mov    %eax,(%esp)
     e84:	e8 33 ff ff ff       	call   dbc <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     e89:	ff 4d f4             	decl   -0xc(%ebp)
     e8c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     e90:	79 db                	jns    e6d <printint+0x89>
    putc(fd, buf[i]);
}
     e92:	83 c4 30             	add    $0x30,%esp
     e95:	5b                   	pop    %ebx
     e96:	5e                   	pop    %esi
     e97:	5d                   	pop    %ebp
     e98:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
     ...
     e9c:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
     e9f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
     ea6:	8d 45 0c             	lea    0xc(%ebp),%eax
     ea9:	83 c0 04             	add    $0x4,%eax
     eac:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
     eaf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     eb6:	e9 77 01 00 00       	jmp    1032 <printf+0x199>
    c = fmt[i] & 0xff;
     ebb:	8b 55 0c             	mov    0xc(%ebp),%edx
     ebe:	8b 45 f0             	mov    -0x10(%ebp),%eax
     ec1:	01 d0                	add    %edx,%eax
     ec3:	8a 00                	mov    (%eax),%al
     ec5:	0f be c0             	movsbl %al,%eax
     ec8:	25 ff 00 00 00       	and    $0xff,%eax
     ecd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
     ed0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     ed4:	75 2c                	jne    f02 <printf+0x69>
      if(c == '%'){
     ed6:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     eda:	75 0c                	jne    ee8 <printf+0x4f>
        state = '%';
     edc:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
     ee3:	e9 47 01 00 00       	jmp    102f <printf+0x196>
      } else {
        putc(fd, c);
     ...
     ef8:	e8 bf fe ff ff       	call   dbc <putc>
     efd:	e9 2d 01 00 00       	jmp    102f <printf+0x196>
      }
    } else if(state == '%'){
     f02:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
     f06:	0f 85 23 01 00 00    	jne    102f <printf+0x196>
      if(c == 'd'){
     f0c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
     f10:	75 2d                	jne    f3f <printf+0xa6>
        printint(fd, *ap, 10, 1);
     f12:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f15:	8b 00                	mov    (%eax),%eax
     f17:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
     f1e:	00 
     f1f:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     f26:	00 
     f27:	89 44 24 04          	mov    %eax,0x4(%esp)
     f2b:	8b 45 08             	mov    0x8(%ebp),%eax
     f2e:	89 04 24             	mov    %eax,(%esp)
     f31:	e8 ae fe ff ff       	call   de4 <printint>
        ap++;
     f36:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     f3a:	e9 e9 00 00 00       	jmp    1028 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
     f3f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
     f43:	74 06                	je     f4b <printf+0xb2>
     f45:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
     f49:	75 2d                	jne    f78 <printf+0xdf>
        printint(fd, *ap, 16, 0);
     f4b:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f4e:	8b 00                	mov    (%eax),%eax
     f50:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
     f57:	00 
     f58:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
     f5f:	00 
     f60:	89 44 24 04          	mov    %eax,0x4(%esp)
     f64:	8b 45 08             	mov    0x8(%ebp),%eax
     f67:	89 04 24             	mov    %eax,(%esp)
     f6a:	e8 75 fe ff ff       	call   de4 <printint>
        ap++;
     f6f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     f73:	e9 b0 00 00 00       	jmp    1028 <printf+0x18f>
      } else if(c == 's'){
     f78:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
     f7c:	75 42                	jne    fc0 <printf+0x127>
        s = (char*)*ap;
     f7e:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f81:	8b 00                	mov    (%eax),%eax
     f83:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
     f86:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
     f8a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     f8e:	75 09                	jne    f99 <printf+0x100>
          s = "(null)";
     f90:	c7 45 f4 2c 14 00 00 	movl   $0x142c,-0xc(%ebp)
        while(*s != 0){
     f97:	eb 1c                	jmp    fb5 <printf+0x11c>
     f99:	eb 1a                	jmp    fb5 <printf+0x11c>
          putc(fd, *s);
     f9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
     f9e:	8a 00                	mov    (%eax),%al
     fa0:	0f be c0             	movsbl %al,%eax
     fa3:	89 44 24 04          	mov    %eax,0x4(%esp)
     fa7:	8b 45 08             	mov    0x8(%ebp),%eax
     faa:	89 04 24             	mov    %eax,(%esp)
     fad:	e8 0a fe ff ff       	call   dbc <putc>
          s++;
     ...
     fb8:	8a 00                	mov    (%eax),%al
     fba:	84 c0                	test   %al,%al
     fbc:	75 dd                	jne    f9b <printf+0x102>
     fbe:	eb 68                	jmp    1028 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
     fc0:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
     fc4:	75 1d                	jne    fe3 <printf+0x14a>
        putc(fd, *ap);
     fc6:	8b 45 e8             	mov    -0x18(%ebp),%eax
     fc9:	8b 00                	mov    (%eax),%eax
     fcb:	0f be c0             	movsbl %al,%eax
     fce:	89 44 24 04          	mov    %eax,0x4(%esp)
     fd2:	8b 45 08             	mov    0x8(%ebp),%eax
     fd5:	89 04 24             	mov    %eax,(%esp)
     fd8:	e8 df fd ff ff       	call   dbc <putc>
        ap++;
     fdd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     fe1:	eb 45                	jmp    1028 <printf+0x18f>
      } else if(c == '%'){
     fe3:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     fe7:	75 17                	jne    1000 <printf+0x167>
        putc(fd, c);
     fe9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     fec:	0f be c0             	movsbl %al,%eax
     fef:	89 44 24 04          	mov    %eax,0x4(%esp)
     ff3:	8b 45 08             	mov    0x8(%ebp),%eax
     ff6:	89 04 24             	mov    %eax,(%esp)
     ff9:	e8 be fd ff ff       	call   dbc <putc>
     ffe:	eb 28                	jmp    1028 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1000:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    1007:	00 
    1008:	8b 45 08             	mov    0x8(%ebp),%eax
    100b:	89 04 24             	mov    %eax,(%esp)
    100e:	e8 a9 fd ff ff       	call   dbc <putc>
        putc(fd, c);
    ...
    1023:	e8 94 fd ff ff       	call   dbc <putc>
      }
      state = 0;
    1028:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    102f:	ff 45 f0             	incl   -0x10(%ebp)
    1032:	8b 55 0c             	mov    0xc(%ebp),%edx
    1035:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1038:	01 d0                	add    %edx,%eax
    103a:	8a 00                	mov    (%eax),%al
    103c:	84 c0                	test   %al,%al
    103e:	0f 85 77 fe ff ff    	jne    ebb <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    1051:	83 e8 08             	sub    $0x8,%eax
    1054:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1057:	a1 4c 18 00 00       	mov    0x184c,%eax
    105c:	89 45 fc             	mov    %eax,-0x4(%ebp)
    105f:	eb 24                	jmp    1085 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1061:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1064:	8b 00                	mov    (%eax),%eax
    1066:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1069:	77 12                	ja     107d <free+0x35>
    106b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    106e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1071:	77 24                	ja     1097 <free+0x4f>
    1073:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1076:	8b 00                	mov    (%eax),%eax
    1078:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    107b:	77 1a                	ja     1097 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1082:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1085:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1088:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    108b:	76 d4                	jbe    1061 <free+0x19>
    108d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1090:	8b 00                	mov    (%eax),%eax
    1092:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1095:	76 ca                	jbe    1061 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    1097:	8b 45 f8             	mov    -0x8(%ebp),%eax
    109a:	8b 40 04             	mov    0x4(%eax),%eax
    109d:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    10a4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    10a7:	01 c2                	add    %eax,%edx
    10a9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10ac:	8b 00                	mov    (%eax),%eax
    10ae:	39 c2                	cmp    %eax,%edx
    10b0:	75 24                	jne    10d6 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    10b2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    10b5:	8b 50 04             	mov    0x4(%eax),%edx
    10b8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10bb:	8b 00                	mov    (%eax),%eax
    10bd:	8b 40 04             	mov    0x4(%eax),%eax
    10c0:	01 c2                	add    %eax,%edx
    10c2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    10c5:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    10c8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10cb:	8b 00                	mov    (%eax),%eax
    10cd:	8b 10                	mov    (%eax),%edx
    10cf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    10d2:	89 10                	mov    %edx,(%eax)
    10d4:	eb 0a                	jmp    10e0 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    10d6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10d9:	8b 10                	mov    (%eax),%edx
    10db:	8b 45 f8             	mov    -0x8(%ebp),%eax
    10de:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    10e0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10e3:	8b 40 04             	mov    0x4(%eax),%eax
    10e6:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    10ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10f0:	01 d0                	add    %edx,%eax
    10f2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    10f5:	75 20                	jne    1117 <free+0xcf>
    p->s.size += bp->s.size;
    10f7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    10fa:	8b 50 04             	mov    0x4(%eax),%edx
    10fd:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1100:	8b 40 04             	mov    0x4(%eax),%eax
    1103:	01 c2                	add    %eax,%edx
    1105:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1108:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    110b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    110e:	8b 10                	mov    (%eax),%edx
    1110:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1113:	89 10                	mov    %edx,(%eax)
    1115:	eb 08                	jmp    111f <free+0xd7>
  } else
    p->s.ptr = bp;
    1117:	8b 45 fc             	mov    -0x4(%ebp),%eax
    111a:	8b 55 f8             	mov    -0x8(%ebp),%edx
    111d:	89 10                	mov    %edx,(%eax)
  freep = p;
    111f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1122:	a3 4c 18 00 00       	mov    %eax,0x184c
}
    1127:	c9                   	leave  
    1128:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    112c:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    112f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1136:	77 07                	ja     113f <morecore+0x16>
    nu = 4096;
    1138:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    113f:	8b 45 08             	mov    0x8(%ebp),%eax
    1142:	c1 e0 03             	shl    $0x3,%eax
    1145:	89 04 24             	mov    %eax,(%esp)
    1148:	e8 9f fb ff ff       	call   cec <sbrk>
    114d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    1150:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1154:	75 07                	jne    115d <morecore+0x34>
    return 0;
    1156:	b8 00 00 00 00       	mov    $0x0,%eax
    115b:	eb 22                	jmp    117f <morecore+0x56>
  hp = (Header*)p;
  ...
  hp->s.size = nu;
    ...
    1169:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    116c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    116f:	83 c0 08             	add    $0x8,%eax
    1172:	89 04 24             	mov    %eax,(%esp)
    1175:	e8 ce fe ff ff       	call   1048 <free>
  return freep;
    117a:	a1 4c 18 00 00       	mov    0x184c,%eax
}
    117f:	c9                   	leave  
    1180:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    1184:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1187:	8b 45 08             	mov    0x8(%ebp),%eax
    118a:	83 c0 07             	add    $0x7,%eax
    118d:	c1 e8 03             	shr    $0x3,%eax
    1190:	40                   	inc    %eax
    1191:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1194:	a1 4c 18 00 00       	mov    0x184c,%eax
    1199:	89 45 f0             	mov    %eax,-0x10(%ebp)
    119c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    11a0:	75 23                	jne    11c5 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    11a2:	c7 45 f0 44 18 00 00 	movl   $0x1844,-0x10(%ebp)
    11a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    11ac:	a3 4c 18 00 00       	mov    %eax,0x184c
    11b1:	a1 4c 18 00 00       	mov    0x184c,%eax
    11b6:	a3 44 18 00 00       	mov    %eax,0x1844
    base.s.size = 0;
    11bb:	c7 05 48 18 00 00 00 	movl   $0x0,0x1848
    11c2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11d0:	8b 40 04             	mov    0x4(%eax),%eax
    11d3:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    11d6:	72 4d                	jb     1225 <malloc+0xa4>
      if(p->s.size == nunits)
    11d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11db:	8b 40 04             	mov    0x4(%eax),%eax
    11de:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    11e1:	75 0c                	jne    11ef <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    11e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11e6:	8b 10                	mov    (%eax),%edx
    11e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    11eb:	89 10                	mov    %edx,(%eax)
    11ed:	eb 26                	jmp    1215 <malloc+0x94>
      else {
        p->s.size -= nunits;
    11ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11f2:	8b 40 04             	mov    0x4(%eax),%eax
    11f5:	2b 45 ec             	sub    -0x14(%ebp),%eax
    11f8:	89 c2                	mov    %eax,%edx
    11fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11fd:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    1200:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1203:	8b 40 04             	mov    0x4(%eax),%eax
    1206:	c1 e0 03             	shl    $0x3,%eax
    1209:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    120c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    120f:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1212:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    1215:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1218:	a3 4c 18 00 00       	mov    %eax,0x184c
      return (void*)(p + 1);
    121d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1220:	83 c0 08             	add    $0x8,%eax
    1223:	eb 38                	jmp    125d <malloc+0xdc>
    }
    if(p == freep)
    1225:	a1 4c 18 00 00       	mov    0x184c,%eax
    122a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    122d:	75 1b                	jne    124a <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    122f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1232:	89 04 24             	mov    %eax,(%esp)
    1235:	e8 ef fe ff ff       	call   1129 <morecore>
    123a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    123d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1241:	75 07                	jne    124a <malloc+0xc9>
        return 0;
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	eb 13                	jmp    125d <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1258:	e9 70 ff ff ff       	jmp    11cd <malloc+0x4c>
}
    125d:	c9                   	leave  
    125e:	c3                   	ret    
