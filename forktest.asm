...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 0c 06 00 	movl   $0x60c,0x4(%esp)
  36:	00 
  ...
  62:	e8 e5 03 00 00       	call   44c <exit>
{
  ...
  83:	00 
  84:	c7 44 24 04 18 06 00 	movl   $0x618,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 37 06 00 	movl   $0x637,0x4(%esp)
  af:	00 
  ...
  d4:	c7 44 24 04 4b 06 00 	movl   $0x64b,0x4(%esp)
  db:	00 
  ...
  ed:	c7 44 24 04 5e 06 00 	movl   $0x65e,0x4(%esp)
  f4:	00 
...
000005fc <get_cticks>:
SYSCALL(get_cticks)
 5fc:	b8 38 00 00 00       	mov    $0x38,%eax
 601:	cd 40                	int    $0x40
 603:	c3                   	ret    

00000604 <tick_reset2>:
SYSCALL(tick_reset2)
 604:	b8 39 00 00 00       	mov    $0x39,%eax
 609:	cd 40                	int    $0x40
 60b:	c3                   	ret    
