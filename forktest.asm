...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 e8 04 00 	movl   $0x4e8,0x4(%esp)
  36:	00 
  ...
  62:	e8 01 03 00 00       	call   368 <exit>
{
  ...
  83:	00 
  84:	c7 44 24 04 f4 04 00 	movl   $0x4f4,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 13 05 00 	movl   $0x513,0x4(%esp)
  af:	00 
  ...
  d4:	c7 44 24 04 27 05 00 	movl   $0x527,0x4(%esp)
  db:	00 
  ...
  ed:	c7 44 24 04 3a 05 00 	movl   $0x53a,0x4(%esp)
  f4:	00 
