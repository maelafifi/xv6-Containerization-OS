...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 1b 09 00 	movl   $0x91b,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4dd:	8a 80 80 0b 00 00    	mov    0xb80(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 636:	75 09                	jne    641 <printf+0x100>
          s = "(null)";
 638:	c7 45 f4 34 09 00 00 	movl   $0x934,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ff:	a1 9c 0b 00 00       	mov    0xb9c,%eax
...
free(void *ap)
{
 ...
 7ca:	a3 9c 0b 00 00       	mov    %eax,0xb9c
}
 7cf:	c9                   	leave  
 7d0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 81d:	e8 ce fe ff ff       	call   6f0 <free>
  return freep;
 822:	a1 9c 0b 00 00       	mov    0xb9c,%eax
}
 827:	c9                   	leave  
 828:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 839:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 83c:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 841:	89 45 f0             	mov    %eax,-0x10(%ebp)
 844:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 848:	75 23                	jne    86d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 84a:	c7 45 f0 94 0b 00 00 	movl   $0xb94,-0x10(%ebp)
 851:	8b 45 f0             	mov    -0x10(%ebp),%eax
 854:	a3 9c 0b 00 00       	mov    %eax,0xb9c
 859:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 85e:	a3 94 0b 00 00       	mov    %eax,0xb94
    base.s.size = 0;
 863:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 86a:	00 00 00 
  }
 ...
 8c0:	a3 9c 0b 00 00       	mov    %eax,0xb9c
      return (void*)(p + 1);
 ...
 8cb:	eb 38                	jmp    905 <malloc+0xdc>
    ...
    if(p == freep)
 8cd:	a1 9c 0b 00 00       	mov    0xb9c,%eax
