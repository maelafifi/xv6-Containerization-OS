...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 6c 65 00 00       	mov    0x656c,%eax
       b:	c7 44 24 04 02 46 00 	movl   $0x4602,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 0a 42 00 00       	call   4225 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 0d 46 00 00 	movl   $0x460d,(%esp)
      22:	e8 09 40 00 00       	call   4030 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 6c 65 00 00       	mov    0x656c,%eax
      30:	c7 44 24 04 15 46 00 	movl   $0x4615,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 e5 41 00 00       	call   4225 <printf>
    exit();
      40:	e8 83 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 0d 46 00 00 	movl   $0x460d,(%esp)
      4c:	e8 e7 3f 00 00       	call   4038 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 6c 65 00 00       	mov    0x656c,%eax
      5a:	c7 44 24 04 23 46 00 	movl   $0x4623,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 bb 41 00 00       	call   4225 <printf>
    exit();
      6a:	e8 59 3f 00 00       	call   3fc8 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 39 46 00 00 	movl   $0x4639,(%esp)
      76:	e8 9d 3f 00 00       	call   4018 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 6c 65 00 00       	mov    0x656c,%eax
      84:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 91 41 00 00       	call   4225 <printf>
    exit();
      94:	e8 2f 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 5e 46 00 00 	movl   $0x465e,(%esp)
      a0:	e8 93 3f 00 00       	call   4038 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 6c 65 00 00       	mov    0x656c,%eax
      ae:	c7 44 24 04 60 46 00 	movl   $0x4660,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 67 41 00 00       	call   4225 <printf>
    exit();
      be:	e8 05 3f 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 6c 65 00 00       	mov    0x656c,%eax
      c8:	c7 44 24 04 70 46 00 	movl   $0x4670,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 4d 41 00 00       	call   4225 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 6c 65 00 00       	mov    0x656c,%eax
      e5:	c7 44 24 04 7e 46 00 	movl   $0x467e,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 30 41 00 00       	call   4225 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 6c 65 00 00       	mov    0x656c,%eax
     108:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 0d 41 00 00       	call   4225 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 0d 46 00 00 	movl   $0x460d,(%esp)
     12e:	e8 fd 3e 00 00       	call   4030 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 6c 65 00 00       	mov    0x656c,%eax
     13c:	c7 44 24 04 15 46 00 	movl   $0x4615,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 d9 40 00 00       	call   4225 <printf>
      exit();
     14c:	e8 77 3e 00 00       	call   3fc8 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 0d 46 00 00 	movl   $0x460d,(%esp)
     158:	e8 db 3e 00 00       	call   4038 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 6c 65 00 00       	mov    0x656c,%eax
     166:	c7 44 24 04 9a 46 00 	movl   $0x469a,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 af 40 00 00       	call   4225 <printf>
      exit();
     176:	e8 4d 3e 00 00       	call   3fc8 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 39 46 00 00 	movl   $0x4639,(%esp)
     182:	e8 91 3e 00 00       	call   4018 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 6c 65 00 00       	mov    0x656c,%eax
     190:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 85 40 00 00       	call   4225 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 6c 65 00 00       	mov    0x656c,%eax
     1b4:	c7 44 24 04 ae 46 00 	movl   $0x46ae,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 61 40 00 00       	call   4225 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 6c 65 00 00       	mov    0x656c,%eax
     1d1:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 44 40 00 00       	call   4225 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 cf 46 00 00 	movl   $0x46cf,(%esp)
     1e8:	e8 43 3e 00 00       	call   4030 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 6c 65 00 00       	mov    0x656c,%eax
     1f6:	c7 44 24 04 d5 46 00 	movl   $0x46d5,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 1f 40 00 00       	call   4225 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 6c 65 00 00       	mov    0x656c,%eax
     21e:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 f7 3f 00 00       	call   4225 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 cf 46 00 00 	movl   $0x46cf,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 6c 65 00 00       	mov    0x656c,%eax
     25b:	c7 44 24 04 ec 46 00 	movl   $0x46ec,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 ba 3f 00 00       	call   4225 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 cf 46 00 00 	movl   $0x46cf,(%esp)
     288:	e8 8b 3d 00 00       	call   4018 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 6c 65 00 00       	mov    0x656c,%eax
     296:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 7f 3f 00 00       	call   4225 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 6c 65 00 00       	mov    0x656c,%eax
     2b5:	c7 44 24 04 1f 47 00 	movl   $0x471f,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 60 3f 00 00       	call   4225 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 6c 65 00 00       	mov    0x656c,%eax
     2d2:	c7 44 24 04 31 47 00 	movl   $0x4731,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 43 3f 00 00       	call   4225 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 ec 45 00 00 	movl   $0x45ec,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 6c 65 00 00       	mov    0x656c,%eax
     304:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 11 3f 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 4f 47 00 00 	movl   $0x474f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 6c 65 00 00       	mov    0x656c,%eax
     346:	c7 44 24 04 5c 47 00 	movl   $0x475c,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 cf 3e 00 00       	call   4225 <printf>
    exit();
     356:	e8 6d 3c 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 6c 65 00 00       	mov    0x656c,%eax
     360:	c7 44 24 04 7a 47 00 	movl   $0x477a,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 b5 3e 00 00       	call   4225 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 6c 65 00 00       	mov    0x656c,%eax
     37d:	c7 44 24 04 88 47 00 	movl   $0x4788,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 98 3e 00 00       	call   4225 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 99 47 00 00 	movl   $0x4799,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 6c 65 00 00       	mov    0x656c,%eax
     3af:	c7 44 24 04 9f 47 00 	movl   $0x479f,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 66 3e 00 00       	call   4225 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 6c 65 00 00       	mov    0x656c,%eax
     3d0:	c7 44 24 04 ba 47 00 	movl   $0x47ba,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 45 3e 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 d6 47 00 	movl   $0x47d6,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 6c 65 00 00       	mov    0x656c,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 e4 47 00 	movl   $0x47e4,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 04 3e 00 00       	call   4225 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 08 48 00 	movl   $0x4808,0x4(%esp)
     435:	00 
     ...
     446:	a1 6c 65 00 00       	mov    0x656c,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 c3 3d 00 00       	call   4225 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     474:	a1 6c 65 00 00       	mov    0x656c,%eax
     479:	c7 44 24 04 38 48 00 	movl   $0x4838,0x4(%esp)
     480:	00 
     481:	89 04 24             	mov    %eax,(%esp)
     484:	e8 9c 3d 00 00       	call   4225 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49b:	00 
     49c:	c7 04 24 99 47 00 00 	movl   $0x4799,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b1:	a1 6c 65 00 00       	mov    0x656c,%eax
     4b6:	c7 44 24 04 43 48 00 	movl   $0x4843,0x4(%esp)
     4bd:	00 
     4be:	89 04 24             	mov    %eax,(%esp)
     4c1:	e8 5f 3d 00 00       	call   4225 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4cd:	00 
     4ce:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
     4d5:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4ef:	a1 6c 65 00 00       	mov    0x656c,%eax
     4f4:	c7 44 24 04 5c 48 00 	movl   $0x485c,0x4(%esp)
     4fb:	00 
     4fc:	89 04 24             	mov    %eax,(%esp)
     4ff:	e8 21 3d 00 00       	call   4225 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     509:	a1 6c 65 00 00       	mov    0x656c,%eax
     50e:	c7 44 24 04 77 48 00 	movl   $0x4877,0x4(%esp)
     515:	00 
     516:	89 04 24             	mov    %eax,(%esp)
     519:	e8 07 3d 00 00       	call   4225 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     529:	c7 04 24 99 47 00 00 	movl   $0x4799,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53b:	a1 6c 65 00 00       	mov    0x656c,%eax
     540:	c7 44 24 04 8a 48 00 	movl   $0x488a,0x4(%esp)
     547:	00 
     548:	89 04 24             	mov    %eax,(%esp)
     54b:	e8 d5 3c 00 00       	call   4225 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     555:	a1 6c 65 00 00       	mov    0x656c,%eax
     55a:	c7 44 24 04 97 48 00 	movl   $0x4897,0x4(%esp)
     561:	00 
     562:	89 04 24             	mov    %eax,(%esp)
     565:	e8 bb 3c 00 00       	call   4225 <printf>
    exit();
     56a:	e8 59 3a 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "small file test ok\n");
     56f:	a1 6c 65 00 00       	mov    0x656c,%eax
     574:	c7 44 24 04 ac 48 00 	movl   $0x48ac,0x4(%esp)
     57b:	00 
     57c:	89 04 24             	mov    %eax,(%esp)
     57f:	e8 a1 3c 00 00       	call   4225 <printf>
}
     584:	c9                   	leave  
     585:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58c:	a1 6c 65 00 00       	mov    0x656c,%eax
     591:	c7 44 24 04 c0 48 00 	movl   $0x48c0,0x4(%esp)
     598:	00 
     599:	89 04 24             	mov    %eax,(%esp)
     59c:	e8 84 3c 00 00       	call   4225 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a1:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a8:	00 
     5a9:	c7 04 24 d0 48 00 00 	movl   $0x48d0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5be:	a1 6c 65 00 00       	mov    0x656c,%eax
     5c3:	c7 44 24 04 d4 48 00 	movl   $0x48d4,0x4(%esp)
     5ca:	00 
     5cb:	89 04 24             	mov    %eax,(%esp)
     5ce:	e8 52 3c 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60d:	a1 6c 65 00 00       	mov    0x656c,%eax
     612:	8b 55 f4             	mov    -0xc(%ebp),%edx
     615:	89 54 24 08          	mov    %edx,0x8(%esp)
     619:	c7 44 24 04 ee 48 00 	movl   $0x48ee,0x4(%esp)
     620:	00 
     621:	89 04 24             	mov    %eax,(%esp)
     624:	e8 fc 3b 00 00       	call   4225 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64d:	00 
     64e:	c7 04 24 d0 48 00 00 	movl   $0x48d0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     663:	a1 6c 65 00 00       	mov    0x656c,%eax
     668:	c7 44 24 04 0c 49 00 	movl   $0x490c,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 ad 3b 00 00       	call   4225 <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68b:	00 
     68c:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
     693:	00 
    ...
    if(i == 0){
     ...
     6b1:	a1 6c 65 00 00       	mov    0x656c,%eax
     6b6:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6b9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bd:	c7 44 24 04 25 49 00 	movl   $0x4925,0x4(%esp)
     6c4:	00 
     6c5:	89 04 24             	mov    %eax,(%esp)
     6c8:	e8 58 3b 00 00       	call   4225 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6de:	c7 04 24 d0 48 00 00 	movl   $0x48d0,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     75e:	a1 6c 65 00 00       	mov    0x656c,%eax
     763:	c7 44 24 04 74 49 00 	movl   $0x4974,0x4(%esp)
     76a:	00 
     76b:	89 04 24             	mov    %eax,(%esp)
     76e:	e8 b2 3a 00 00       	call   4225 <printf>
    exit();
     773:	e8 50 38 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "big files ok\n");
     778:	a1 6c 65 00 00       	mov    0x656c,%eax
     77d:	c7 44 24 04 87 49 00 	movl   $0x4987,0x4(%esp)
     784:	00 
     785:	89 04 24             	mov    %eax,(%esp)
     788:	e8 98 3a 00 00       	call   4225 <printf>
}
     78d:	c9                   	leave  
     78e:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     795:	a1 6c 65 00 00       	mov    0x656c,%eax
     79a:	c7 44 24 04 98 49 00 	movl   $0x4998,0x4(%esp)
     7a1:	00 
     7a2:	89 04 24             	mov    %eax,(%esp)
     7a5:	e8 7b 3a 00 00       	call   4225 <printf>

  name[0] = 'a';
     7aa:	c6 05 60 ad 00 00 61 	movb   $0x61,0xad60
  name[2] = '\0';
     7b1:	c6 05 62 ad 00 00 00 	movb   $0x0,0xad62
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7c7:	a2 61 ad 00 00       	mov    %al,0xad61
    fd = open(name, O_CREATE|O_RDWR);
     7cc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d3:	00 
     7d4:	c7 04 24 60 ad 00 00 	movl   $0xad60,(%esp)
  ...
  name[0] = 'a';
     7f7:	c6 05 60 ad 00 00 61 	movb   $0x61,0xad60
  name[2] = '\0';
     7fe:	c6 05 62 ad 00 00 00 	movb   $0x0,0xad62
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     814:	a2 61 ad 00 00       	mov    %al,0xad61
    unlink(name);
     819:	c7 04 24 60 ad 00 00 	movl   $0xad60,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     82e:	a1 6c 65 00 00       	mov    0x656c,%eax
     833:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
     83a:	00 
     83b:	89 04 24             	mov    %eax,(%esp)
     83e:	e8 e2 39 00 00       	call   4225 <printf>
}
     843:	c9                   	leave  
     844:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84b:	a1 6c 65 00 00       	mov    0x656c,%eax
     850:	c7 44 24 04 e6 49 00 	movl   $0x49e6,0x4(%esp)
     857:	00 
     858:	89 04 24             	mov    %eax,(%esp)
     85b:	e8 c5 39 00 00       	call   4225 <printf>

  if(mkdir("dir0") < 0){
     860:	c7 04 24 f2 49 00 00 	movl   $0x49f2,(%esp)
     867:	e8 c4 37 00 00       	call   4030 <mkdir>
     86c:	85 c0                	test   %eax,%eax
     86e:	79 1a                	jns    88a <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     870:	a1 6c 65 00 00       	mov    0x656c,%eax
     875:	c7 44 24 04 15 46 00 	movl   $0x4615,0x4(%esp)
     87c:	00 
     87d:	89 04 24             	mov    %eax,(%esp)
     880:	e8 a0 39 00 00       	call   4225 <printf>
    exit();
     885:	e8 3e 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("dir0") < 0){
     88a:	c7 04 24 f2 49 00 00 	movl   $0x49f2,(%esp)
     891:	e8 a2 37 00 00       	call   4038 <chdir>
     896:	85 c0                	test   %eax,%eax
     898:	79 1a                	jns    8b4 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89a:	a1 6c 65 00 00       	mov    0x656c,%eax
     89f:	c7 44 24 04 f7 49 00 	movl   $0x49f7,0x4(%esp)
     8a6:	00 
     8a7:	89 04 24             	mov    %eax,(%esp)
     8aa:	e8 76 39 00 00       	call   4225 <printf>
    exit();
     8af:	e8 14 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("..") < 0){
     8b4:	c7 04 24 0a 4a 00 00 	movl   $0x4a0a,(%esp)
     8bb:	e8 78 37 00 00       	call   4038 <chdir>
     8c0:	85 c0                	test   %eax,%eax
     8c2:	79 1a                	jns    8de <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c4:	a1 6c 65 00 00       	mov    0x656c,%eax
     8c9:	c7 44 24 04 0d 4a 00 	movl   $0x4a0d,0x4(%esp)
     8d0:	00 
     8d1:	89 04 24             	mov    %eax,(%esp)
     8d4:	e8 4c 39 00 00       	call   4225 <printf>
    exit();
     8d9:	e8 ea 36 00 00       	call   3fc8 <exit>
  }

  if(unlink("dir0") < 0){
     8de:	c7 04 24 f2 49 00 00 	movl   $0x49f2,(%esp)
     8e5:	e8 2e 37 00 00       	call   4018 <unlink>
     8ea:	85 c0                	test   %eax,%eax
     8ec:	79 1a                	jns    908 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8ee:	a1 6c 65 00 00       	mov    0x656c,%eax
     8f3:	c7 44 24 04 1e 4a 00 	movl   $0x4a1e,0x4(%esp)
     8fa:	00 
     8fb:	89 04 24             	mov    %eax,(%esp)
     8fe:	e8 22 39 00 00       	call   4225 <printf>
    exit();
     903:	e8 c0 36 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     908:	a1 6c 65 00 00       	mov    0x656c,%eax
     90d:	c7 44 24 04 32 4a 00 	movl   $0x4a32,0x4(%esp)
     914:	00 
     915:	89 04 24             	mov    %eax,(%esp)
     918:	e8 08 39 00 00       	call   4225 <printf>
}
     91d:	c9                   	leave  
     91e:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     925:	a1 6c 65 00 00       	mov    0x656c,%eax
     92a:	c7 44 24 04 41 4a 00 	movl   $0x4a41,0x4(%esp)
     931:	00 
     932:	89 04 24             	mov    %eax,(%esp)
     935:	e8 eb 38 00 00       	call   4225 <printf>
  if(exec("echo", echoargv) < 0){
     93a:	c7 44 24 04 58 65 00 	movl   $0x6558,0x4(%esp)
     941:	00 
     942:	c7 04 24 ec 45 00 00 	movl   $0x45ec,(%esp)
     949:	e8 b2 36 00 00       	call   4000 <exec>
     94e:	85 c0                	test   %eax,%eax
     950:	79 1a                	jns    96c <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     952:	a1 6c 65 00 00       	mov    0x656c,%eax
     957:	c7 44 24 04 4c 4a 00 	movl   $0x4a4c,0x4(%esp)
     95e:	00 
     95f:	89 04 24             	mov    %eax,(%esp)
     962:	e8 be 38 00 00       	call   4225 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     983:	c7 44 24 04 5e 4a 00 	movl   $0x4a5e,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 8e 38 00 00       	call   4225 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9de:	81 c2 60 8d 00 00    	add    $0x8d60,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9fc:	00 
     9fd:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
     a04:	00 
     ...
     a14:	c7 44 24 04 6d 4a 00 	movl   $0x4a6d,0x4(%esp)
     a1b:	00 
     a1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a23:	e8 fd 37 00 00       	call   4225 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6c:	05 60 8d 00 00       	add    $0x8d60,%eax
     ...
     a88:	c7 44 24 04 7b 4a 00 	movl   $0x4a7b,0x4(%esp)
     a8f:	00 
     a90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a97:	e8 89 37 00 00       	call   4225 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad5:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
     adc:	00 
    ...
    if(total != 5 * 1033){
     ...
     b02:	c7 44 24 04 89 4a 00 	movl   $0x4a89,0x4(%esp)
     b09:	00 
     b0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b11:	e8 0f 37 00 00       	call   4225 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2b:	c7 44 24 04 af 4a 00 	movl   $0x4aaf,0x4(%esp)
     b32:	00 
     b33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3a:	e8 e6 36 00 00       	call   4225 <printf>
    ...
    printf(1, "fork() failed\n");
     b41:	c7 44 24 04 a0 4a 00 	movl   $0x4aa0,0x4(%esp)
     b48:	00 
     b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b50:	e8 d0 36 00 00       	call   4225 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b62:	c7 44 24 04 b9 4a 00 	movl   $0x4ab9,0x4(%esp)
     b69:	00 
     b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b71:	e8 af 36 00 00       	call   4225 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc4:	00 
     bc5:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
     bcc:	00 
     ...
     bda:	c7 44 24 04 c5 4a 00 	movl   $0x4ac5,0x4(%esp)
     be1:	00 
     be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     be9:	e8 37 36 00 00       	call   4225 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c10:	00 
     c11:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
     c18:	00 
    ...
    printf(1, "preempt read error");
     c26:	c7 44 24 04 d9 4a 00 	movl   $0x4ad9,0x4(%esp)
     c2d:	00 
     c2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c35:	e8 eb 35 00 00       	call   4225 <printf>
  ...
  printf(1, "kill... ");
     c47:	c7 44 24 04 ec 4a 00 	movl   $0x4aec,0x4(%esp)
     c4e:	00 
     c4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c56:	e8 ca 35 00 00       	call   4225 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7c:	c7 44 24 04 f5 4a 00 	movl   $0x4af5,0x4(%esp)
     c83:	00 
     c84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8b:	e8 95 35 00 00       	call   4225 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c9f:	c7 44 24 04 fe 4a 00 	movl   $0x4afe,0x4(%esp)
     ca6:	00 
     ca7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cae:	e8 72 35 00 00       	call   4225 <printf>
}
     cb3:	c9                   	leave  
     cb4:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd0:	79 16                	jns    ce8 <exitwait+0x33>
      printf(1, "fork failed\n");
     cd2:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
     cd9:	00 
     cda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce1:	e8 3f 35 00 00       	call   4225 <printf>
      return;
    ...
    if(pid){
     ...
     cf8:	c7 44 24 04 0a 4b 00 	movl   $0x4b0a,0x4(%esp)
     cff:	00 
     d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d07:	e8 19 35 00 00       	call   4225 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d1c:	c7 44 24 04 1a 4b 00 	movl   $0x4b1a,0x4(%esp)
     d23:	00 
     d24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2b:	e8 f5 34 00 00       	call   4225 <printf>
}
     d30:	c9                   	leave  
     d31:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d38:	c7 44 24 04 27 4b 00 	movl   $0x4b27,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 d9 34 00 00       	call   4225 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d84:	e8 84 37 00 00       	call   450d <malloc>
    ...
    while(m1){
     ...
     da2:	e8 2d 36 00 00       	call   43d4 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df2:	e8 dd 35 00 00       	call   43d4 <free>
    printf(1, "mem ok\n");
     df7:	c7 44 24 04 4b 4b 00 	movl   $0x4b4b,0x4(%esp)
     dfe:	00 
     dff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e06:	e8 1a 34 00 00       	call   4225 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e1d:	c7 44 24 04 53 4b 00 	movl   $0x4b53,0x4(%esp)
     e24:	00 
     e25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2c:	e8 f4 33 00 00       	call   4225 <printf>

  unlink("sharedfd");
     e31:	c7 04 24 62 4b 00 00 	movl   $0x4b62,(%esp)
     e38:	e8 db 31 00 00       	call   4018 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e3d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e44:	00 
     e45:	c7 04 24 62 4b 00 00 	movl   $0x4b62,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5a:	c7 44 24 04 6c 4b 00 	movl   $0x4b6c,0x4(%esp)
     e61:	00 
     e62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e69:	e8 b7 33 00 00       	call   4225 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
     ed3:	00 
     ed4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edb:	e8 45 33 00 00       	call   4225 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f10:	00 
     f11:	c7 04 24 62 4b 00 00 	movl   $0x4b62,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f26:	c7 44 24 04 b8 4b 00 	movl   $0x4bb8,0x4(%esp)
     f2d:	00 
     f2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f35:	e8 eb 32 00 00       	call   4225 <printf>
    return;
  ...
  unlink("sharedfd");
     fb2:	c7 04 24 62 4b 00 00 	movl   $0x4b62,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd0:	c7 44 24 04 e3 4b 00 	movl   $0x4be3,0x4(%esp)
     fd7:	00 
     fd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdf:	e8 41 32 00 00       	call   4225 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ff4:	c7 44 24 04 f0 4b 00 	movl   $0x4bf0,0x4(%esp)
     ffb:	00 
     ffc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1003:	e8 1d 32 00 00       	call   4225 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    101b:	bb 6c 4c 00 00       	mov    $0x4c6c,%ebx
  ...
  printf(1, "fourfiles test\n");
    102d:	c7 44 24 04 05 4c 00 	movl   $0x4c05,0x4(%esp)
    1034:	00 
    1035:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103c:	e8 e4 31 00 00       	call   4225 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106e:	79 19                	jns    1089 <fourfiles+0x7a>
      printf(1, "fork failed\n");
    1070:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    1077:	00 
    1078:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    107f:	e8 a1 31 00 00       	call   4225 <printf>
      exit();
    ...
    10af:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    10b6:	00 
    10b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10be:	e8 62 31 00 00       	call   4225 <printf>
        exit();
    ...
    10da:	c7 04 24 60 8d 00 00 	movl   $0x8d60,(%esp)
    ...
    10f6:	00 
    10f7:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    10fe:	00 
    ...
    111d:	c7 44 24 04 24 4c 00 	movl   $0x4c24,0x4(%esp)
    1124:	00 
    1125:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    112c:	e8 f4 30 00 00       	call   4225 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11a9:	05 60 8d 00 00       	add    $0x8d60,%eax
    ...
    11bb:	74 19                	je     11d6 <fourfiles+0x1c7>
          printf(1, "wrong char\n");
    11bd:	c7 44 24 04 35 4c 00 	movl   $0x4c35,0x4(%esp)
    11c4:	00 
    11c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11cc:	e8 54 30 00 00       	call   4225 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ee:	00 
    11ef:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    11f6:	00 
    ...
    1226:	c7 44 24 04 41 4c 00 	movl   $0x4c41,0x4(%esp)
    122d:	00 
    122e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1235:	e8 eb 2f 00 00       	call   4225 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1257:	c7 44 24 04 52 4c 00 	movl   $0x4c52,0x4(%esp)
    125e:	00 
    125f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1266:	e8 ba 2f 00 00       	call   4225 <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1279:	c7 44 24 04 7c 4c 00 	movl   $0x4c7c,0x4(%esp)
    1280:	00 
    1281:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1288:	e8 98 2f 00 00       	call   4225 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12a5:	79 19                	jns    12c0 <createdelete+0x4d>
      printf(1, "fork failed\n");
    12a7:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    12ae:	00 
    12af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b6:	e8 6a 2f 00 00       	call   4225 <printf>
      exit();
    ...
    1306:	79 19                	jns    1321 <createdelete+0xae>
          printf(1, "create failed\n");
    1308:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    130f:	00 
    1310:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1317:	e8 09 2f 00 00       	call   4225 <printf>
          exit();
    ...
    135d:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
    1364:	00 
    1365:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    136c:	e8 b4 2e 00 00       	call   4225 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1415:	c7 44 24 04 90 4c 00 	movl   $0x4c90,0x4(%esp)
    141c:	00 
    141d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1424:	e8 fc 2d 00 00       	call   4225 <printf>
        exit();
    ...
    1447:	c7 44 24 04 b4 4c 00 	movl   $0x4cb4,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 ca 2d 00 00       	call   4225 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14cc:	c7 44 24 04 d4 4c 00 	movl   $0x4cd4,0x4(%esp)
    14d3:	00 
    14d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14db:	e8 45 2d 00 00       	call   4225 <printf>
}
    14e0:	c9                   	leave  
    14e1:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14e8:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f7:	e8 29 2d 00 00       	call   4225 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    14fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1503:	00 
    1504:	c7 04 24 f6 4c 00 00 	movl   $0x4cf6,(%esp)
  ...
  if(fd < 0){
    ...
    1519:	c7 44 24 04 01 4d 00 	movl   $0x4d01,0x4(%esp)
    1520:	00 
    1521:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1528:	e8 f8 2c 00 00       	call   4225 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1539:	00 
    153a:	c7 44 24 04 1b 4d 00 	movl   $0x4d1b,0x4(%esp)
    1541:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    155f:	00 
    1560:	c7 04 24 f6 4c 00 00 	movl   $0x4cf6,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15fb:	00 
    15fc:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    1603:	00 
    ...
    1614:	c7 44 24 04 57 4d 00 	movl   $0x4d57,0x4(%esp)
    161b:	00 
    161c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1623:	e8 fd 2b 00 00       	call   4225 <printf>
    exit();
    1628:	e8 9b 29 00 00       	call   3fc8 <exit>
  }
  if(buf[0] != 'h'){
    162d:	a0 60 8d 00 00       	mov    0x8d60,%al
    1632:	3c 68                	cmp    $0x68,%al
    1634:	74 19                	je     164f <unlinkread+0x16d>
    printf(1, "unlinkread wrong data\n");
    1636:	c7 44 24 04 6e 4d 00 	movl   $0x4d6e,0x4(%esp)
    163d:	00 
    163e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1645:	e8 db 2b 00 00       	call   4225 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1656:	00 
    1657:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    165e:	00 
    ...
    166f:	c7 44 24 04 85 4d 00 	movl   $0x4d85,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 a2 2b 00 00       	call   4225 <printf>
    exit();
  ...
  unlink("unlinkread");
    1693:	c7 04 24 f6 4c 00 00 	movl   $0x4cf6,(%esp)
    169a:	e8 79 29 00 00       	call   4018 <unlink>
  printf(1, "unlinkread ok\n");
    169f:	c7 44 24 04 9e 4d 00 	movl   $0x4d9e,0x4(%esp)
    16a6:	00 
    16a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ae:	e8 72 2b 00 00       	call   4225 <printf>
}
    16b3:	c9                   	leave  
    16b4:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16bb:	c7 44 24 04 ad 4d 00 	movl   $0x4dad,0x4(%esp)
    16c2:	00 
    16c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ca:	e8 56 2b 00 00       	call   4225 <printf>

  unlink("lf1");
    16cf:	c7 04 24 b7 4d 00 00 	movl   $0x4db7,(%esp)
    16d6:	e8 3d 29 00 00       	call   4018 <unlink>
  unlink("lf2");
    16db:	c7 04 24 bb 4d 00 00 	movl   $0x4dbb,(%esp)
    16e2:	e8 31 29 00 00       	call   4018 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16e7:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    16ee:	00 
    16ef:	c7 04 24 b7 4d 00 00 	movl   $0x4db7,(%esp)
  ...
  if(fd < 0){
    ...
    1704:	c7 44 24 04 bf 4d 00 	movl   $0x4dbf,0x4(%esp)
    170b:	00 
    170c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1713:	e8 0d 2b 00 00       	call   4225 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1724:	00 
    1725:	c7 44 24 04 1b 4d 00 	movl   $0x4d1b,0x4(%esp)
    172c:	00 
    ...
    173d:	c7 44 24 04 d2 4d 00 	movl   $0x4dd2,0x4(%esp)
    1744:	00 
    1745:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    174c:	e8 d4 2a 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 bb 4d 00 00 	movl   $0x4dbb,(%esp)
  ...
  if(fd < 0){
    ...
    17ec:	c7 44 24 04 21 4e 00 	movl   $0x4e21,0x4(%esp)
    17f3:	00 
    17f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17fb:	e8 25 2a 00 00       	call   4225 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    180c:	00 
    180d:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    1814:	00 
    ...
    1825:	c7 44 24 04 32 4e 00 	movl   $0x4e32,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1834:	e8 ec 29 00 00       	call   4225 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1849:	c7 44 24 04 bb 4d 00 	movl   $0x4dbb,0x4(%esp)
    1850:	00 
    1851:	c7 04 24 bb 4d 00 00 	movl   $0x4dbb,(%esp)
    1858:	e8 cb 27 00 00       	call   4028 <link>
    185d:	85 c0                	test   %eax,%eax
    185f:	78 19                	js     187a <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1861:	c7 44 24 04 43 4e 00 	movl   $0x4e43,0x4(%esp)
    1868:	00 
    1869:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1870:	e8 b0 29 00 00       	call   4225 <printf>
    exit();
    1875:	e8 4e 27 00 00       	call   3fc8 <exit>
  }

  unlink("lf2");
    187a:	c7 04 24 bb 4d 00 00 	movl   $0x4dbb,(%esp)
    1881:	e8 92 27 00 00       	call   4018 <unlink>
  if(link("lf2", "lf1") >= 0){
    1886:	c7 44 24 04 b7 4d 00 	movl   $0x4db7,0x4(%esp)
    188d:	00 
    188e:	c7 04 24 bb 4d 00 00 	movl   $0x4dbb,(%esp)
    1895:	e8 8e 27 00 00       	call   4028 <link>
    189a:	85 c0                	test   %eax,%eax
    189c:	78 19                	js     18b7 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    189e:	c7 44 24 04 64 4e 00 	movl   $0x4e64,0x4(%esp)
    18a5:	00 
    18a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18ad:	e8 73 29 00 00       	call   4225 <printf>
    exit();
    18b2:	e8 11 27 00 00       	call   3fc8 <exit>
  }

  if(link(".", "lf1") >= 0){
    18b7:	c7 44 24 04 b7 4d 00 	movl   $0x4db7,0x4(%esp)
    18be:	00 
    18bf:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
    18c6:	e8 5d 27 00 00       	call   4028 <link>
    18cb:	85 c0                	test   %eax,%eax
    18cd:	78 19                	js     18e8 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18cf:	c7 44 24 04 89 4e 00 	movl   $0x4e89,0x4(%esp)
    18d6:	00 
    18d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18de:	e8 42 29 00 00       	call   4225 <printf>
    exit();
    18e3:	e8 e0 26 00 00       	call   3fc8 <exit>
  }

  printf(1, "linktest ok\n");
    18e8:	c7 44 24 04 a5 4e 00 	movl   $0x4ea5,0x4(%esp)
    18ef:	00 
    18f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f7:	e8 29 29 00 00       	call   4225 <printf>
}
    18fc:	c9                   	leave  
    18fd:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1904:	c7 44 24 04 b2 4e 00 	movl   $0x4eb2,0x4(%esp)
    190b:	00 
    190c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1913:	e8 0d 29 00 00       	call   4225 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1967:	c7 04 24 c2 4e 00 00 	movl   $0x4ec2,(%esp)
    ...
    1994:	c7 04 24 c2 4e 00 00 	movl   $0x4ec2,(%esp)
    ...
    19c5:	c7 44 24 04 c5 4e 00 	movl   $0x4ec5,0x4(%esp)
    19cc:	00 
    19cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19d4:	e8 4c 28 00 00       	call   4225 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a28:	00 
    1a29:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1a87:	c7 44 24 04 e1 4e 00 	movl   $0x4ee1,0x4(%esp)
    1a8e:	00 
    1a8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a96:	e8 8a 27 00 00       	call   4225 <printf>
        exit();
    ...
    1ab8:	c7 44 24 04 fa 4e 00 	movl   $0x4efa,0x4(%esp)
    1abf:	00 
    1ac0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ac7:	e8 59 27 00 00       	call   4225 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b12:	c7 44 24 04 18 4f 00 	movl   $0x4f18,0x4(%esp)
    1b19:	00 
    1b1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b21:	e8 ff 26 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b4c:	79 19                	jns    1b67 <concreate+0x269>
      printf(1, "fork failed\n");
    1b4e:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    1b55:	00 
    1b56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b5d:	e8 c3 26 00 00       	call   4225 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1c4d:	c7 44 24 04 49 4f 00 	movl   $0x4f49,0x4(%esp)
    1c54:	00 
    1c55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c5c:	e8 c4 25 00 00       	call   4225 <printf>
}
    1c61:	c9                   	leave  
    1c62:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1c69:	c7 44 24 04 57 4f 00 	movl   $0x4f57,0x4(%esp)
    1c70:	00 
    1c71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c78:	e8 a8 25 00 00       	call   4225 <printf>

  unlink("x");
    1c7d:	c7 04 24 c3 4a 00 00 	movl   $0x4ac3,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1c97:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    1c9e:	00 
    1c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca6:	e8 7a 25 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d24:	00 
    1d25:	c7 04 24 c3 4a 00 00 	movl   $0x4ac3,(%esp)
    ...
    1d4f:	75 16                	jne    1d67 <linkunlink+0x104>
      link("cat", "x");
    1d51:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
    1d58:	00 
    1d59:	c7 04 24 68 4f 00 00 	movl   $0x4f68,(%esp)
    1d60:	e8 c3 22 00 00       	call   4028 <link>
    1d65:	eb 0c                	jmp    1d73 <linkunlink+0x110>
    } else {
      unlink("x");
    1d67:	c7 04 24 c3 4a 00 00 	movl   $0x4ac3,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d92:	c7 44 24 04 6c 4f 00 	movl   $0x4f6c,0x4(%esp)
    1d99:	00 
    1d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da1:	e8 7f 24 00 00       	call   4225 <printf>
}
    1da6:	c9                   	leave  
    1da7:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dae:	c7 44 24 04 7b 4f 00 	movl   $0x4f7b,0x4(%esp)
    1db5:	00 
    1db6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dbd:	e8 63 24 00 00       	call   4225 <printf>
  unlink("bd");
    1dc2:	c7 04 24 88 4f 00 00 	movl   $0x4f88,(%esp)
    1dc9:	e8 4a 22 00 00       	call   4018 <unlink>

  fd = open("bd", O_CREATE);
    1dce:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1dd5:	00 
    1dd6:	c7 04 24 88 4f 00 00 	movl   $0x4f88,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 8b 4f 00 	movl   $0x4f8b,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 26 24 00 00       	call   4225 <printf>
    exit();
  ...
  unlink("bd");
    1e86:	c7 04 24 88 4f 00 00 	movl   $0x4f88,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1edc:	c7 44 24 04 b5 4f 00 	movl   $0x4fb5,0x4(%esp)
    1ee3:	00 
    1ee4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eeb:	e8 35 23 00 00       	call   4225 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f01:	c7 44 24 04 ca 4f 00 	movl   $0x4fca,0x4(%esp)
    1f08:	00 
    1f09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f10:	e8 10 23 00 00       	call   4225 <printf>
}
    1f15:	c9                   	leave  
    1f16:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f1d:	c7 44 24 04 d5 4f 00 	movl   $0x4fd5,0x4(%esp)
    1f24:	00 
    1f25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f2c:	e8 f4 22 00 00       	call   4225 <printf>

  unlink("ff");
    1f31:	c7 04 24 e2 4f 00 00 	movl   $0x4fe2,(%esp)
    1f38:	e8 db 20 00 00       	call   4018 <unlink>
  if(mkdir("dd") != 0){
    1f3d:	c7 04 24 e5 4f 00 00 	movl   $0x4fe5,(%esp)
    1f44:	e8 e7 20 00 00       	call   4030 <mkdir>
    1f49:	85 c0                	test   %eax,%eax
    1f4b:	74 19                	je     1f66 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f4d:	c7 44 24 04 e8 4f 00 	movl   $0x4fe8,0x4(%esp)
    1f54:	00 
    1f55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5c:	e8 c4 22 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f6d:	00 
    1f6e:	c7 04 24 00 50 00 00 	movl   $0x5000,(%esp)
  ...
  if(fd < 0){
    ...
    1f83:	c7 44 24 04 06 50 00 	movl   $0x5006,0x4(%esp)
    1f8a:	00 
    1f8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f92:	e8 8e 22 00 00       	call   4225 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1fa3:	00 
    1fa4:	c7 44 24 04 e2 4f 00 	movl   $0x4fe2,0x4(%esp)
    1fab:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    201b:	00 
    201c:	c7 04 24 64 50 00 00 	movl   $0x5064,(%esp)
  ...
  if(fd < 0){
    ...
    2031:	c7 44 24 04 6d 50 00 	movl   $0x506d,0x4(%esp)
    2038:	00 
    2039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2040:	e8 e0 21 00 00       	call   4225 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    2051:	00 
    2052:	c7 44 24 04 85 50 00 	movl   $0x5085,0x4(%esp)
    2059:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2077:	00 
    2078:	c7 04 24 88 50 00 00 	movl   $0x5088,(%esp)
  ...
  if(fd < 0){
    ...
    208d:	c7 44 24 04 94 50 00 	movl   $0x5094,0x4(%esp)
    2094:	00 
    2095:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    209c:	e8 84 21 00 00       	call   4225 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20ad:	00 
    20ae:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    20b5:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    20ca:	a0 60 8d 00 00       	mov    0x8d60,%al
    20cf:	3c 66                	cmp    $0x66,%al
    20d1:	74 19                	je     20ec <subdir+0x1d5>
    printf(1, "dd/dd/../ff wrong content\n");
    20d3:	c7 44 24 04 ad 50 00 	movl   $0x50ad,0x4(%esp)
    20da:	00 
    20db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20e2:	e8 3e 21 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    222d:	00 
    222e:	c7 04 24 c8 50 00 00 	movl   $0x50c8,(%esp)
  ...
  if(fd < 0){
    ...
    2243:	c7 44 24 04 92 51 00 	movl   $0x5192,0x4(%esp)
    224a:	00 
    224b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2252:	e8 ce 1f 00 00       	call   4225 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2263:	00 
    2264:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    226b:	00 
    ...
    227c:	c7 44 24 04 aa 51 00 	movl   $0x51aa,0x4(%esp)
    2283:	00 
    2284:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228b:	e8 95 1f 00 00       	call   4225 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2661:	c7 44 24 04 24 54 00 	movl   $0x5424,0x4(%esp)
    2668:	00 
    2669:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2670:	e8 b0 1b 00 00       	call   4225 <printf>

  unlink("bigwrite");
    2675:	c7 04 24 33 54 00 00 	movl   $0x5433,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2694:	00 
    2695:	c7 04 24 33 54 00 00 	movl   $0x5433,(%esp)
    ...
    26aa:	c7 44 24 04 3c 54 00 	movl   $0x543c,0x4(%esp)
    26b1:	00 
    26b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b9:	e8 67 1b 00 00       	call   4225 <printf>
      exit();
    ...
    26d3:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    26da:	00 
    ...
    26ff:	c7 44 24 04 54 54 00 	movl   $0x5454,0x4(%esp)
    2706:	00 
    2707:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270e:	e8 12 1b 00 00       	call   4225 <printf>
        exit();
    ...
    unlink("bigwrite");
    272c:	c7 04 24 33 54 00 00 	movl   $0x5433,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    274c:	c7 44 24 04 66 54 00 	movl   $0x5466,0x4(%esp)
    2753:	00 
    2754:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275b:	e8 c5 1a 00 00       	call   4225 <printf>
}
    2760:	c9                   	leave  
    2761:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2768:	c7 44 24 04 73 54 00 	movl   $0x5473,0x4(%esp)
    276f:	00 
    2770:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2777:	e8 a9 1a 00 00       	call   4225 <printf>

  unlink("bigfile");
    277c:	c7 04 24 81 54 00 00 	movl   $0x5481,(%esp)
    2783:	e8 90 18 00 00       	call   4018 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2788:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    278f:	00 
    2790:	c7 04 24 81 54 00 00 	movl   $0x5481,(%esp)
  ...
  if(fd < 0){
    ...
    27a5:	c7 44 24 04 89 54 00 	movl   $0x5489,0x4(%esp)
    27ac:	00 
    27ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27b4:	e8 6c 1a 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    27d6:	c7 04 24 60 8d 00 00 	movl   $0x8d60,(%esp)
    27dd:	e8 42 16 00 00       	call   3e24 <memset>
    if(write(fd, buf, 600) != 600){
    27e2:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    27e9:	00 
    27ea:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    27f1:	00 
    ...
    2804:	c7 44 24 04 9f 54 00 	movl   $0x549f,0x4(%esp)
    280b:	00 
    280c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2813:	e8 0d 1a 00 00       	call   4225 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    2838:	00 
    2839:	c7 04 24 81 54 00 00 	movl   $0x5481,(%esp)
  ...
  if(fd < 0){
    ...
    284e:	c7 44 24 04 b5 54 00 	movl   $0x54b5,0x4(%esp)
    2855:	00 
    2856:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    285d:	e8 c3 19 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    287c:	00 
    287d:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    2884:	00 
    ...
    2899:	c7 44 24 04 ca 54 00 	movl   $0x54ca,0x4(%esp)
    28a0:	00 
    28a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28a8:	e8 78 19 00 00       	call   4225 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    28dc:	c7 44 24 04 df 54 00 	movl   $0x54df,0x4(%esp)
    28e3:	00 
    28e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28eb:	e8 35 19 00 00       	call   4225 <printf>
      exit();
    28f0:	e8 d3 16 00 00       	call   3fc8 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    28f5:	a0 60 8d 00 00       	mov    0x8d60,%al
    ...
    290d:	a0 8b 8e 00 00       	mov    0x8e8b,%al
    ...
    2923:	74 19                	je     293e <bigfile+0x1dc>
      printf(1, "read bigfile wrong data\n");
    2925:	c7 44 24 04 f3 54 00 	movl   $0x54f3,0x4(%esp)
    292c:	00 
    292d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2934:	e8 ec 18 00 00       	call   4225 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    294c:	c7 44 24 04 0c 55 00 	movl   $0x550c,0x4(%esp)
    2953:	00 
    2954:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    295b:	e8 c5 18 00 00       	call   4225 <printf>
    exit();
    2960:	e8 63 16 00 00       	call   3fc8 <exit>
  }
  unlink("bigfile");
    2965:	c7 04 24 81 54 00 00 	movl   $0x5481,(%esp)
    296c:	e8 a7 16 00 00       	call   4018 <unlink>

  printf(1, "bigfile test ok\n");
    2971:	c7 44 24 04 26 55 00 	movl   $0x5526,0x4(%esp)
    2978:	00 
    2979:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2980:	e8 a0 18 00 00       	call   4225 <printf>
}
    2985:	c9                   	leave  
    2986:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29fa:	00 
    29fb:	c7 04 24 c4 55 00 00 	movl   $0x55c4,(%esp)
  ...
  if(fd < 0){
    ...
    2a10:	c7 44 24 04 f4 55 00 	movl   $0x55f4,0x4(%esp)
    2a17:	00 
    2a18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a1f:	e8 01 18 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a3b:	00 
    2a3c:	c7 04 24 34 56 00 00 	movl   $0x5634,(%esp)
  ...
  if(fd < 0){
    ...
    2a51:	c7 44 24 04 64 56 00 	movl   $0x5664,0x4(%esp)
    2a58:	00 
    2a59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a60:	e8 c0 17 00 00       	call   4225 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2c5b:	c7 44 24 04 fb 57 00 	movl   $0x57fb,0x4(%esp)
    2c62:	00 
    2c63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6a:	e8 b6 15 00 00       	call   4225 <printf>

  fd = open("dirfile", O_CREATE);
    2c6f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2c76:	00 
    2c77:	c7 04 24 08 58 00 00 	movl   $0x5808,(%esp)
  ...
  if(fd < 0){
    ...
    2c8c:	c7 44 24 04 10 58 00 	movl   $0x5810,0x4(%esp)
    2c93:	00 
    2c94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9b:	e8 85 15 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce0:	00 
    2ce1:	c7 04 24 41 58 00 00 	movl   $0x5841,(%esp)
  ...
  if(fd >= 0){
    ...
    2cf6:	c7 44 24 04 4c 58 00 	movl   $0x584c,0x4(%esp)
    2cfd:	00 
    2cfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d05:	e8 1b 15 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d16:	00 
    2d17:	c7 04 24 41 58 00 00 	movl   $0x5841,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2df8:	00 
    2df9:	c7 04 24 87 4e 00 00 	movl   $0x4e87,(%esp)
  ...
  if(fd >= 0){
    ...
    2e0e:	c7 44 24 04 e4 58 00 	movl   $0x58e4,0x4(%esp)
    2e15:	00 
    2e16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e1d:	e8 03 14 00 00       	call   4225 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2e5d:	c7 44 24 04 03 59 00 	movl   $0x5903,0x4(%esp)
    2e64:	00 
    2e65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6c:	e8 b4 13 00 00       	call   4225 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2e81:	c7 44 24 04 17 59 00 	movl   $0x5917,0x4(%esp)
    2e88:	00 
    2e89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e90:	e8 90 13 00 00       	call   4225 <printf>
}
    2e95:	c9                   	leave  
    2e96:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2e9d:	c7 44 24 04 27 59 00 	movl   $0x5927,0x4(%esp)
    2ea4:	00 
    2ea5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2eac:	e8 74 13 00 00       	call   4225 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f5e:	00 
    2f5f:	c7 04 24 67 59 00 00 	movl   $0x5967,(%esp)
    ...
    unlink("xx");
    2f7f:	c7 04 24 67 59 00 00 	movl   $0x5967,(%esp)
  ...
  chdir("/");
    2f98:	c7 04 24 5e 46 00 00 	movl   $0x465e,(%esp)
    2f9f:	e8 94 10 00 00       	call   4038 <chdir>
  printf(1, "empty file name OK\n");
    2fa4:	c7 44 24 04 6a 59 00 	movl   $0x596a,0x4(%esp)
    2fab:	00 
    2fac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fb3:	e8 6d 12 00 00       	call   4225 <printf>
}
    2fb8:	c9                   	leave  
    2fb9:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2fc0:	c7 44 24 04 7e 59 00 	movl   $0x597e,0x4(%esp)
    2fc7:	00 
    2fc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fcf:	e8 51 12 00 00       	call   4225 <printf>
    ...
    2ff3:	e8 d0 0f 00 00       	call   3fc8 <exit>
{
  ...
  if(n == 1000){
    ...
    300d:	c7 44 24 04 8c 59 00 	movl   $0x598c,0x4(%esp)
    3014:	00 
    3015:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    301c:	e8 04 12 00 00       	call   4225 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3031:	c7 44 24 04 ae 59 00 	movl   $0x59ae,0x4(%esp)
    3038:	00 
    3039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3040:	e8 e0 11 00 00       	call   4225 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    305d:	c7 44 24 04 c2 59 00 	movl   $0x59c2,0x4(%esp)
    3064:	00 
    3065:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    306c:	e8 b4 11 00 00       	call   4225 <printf>
    exit();
    3071:	e8 52 0f 00 00       	call   3fc8 <exit>
  }

  printf(1, "fork test OK\n");
    3076:	c7 44 24 04 d5 59 00 	movl   $0x59d5,0x4(%esp)
    307d:	00 
    307e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3085:	e8 9b 11 00 00       	call   4225 <printf>
}
    308a:	c9                   	leave  
    308b:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3096:	a1 6c 65 00 00       	mov    0x656c,%eax
    309b:	c7 44 24 04 e3 59 00 	movl   $0x59e3,0x4(%esp)
    30a2:	00 
    30a3:	89 04 24             	mov    %eax,(%esp)
    30a6:	e8 7a 11 00 00       	call   4225 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    30e9:	a1 6c 65 00 00       	mov    0x656c,%eax
    ...
    3103:	c7 44 24 04 ee 59 00 	movl   $0x59ee,0x4(%esp)
    310a:	00 
    310b:	89 04 24             	mov    %eax,(%esp)
    310e:	e8 12 11 00 00       	call   4225 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    313f:	a1 6c 65 00 00       	mov    0x656c,%eax
    3144:	c7 44 24 04 09 5a 00 	movl   $0x5a09,0x4(%esp)
    314b:	00 
    314c:	89 04 24             	mov    %eax,(%esp)
    314f:	e8 d1 10 00 00       	call   4225 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3180:	a1 6c 65 00 00       	mov    0x656c,%eax
    3185:	c7 44 24 04 20 5a 00 	movl   $0x5a20,0x4(%esp)
    318c:	00 
    318d:	89 04 24             	mov    %eax,(%esp)
    3190:	e8 90 10 00 00       	call   4225 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    31de:	a1 6c 65 00 00       	mov    0x656c,%eax
    31e3:	c7 44 24 04 3c 5a 00 	movl   $0x5a3c,0x4(%esp)
    31ea:	00 
    31eb:	89 04 24             	mov    %eax,(%esp)
    31ee:	e8 32 10 00 00       	call   4225 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3229:	a1 6c 65 00 00       	mov    0x656c,%eax
    322e:	c7 44 24 04 7a 5a 00 	movl   $0x5a7a,0x4(%esp)
    3235:	00 
    3236:	89 04 24             	mov    %eax,(%esp)
    3239:	e8 e7 0f 00 00       	call   4225 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    325f:	a1 6c 65 00 00       	mov    0x656c,%eax
    ...
    3272:	c7 44 24 04 98 5a 00 	movl   $0x5a98,0x4(%esp)
    3279:	00 
    327a:	89 04 24             	mov    %eax,(%esp)
    327d:	e8 a3 0f 00 00       	call   4225 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    32c6:	a1 6c 65 00 00       	mov    0x656c,%eax
    ...
    32d9:	c7 44 24 04 d0 5a 00 	movl   $0x5ad0,0x4(%esp)
    32e0:	00 
    32e1:	89 04 24             	mov    %eax,(%esp)
    32e4:	e8 3c 0f 00 00       	call   4225 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    32f7:	a1 6c 65 00 00       	mov    0x656c,%eax
    32fc:	c7 44 24 04 f8 5a 00 	movl   $0x5af8,0x4(%esp)
    3303:	00 
    3304:	89 04 24             	mov    %eax,(%esp)
    3307:	e8 19 0f 00 00       	call   4225 <printf>
    exit();
  ...
  if(c != a){
    ...
    3346:	a1 6c 65 00 00       	mov    0x656c,%eax
    ...
    3359:	c7 44 24 04 28 5b 00 	movl   $0x5b28,0x4(%esp)
    3360:	00 
    3361:	89 04 24             	mov    %eax,(%esp)
    3364:	e8 bc 0e 00 00       	call   4225 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    338b:	79 1a                	jns    33a7 <sbrktest+0x31b>
      printf(stdout, "fork failed\n");
    338d:	a1 6c 65 00 00       	mov    0x656c,%eax
    3392:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    3399:	00 
    339a:	89 04 24             	mov    %eax,(%esp)
    339d:	e8 83 0e 00 00       	call   4225 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    340d:	c7 44 24 04 5e 4a 00 	movl   $0x4a5e,0x4(%esp)
    3414:	00 
    3415:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    341c:	e8 04 0e 00 00       	call   4225 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3470:	00 
    3471:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
    3478:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    350f:	a1 6c 65 00 00       	mov    0x656c,%eax
    3514:	c7 44 24 04 62 5b 00 	movl   $0x5b62,0x4(%esp)
    351b:	00 
    351c:	89 04 24             	mov    %eax,(%esp)
    351f:	e8 01 0d 00 00       	call   4225 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3555:	a1 6c 65 00 00       	mov    0x656c,%eax
    355a:	c7 44 24 04 7d 5b 00 	movl   $0x5b7d,0x4(%esp)
    3561:	00 
    3562:	89 04 24             	mov    %eax,(%esp)
    3565:	e8 bb 0c 00 00       	call   4225 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    359b:	a1 6c 65 00 00       	mov    0x656c,%eax
    35a0:	c7 44 24 04 8b 5b 00 	movl   $0x5b8b,0x4(%esp)
    35a7:	00 
    35a8:	89 04 24             	mov    %eax,(%esp)
    35ab:	e8 75 0c 00 00       	call   4225 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    360d:	c7 04 24 9a 5b 00 00 	movl   $0x5b9a,(%esp)
    3614:	e8 0f 0a 00 00       	call   4028 <link>
    3619:	83 f8 ff             	cmp    $0xffffffff,%eax
    361c:	74 1a                	je     3638 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    361e:	a1 6c 65 00 00       	mov    0x656c,%eax
    3623:	c7 44 24 04 a5 5b 00 	movl   $0x5ba5,0x4(%esp)
    362a:	00 
    362b:	89 04 24             	mov    %eax,(%esp)
    362e:	e8 f2 0b 00 00       	call   4225 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    364b:	a1 6c 65 00 00       	mov    0x656c,%eax
    3650:	c7 44 24 04 be 5b 00 	movl   $0x5bbe,0x4(%esp)
    3657:	00 
    3658:	89 04 24             	mov    %eax,(%esp)
    365b:	e8 c5 0b 00 00       	call   4225 <printf>
}
    3660:	c9                   	leave  
    3661:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3668:	a1 6c 65 00 00       	mov    0x656c,%eax
    366d:	c7 44 24 04 cb 5b 00 	movl   $0x5bcb,0x4(%esp)
    3674:	00 
    3675:	89 04 24             	mov    %eax,(%esp)
    3678:	e8 a8 0b 00 00       	call   4225 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    367d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3684:	eb 2b                	jmp    36b1 <bsstest+0x4f>
    if(uninit[i] != '\0'){
    3686:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3689:	05 40 66 00 00       	add    $0x6640,%eax
    368e:	8a 00                	mov    (%eax),%al
    3690:	84 c0                	test   %al,%al
    3692:	74 1a                	je     36ae <bsstest+0x4c>
      printf(stdout, "bss test failed\n");
    3694:	a1 6c 65 00 00       	mov    0x656c,%eax
    3699:	c7 44 24 04 d5 5b 00 	movl   $0x5bd5,0x4(%esp)
    36a0:	00 
    36a1:	89 04 24             	mov    %eax,(%esp)
    36a4:	e8 7c 0b 00 00       	call   4225 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    36bb:	a1 6c 65 00 00       	mov    0x656c,%eax
    36c0:	c7 44 24 04 e6 5b 00 	movl   $0x5be6,0x4(%esp)
    36c7:	00 
    36c8:	89 04 24             	mov    %eax,(%esp)
    36cb:	e8 55 0b 00 00       	call   4225 <printf>
}
    36d0:	c9                   	leave  
    36d1:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    36d8:	c7 04 24 f3 5b 00 00 	movl   $0x5bf3,(%esp)
  ...
  if(pid == 0){
    ...
    3702:	c7 04 85 a0 65 00 00 	movl   $0x5c00,0x65a0(,%eax,4)
    3709:	00 5c 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3714:	7e e9                	jle    36ff <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    3716:	c7 05 1c 66 00 00 00 	movl   $0x0,0x661c
    371d:	00 00 00 
    printf(stdout, "bigarg test\n");
    3720:	a1 6c 65 00 00       	mov    0x656c,%eax
    3725:	c7 44 24 04 dd 5c 00 	movl   $0x5cdd,0x4(%esp)
    372c:	00 
    372d:	89 04 24             	mov    %eax,(%esp)
    3730:	e8 f0 0a 00 00       	call   4225 <printf>
    exec("echo", args);
    3735:	c7 44 24 04 a0 65 00 	movl   $0x65a0,0x4(%esp)
    373c:	00 
    373d:	c7 04 24 ec 45 00 00 	movl   $0x45ec,(%esp)
    3744:	e8 b7 08 00 00       	call   4000 <exec>
    printf(stdout, "bigarg test ok\n");
    3749:	a1 6c 65 00 00       	mov    0x656c,%eax
    374e:	c7 44 24 04 ea 5c 00 	movl   $0x5cea,0x4(%esp)
    3755:	00 
    3756:	89 04 24             	mov    %eax,(%esp)
    3759:	e8 c7 0a 00 00       	call   4225 <printf>
    fd = open("bigarg-ok", O_CREATE);
    375e:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3765:	00 
    3766:	c7 04 24 f3 5b 00 00 	movl   $0x5bf3,(%esp)
    ...
    378b:	a1 6c 65 00 00       	mov    0x656c,%eax
    3790:	c7 44 24 04 fa 5c 00 	movl   $0x5cfa,0x4(%esp)
    3797:	00 
    3798:	89 04 24             	mov    %eax,(%esp)
    379b:	e8 85 0a 00 00       	call   4225 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    37b1:	00 
    37b2:	c7 04 24 f3 5b 00 00 	movl   $0x5bf3,(%esp)
  ...
  if(fd < 0){
    ...
    37c7:	a1 6c 65 00 00       	mov    0x656c,%eax
    37cc:	c7 44 24 04 13 5d 00 	movl   $0x5d13,0x4(%esp)
    37d3:	00 
    37d4:	89 04 24             	mov    %eax,(%esp)
    37d7:	e8 49 0a 00 00       	call   4225 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    37ec:	c7 04 24 f3 5b 00 00 	movl   $0x5bf3,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3808:	c7 44 24 04 28 5d 00 	movl   $0x5d28,0x4(%esp)
    380f:	00 
    3810:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3817:	e8 09 0a 00 00       	call   4225 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    390c:	c7 44 24 04 35 5d 00 	movl   $0x5d35,0x4(%esp)
    3913:	00 
    3914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    391b:	e8 05 09 00 00       	call   4225 <printf>
    ...
    3943:	c7 44 24 04 41 5d 00 	movl   $0x5d41,0x4(%esp)
    394a:	00 
    394b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3952:	e8 ce 08 00 00       	call   4225 <printf>
      break;
    ...
    3967:	00 
    3968:	c7 44 24 04 60 8d 00 	movl   $0x8d60,0x4(%esp)
    396f:	00 
    ...
    398f:	c7 44 24 04 51 5d 00 	movl   $0x5d51,0x4(%esp)
    3996:	00 
    3997:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399e:	e8 82 08 00 00       	call   4225 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3aca:	c7 44 24 04 61 5d 00 	movl   $0x5d61,0x4(%esp)
    3ad1:	00 
    3ad2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ad9:	e8 47 07 00 00       	call   4225 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3af4:	c7 44 24 04 77 5d 00 	movl   $0x5d77,0x4(%esp)
    3afb:	00 
    3afc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b03:	e8 1d 07 00 00       	call   4225 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b38:	c7 44 24 04 84 5d 00 	movl   $0x5d84,0x4(%esp)
    3b3f:	00 
    3b40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b47:	e8 d9 06 00 00       	call   4225 <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b57:	c7 44 24 04 8d 46 00 	movl   $0x468d,0x4(%esp)
    3b5e:	00 
    3b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b66:	e8 ba 06 00 00       	call   4225 <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3b75:	c7 44 24 04 a5 5d 00 	movl   $0x5da5,0x4(%esp)
    3b7c:	00 
    3b7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b84:	e8 9c 06 00 00       	call   4225 <printf>
}
    3b89:	c9                   	leave  
    3b8a:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3b98:	00 
    3b99:	c7 04 24 b4 5d 00 00 	movl   $0x5db4,(%esp)
  ...
  if (fd < 0) {
    ...
    3bae:	c7 44 24 04 b9 5d 00 	movl   $0x5db9,0x4(%esp)
    3bb5:	00 
    3bb6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bbd:	e8 63 06 00 00       	call   4225 <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3bf6:	c7 44 24 04 c6 5d 00 	movl   $0x5dc6,0x4(%esp)
    3bfd:	00 
    3bfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c05:	e8 1b 06 00 00       	call   4225 <printf>
}
    3c0a:	c9                   	leave  
    3c0b:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c0f:	8b 15 70 65 00 00    	mov    0x6570,%edx
    ...
    3c4a:	a3 70 65 00 00       	mov    %eax,0x6570
  return randstate;
    3c4f:	a1 70 65 00 00       	mov    0x6570,%eax
}
    3c54:	5d                   	pop    %ebp
    3c55:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cab:	00 
    3cac:	c7 04 24 eb 5d 00 00 	movl   $0x5deb,(%esp)
...
00004078 <get_max_proc>:
SYSCALL(get_max_proc)
    4078:	b8 18 00 00 00       	mov    $0x18,%eax
    407d:	cd 40                	int    $0x40
    407f:	c3                   	ret    

00004080 <get_max_mem>:
SYSCALL(get_max_mem)
    4080:	b8 19 00 00 00       	mov    $0x19,%eax
    4085:	cd 40                	int    $0x40
    4087:	c3                   	ret    

00004088 <get_max_disk>:
SYSCALL(get_max_disk)
    4088:	b8 1a 00 00 00       	mov    $0x1a,%eax
    408d:	cd 40                	int    $0x40
    408f:	c3                   	ret    

00004090 <get_curr_proc>:
SYSCALL(get_curr_proc)
    4090:	b8 1b 00 00 00       	mov    $0x1b,%eax
    4095:	cd 40                	int    $0x40
    4097:	c3                   	ret    

00004098 <get_curr_mem>:
SYSCALL(get_curr_mem)
    4098:	b8 1c 00 00 00       	mov    $0x1c,%eax
    409d:	cd 40                	int    $0x40
    409f:	c3                   	ret    

000040a0 <get_curr_disk>:
SYSCALL(get_curr_disk)
    40a0:	b8 1d 00 00 00       	mov    $0x1d,%eax
    40a5:	cd 40                	int    $0x40
    40a7:	c3                   	ret    

000040a8 <set_name>:
SYSCALL(set_name)
    40a8:	b8 1e 00 00 00       	mov    $0x1e,%eax
    40ad:	cd 40                	int    $0x40
    40af:	c3                   	ret    

000040b0 <set_max_mem>:
SYSCALL(set_max_mem)
    40b0:	b8 1f 00 00 00       	mov    $0x1f,%eax
    40b5:	cd 40                	int    $0x40
    40b7:	c3                   	ret    

000040b8 <set_max_disk>:
SYSCALL(set_max_disk)
    40b8:	b8 20 00 00 00       	mov    $0x20,%eax
    40bd:	cd 40                	int    $0x40
    40bf:	c3                   	ret    

000040c0 <set_max_proc>:
SYSCALL(set_max_proc)
    40c0:	b8 21 00 00 00       	mov    $0x21,%eax
    40c5:	cd 40                	int    $0x40
    40c7:	c3                   	ret    

000040c8 <set_curr_mem>:
SYSCALL(set_curr_mem)
    40c8:	b8 22 00 00 00       	mov    $0x22,%eax
    40cd:	cd 40                	int    $0x40
    40cf:	c3                   	ret    

000040d0 <set_curr_disk>:
SYSCALL(set_curr_disk)
    40d0:	b8 23 00 00 00       	mov    $0x23,%eax
    40d5:	cd 40                	int    $0x40
    40d7:	c3                   	ret    

000040d8 <set_curr_proc>:
SYSCALL(set_curr_proc)
    40d8:	b8 24 00 00 00       	mov    $0x24,%eax
    40dd:	cd 40                	int    $0x40
    40df:	c3                   	ret    

000040e0 <find>:
SYSCALL(find)
    40e0:	b8 25 00 00 00       	mov    $0x25,%eax
    40e5:	cd 40                	int    $0x40
    40e7:	c3                   	ret    

000040e8 <is_full>:
SYSCALL(is_full)
    40e8:	b8 26 00 00 00       	mov    $0x26,%eax
    40ed:	cd 40                	int    $0x40
    40ef:	c3                   	ret    

000040f0 <container_init>:
SYSCALL(container_init)
    40f0:	b8 27 00 00 00       	mov    $0x27,%eax
    40f5:	cd 40                	int    $0x40
    40f7:	c3                   	ret    

000040f8 <cont_proc_set>:
SYSCALL(cont_proc_set)
    40f8:	b8 28 00 00 00       	mov    $0x28,%eax
    40fd:	cd 40                	int    $0x40
    40ff:	c3                   	ret    

00004100 <ps>:
SYSCALL(ps)
    4100:	b8 29 00 00 00       	mov    $0x29,%eax
    4105:	cd 40                	int    $0x40
    4107:	c3                   	ret    

00004108 <reduce_curr_mem>:
SYSCALL(reduce_curr_mem)
    4108:	b8 2a 00 00 00       	mov    $0x2a,%eax
    410d:	cd 40                	int    $0x40
    410f:	c3                   	ret    

00004110 <set_root_inode>:
SYSCALL(set_root_inode)
    4110:	b8 2b 00 00 00       	mov    $0x2b,%eax
    4115:	cd 40                	int    $0x40
    4117:	c3                   	ret    

00004118 <cstop>:
SYSCALL(cstop)
    4118:	b8 2c 00 00 00       	mov    $0x2c,%eax
    411d:	cd 40                	int    $0x40
    411f:	c3                   	ret    

00004120 <df>:
SYSCALL(df)
    4120:	b8 2d 00 00 00       	mov    $0x2d,%eax
    4125:	cd 40                	int    $0x40
    4127:	c3                   	ret    

00004128 <max_containers>:
SYSCALL(max_containers)
    4128:	b8 2e 00 00 00       	mov    $0x2e,%eax
    412d:	cd 40                	int    $0x40
    412f:	c3                   	ret    

00004130 <container_reset>:
SYSCALL(container_reset)
    4130:	b8 2f 00 00 00       	mov    $0x2f,%eax
    4135:	cd 40                	int    $0x40
    4137:	c3                   	ret    

00004138 <pause>:
SYSCALL(pause)
    4138:	b8 30 00 00 00       	mov    $0x30,%eax
    413d:	cd 40                	int    $0x40
    413f:	c3                   	ret    

00004140 <resume>:
SYSCALL(resume)
    4140:	b8 31 00 00 00       	mov    $0x31,%eax
    4145:	cd 40                	int    $0x40
    4147:	c3                   	ret    
...
{
    4148:	55                   	push   %ebp
    4149:	89 e5                	mov    %esp,%ebp
    414b:	83 ec 18             	sub    $0x18,%esp
    414e:	8b 45 0c             	mov    0xc(%ebp),%eax
    4151:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    4154:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    415b:	00 
    415c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    415f:	89 44 24 04          	mov    %eax,0x4(%esp)
    4163:	8b 45 08             	mov    0x8(%ebp),%eax
    4166:	89 04 24             	mov    %eax,(%esp)
    4169:	e8 7a fe ff ff       	call   3fe8 <write>
}
    416e:	c9                   	leave  
    416f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    4178:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    417f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    4183:	74 17                	je     419c <printint+0x2c>
    4185:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4189:	79 11                	jns    419c <printint+0x2c>
    neg = 1;
    418b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    4192:	8b 45 0c             	mov    0xc(%ebp),%eax
    4195:	f7 d8                	neg    %eax
    4197:	89 45 ec             	mov    %eax,-0x14(%ebp)
    419a:	eb 06                	jmp    41a2 <printint+0x32>
  } else {
    x = xx;
    419c:	8b 45 0c             	mov    0xc(%ebp),%eax
    419f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    41a2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    41a9:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    41ac:	8d 41 01             	lea    0x1(%ecx),%eax
    41af:	89 45 f4             	mov    %eax,-0xc(%ebp)
    41b2:	8b 5d 10             	mov    0x10(%ebp),%ebx
    41b5:	8b 45 ec             	mov    -0x14(%ebp),%eax
    41b8:	ba 00 00 00 00       	mov    $0x0,%edx
    41bd:	f7 f3                	div    %ebx
    41bf:	89 d0                	mov    %edx,%eax
    41c1:	8a 80 74 65 00 00    	mov    0x6574(%eax),%al
    41c7:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    41cb:	8b 75 10             	mov    0x10(%ebp),%esi
    41ce:	8b 45 ec             	mov    -0x14(%ebp),%eax
    41d1:	ba 00 00 00 00       	mov    $0x0,%edx
    41d6:	f7 f6                	div    %esi
    41d8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    41db:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41df:	75 c8                	jne    41a9 <printint+0x39>
  if(neg)
    41e1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    41e5:	74 10                	je     41f7 <printint+0x87>
    buf[i++] = '-';
    41e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41ea:	8d 50 01             	lea    0x1(%eax),%edx
    41ed:	89 55 f4             	mov    %edx,-0xc(%ebp)
    41f0:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    41f5:	eb 1e                	jmp    4215 <printint+0xa5>
    41f7:	eb 1c                	jmp    4215 <printint+0xa5>
    putc(fd, buf[i]);
    41f9:	8d 55 dc             	lea    -0x24(%ebp),%edx
    41fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41ff:	01 d0                	add    %edx,%eax
    4201:	8a 00                	mov    (%eax),%al
    4203:	0f be c0             	movsbl %al,%eax
    4206:	89 44 24 04          	mov    %eax,0x4(%esp)
    420a:	8b 45 08             	mov    0x8(%ebp),%eax
    420d:	89 04 24             	mov    %eax,(%esp)
    4210:	e8 33 ff ff ff       	call   4148 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4215:	ff 4d f4             	decl   -0xc(%ebp)
    4218:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    421c:	79 db                	jns    41f9 <printint+0x89>
    putc(fd, buf[i]);
}
    421e:	83 c4 30             	add    $0x30,%esp
    4221:	5b                   	pop    %ebx
    4222:	5e                   	pop    %esi
    4223:	5d                   	pop    %ebp
    4224:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4228:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    422b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4232:	8d 45 0c             	lea    0xc(%ebp),%eax
    4235:	83 c0 04             	add    $0x4,%eax
    4238:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    423b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4242:	e9 77 01 00 00       	jmp    43be <printf+0x199>
    c = fmt[i] & 0xff;
    4247:	8b 55 0c             	mov    0xc(%ebp),%edx
    424a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    424d:	01 d0                	add    %edx,%eax
    424f:	8a 00                	mov    (%eax),%al
    4251:	0f be c0             	movsbl %al,%eax
    4254:	25 ff 00 00 00       	and    $0xff,%eax
    4259:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    425c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4260:	75 2c                	jne    428e <printf+0x69>
      if(c == '%'){
    4262:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4266:	75 0c                	jne    4274 <printf+0x4f>
        state = '%';
    4268:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    426f:	e9 47 01 00 00       	jmp    43bb <printf+0x196>
      } else {
        putc(fd, c);
    4274:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4277:	0f be c0             	movsbl %al,%eax
    427a:	89 44 24 04          	mov    %eax,0x4(%esp)
    427e:	8b 45 08             	mov    0x8(%ebp),%eax
    4281:	89 04 24             	mov    %eax,(%esp)
    4284:	e8 bf fe ff ff       	call   4148 <putc>
    4289:	e9 2d 01 00 00       	jmp    43bb <printf+0x196>
      }
    } else if(state == '%'){
    428e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4292:	0f 85 23 01 00 00    	jne    43bb <printf+0x196>
      if(c == 'd'){
    4298:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    429c:	75 2d                	jne    42cb <printf+0xa6>
        printint(fd, *ap, 10, 1);
    429e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42a1:	8b 00                	mov    (%eax),%eax
    42a3:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    42aa:	00 
    42ab:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    42b2:	00 
    42b3:	89 44 24 04          	mov    %eax,0x4(%esp)
    42b7:	8b 45 08             	mov    0x8(%ebp),%eax
    42ba:	89 04 24             	mov    %eax,(%esp)
    42bd:	e8 ae fe ff ff       	call   4170 <printint>
        ap++;
    42c2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42c6:	e9 e9 00 00 00       	jmp    43b4 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    42cb:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    42cf:	74 06                	je     42d7 <printf+0xb2>
    42d1:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    42d5:	75 2d                	jne    4304 <printf+0xdf>
        printint(fd, *ap, 16, 0);
    42d7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42da:	8b 00                	mov    (%eax),%eax
    42dc:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    42e3:	00 
    42e4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    42eb:	00 
    42ec:	89 44 24 04          	mov    %eax,0x4(%esp)
    42f0:	8b 45 08             	mov    0x8(%ebp),%eax
    42f3:	89 04 24             	mov    %eax,(%esp)
    42f6:	e8 75 fe ff ff       	call   4170 <printint>
        ap++;
    42fb:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42ff:	e9 b0 00 00 00       	jmp    43b4 <printf+0x18f>
      } else if(c == 's'){
    4304:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4308:	75 42                	jne    434c <printf+0x127>
        s = (char*)*ap;
    430a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    430d:	8b 00                	mov    (%eax),%eax
    430f:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4312:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4316:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    431a:	75 09                	jne    4325 <printf+0x100>
          s = "(null)";
    431c:	c7 45 f4 26 5e 00 00 	movl   $0x5e26,-0xc(%ebp)
        while(*s != 0){
    4323:	eb 1c                	jmp    4341 <printf+0x11c>
    4325:	eb 1a                	jmp    4341 <printf+0x11c>
          putc(fd, *s);
    4327:	8b 45 f4             	mov    -0xc(%ebp),%eax
    432a:	8a 00                	mov    (%eax),%al
    432c:	0f be c0             	movsbl %al,%eax
    432f:	89 44 24 04          	mov    %eax,0x4(%esp)
    4333:	8b 45 08             	mov    0x8(%ebp),%eax
    4336:	89 04 24             	mov    %eax,(%esp)
    4339:	e8 0a fe ff ff       	call   4148 <putc>
          s++;
    433e:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    4344:	8a 00                	mov    (%eax),%al
    4346:	84 c0                	test   %al,%al
    4348:	75 dd                	jne    4327 <printf+0x102>
    434a:	eb 68                	jmp    43b4 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    434c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4350:	75 1d                	jne    436f <printf+0x14a>
        putc(fd, *ap);
    4352:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4355:	8b 00                	mov    (%eax),%eax
    4357:	0f be c0             	movsbl %al,%eax
    435a:	89 44 24 04          	mov    %eax,0x4(%esp)
    435e:	8b 45 08             	mov    0x8(%ebp),%eax
    4361:	89 04 24             	mov    %eax,(%esp)
    4364:	e8 df fd ff ff       	call   4148 <putc>
        ap++;
    4369:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    436d:	eb 45                	jmp    43b4 <printf+0x18f>
      } else if(c == '%'){
    436f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4373:	75 17                	jne    438c <printf+0x167>
        putc(fd, c);
    4375:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4378:	0f be c0             	movsbl %al,%eax
    437b:	89 44 24 04          	mov    %eax,0x4(%esp)
    437f:	8b 45 08             	mov    0x8(%ebp),%eax
    4382:	89 04 24             	mov    %eax,(%esp)
    4385:	e8 be fd ff ff       	call   4148 <putc>
    438a:	eb 28                	jmp    43b4 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    438c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4393:	00 
    4394:	8b 45 08             	mov    0x8(%ebp),%eax
    4397:	89 04 24             	mov    %eax,(%esp)
    439a:	e8 a9 fd ff ff       	call   4148 <putc>
        putc(fd, c);
    439f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    43a2:	0f be c0             	movsbl %al,%eax
    43a5:	89 44 24 04          	mov    %eax,0x4(%esp)
    43a9:	8b 45 08             	mov    0x8(%ebp),%eax
    43ac:	89 04 24             	mov    %eax,(%esp)
    43af:	e8 94 fd ff ff       	call   4148 <putc>
      }
      state = 0;
    43b4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    43bb:	ff 45 f0             	incl   -0x10(%ebp)
    43be:	8b 55 0c             	mov    0xc(%ebp),%edx
    43c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43c4:	01 d0                	add    %edx,%eax
    43c6:	8a 00                	mov    (%eax),%al
    43c8:	84 c0                	test   %al,%al
    43ca:	0f 85 77 fe ff ff    	jne    4247 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    43d7:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    43da:	8b 45 08             	mov    0x8(%ebp),%eax
    43dd:	83 e8 08             	sub    $0x8,%eax
    43e0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    43e3:	a1 28 66 00 00       	mov    0x6628,%eax
    43e8:	89 45 fc             	mov    %eax,-0x4(%ebp)
    43eb:	eb 24                	jmp    4411 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    43ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43f0:	8b 00                	mov    (%eax),%eax
    43f2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43f5:	77 12                	ja     4409 <free+0x35>
    43f7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43fa:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43fd:	77 24                	ja     4423 <free+0x4f>
    43ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4402:	8b 00                	mov    (%eax),%eax
    4404:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4407:	77 1a                	ja     4423 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    440e:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4411:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4414:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4417:	76 d4                	jbe    43ed <free+0x19>
    4419:	8b 45 fc             	mov    -0x4(%ebp),%eax
    441c:	8b 00                	mov    (%eax),%eax
    441e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4421:	76 ca                	jbe    43ed <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    4423:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4426:	8b 40 04             	mov    0x4(%eax),%eax
    4429:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4430:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4433:	01 c2                	add    %eax,%edx
    4435:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4438:	8b 00                	mov    (%eax),%eax
    443a:	39 c2                	cmp    %eax,%edx
    443c:	75 24                	jne    4462 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    443e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4441:	8b 50 04             	mov    0x4(%eax),%edx
    4444:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4447:	8b 00                	mov    (%eax),%eax
    4449:	8b 40 04             	mov    0x4(%eax),%eax
    444c:	01 c2                	add    %eax,%edx
    444e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4451:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    4454:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4457:	8b 00                	mov    (%eax),%eax
    4459:	8b 10                	mov    (%eax),%edx
    445b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    445e:	89 10                	mov    %edx,(%eax)
    4460:	eb 0a                	jmp    446c <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    4462:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4465:	8b 10                	mov    (%eax),%edx
    4467:	8b 45 f8             	mov    -0x8(%ebp),%eax
    446a:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    446c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    446f:	8b 40 04             	mov    0x4(%eax),%eax
    4472:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4479:	8b 45 fc             	mov    -0x4(%ebp),%eax
    447c:	01 d0                	add    %edx,%eax
    447e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4481:	75 20                	jne    44a3 <free+0xcf>
    p->s.size += bp->s.size;
    4483:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4486:	8b 50 04             	mov    0x4(%eax),%edx
    4489:	8b 45 f8             	mov    -0x8(%ebp),%eax
    448c:	8b 40 04             	mov    0x4(%eax),%eax
    448f:	01 c2                	add    %eax,%edx
    4491:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4494:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4497:	8b 45 f8             	mov    -0x8(%ebp),%eax
    449a:	8b 10                	mov    (%eax),%edx
    449c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    449f:	89 10                	mov    %edx,(%eax)
    44a1:	eb 08                	jmp    44ab <free+0xd7>
  } else
    p->s.ptr = bp;
    44a3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44a6:	8b 55 f8             	mov    -0x8(%ebp),%edx
    44a9:	89 10                	mov    %edx,(%eax)
  freep = p;
    44ab:	8b 45 fc             	mov    -0x4(%ebp),%eax
    44ae:	a3 28 66 00 00       	mov    %eax,0x6628
}
    44b3:	c9                   	leave  
    44b4:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    44b8:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    44bb:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    44c2:	77 07                	ja     44cb <morecore+0x16>
    nu = 4096;
    44c4:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    44cb:	8b 45 08             	mov    0x8(%ebp),%eax
    44ce:	c1 e0 03             	shl    $0x3,%eax
    44d1:	89 04 24             	mov    %eax,(%esp)
    44d4:	e8 77 fb ff ff       	call   4050 <sbrk>
    44d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    44dc:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    44e0:	75 07                	jne    44e9 <morecore+0x34>
    return 0;
    44e2:	b8 00 00 00 00       	mov    $0x0,%eax
    44e7:	eb 22                	jmp    450b <morecore+0x56>
  hp = (Header*)p;
    44e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44ec:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    44ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44f2:	8b 55 08             	mov    0x8(%ebp),%edx
    44f5:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    44f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44fb:	83 c0 08             	add    $0x8,%eax
    44fe:	89 04 24             	mov    %eax,(%esp)
    4501:	e8 ce fe ff ff       	call   43d4 <free>
  return freep;
    4506:	a1 28 66 00 00       	mov    0x6628,%eax
}
    450b:	c9                   	leave  
    450c:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4510:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4513:	8b 45 08             	mov    0x8(%ebp),%eax
    4516:	83 c0 07             	add    $0x7,%eax
    4519:	c1 e8 03             	shr    $0x3,%eax
    451c:	40                   	inc    %eax
    451d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4520:	a1 28 66 00 00       	mov    0x6628,%eax
    4525:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4528:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    452c:	75 23                	jne    4551 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    452e:	c7 45 f0 20 66 00 00 	movl   $0x6620,-0x10(%ebp)
    4535:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4538:	a3 28 66 00 00       	mov    %eax,0x6628
    453d:	a1 28 66 00 00       	mov    0x6628,%eax
    4542:	a3 20 66 00 00       	mov    %eax,0x6620
    base.s.size = 0;
    4547:	c7 05 24 66 00 00 00 	movl   $0x0,0x6624
    454e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    455c:	8b 40 04             	mov    0x4(%eax),%eax
    455f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4562:	72 4d                	jb     45b1 <malloc+0xa4>
      if(p->s.size == nunits)
    4564:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4567:	8b 40 04             	mov    0x4(%eax),%eax
    456a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    456d:	75 0c                	jne    457b <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    456f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4572:	8b 10                	mov    (%eax),%edx
    4574:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4577:	89 10                	mov    %edx,(%eax)
    4579:	eb 26                	jmp    45a1 <malloc+0x94>
      else {
        p->s.size -= nunits;
    457b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    457e:	8b 40 04             	mov    0x4(%eax),%eax
    4581:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4584:	89 c2                	mov    %eax,%edx
    4586:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4589:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    458c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    458f:	8b 40 04             	mov    0x4(%eax),%eax
    4592:	c1 e0 03             	shl    $0x3,%eax
    4595:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4598:	8b 45 f4             	mov    -0xc(%ebp),%eax
    459b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    459e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    45a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    45a4:	a3 28 66 00 00       	mov    %eax,0x6628
      return (void*)(p + 1);
    45a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45ac:	83 c0 08             	add    $0x8,%eax
    45af:	eb 38                	jmp    45e9 <malloc+0xdc>
    }
    if(p == freep)
    45b1:	a1 28 66 00 00       	mov    0x6628,%eax
    45b6:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    45b9:	75 1b                	jne    45d6 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    45bb:	8b 45 ec             	mov    -0x14(%ebp),%eax
    45be:	89 04 24             	mov    %eax,(%esp)
    45c1:	e8 ef fe ff ff       	call   44b5 <morecore>
    45c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    45c9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    45cd:	75 07                	jne    45d6 <malloc+0xc9>
        return 0;
    45cf:	b8 00 00 00 00       	mov    $0x0,%eax
    45d4:	eb 13                	jmp    45e9 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    45d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45d9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    45dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45df:	8b 00                	mov    (%eax),%eax
    45e1:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    45e4:	e9 70 ff ff ff       	jmp    4559 <malloc+0x4c>
}
    45e9:	c9                   	leave  
    45ea:	c3                   	ret    
