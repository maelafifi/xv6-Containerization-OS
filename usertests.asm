...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 54 65 00 00       	mov    0x6554,%eax
       b:	c7 44 24 04 ea 45 00 	movl   $0x45ea,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 f2 41 00 00       	call   420d <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      2b:	a1 54 65 00 00       	mov    0x6554,%eax
      30:	c7 44 24 04 fd 45 00 	movl   $0x45fd,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 cd 41 00 00       	call   420d <printf>
    exit();
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 54 65 00 00       	mov    0x6554,%eax
      5a:	c7 44 24 04 0b 46 00 	movl   $0x460b,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 a3 41 00 00       	call   420d <printf>
    exit();
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 54 65 00 00       	mov    0x6554,%eax
      84:	c7 44 24 04 2c 46 00 	movl   $0x462c,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 79 41 00 00       	call   420d <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 54 65 00 00       	mov    0x6554,%eax
      e5:	c7 44 24 04 66 46 00 	movl   $0x4666,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 18 41 00 00       	call   420d <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 54 65 00 00       	mov    0x6554,%eax
     108:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 f5 40 00 00       	call   420d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 54 65 00 00       	mov    0x6554,%eax
     13c:	c7 44 24 04 fd 45 00 	movl   $0x45fd,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 c1 40 00 00       	call   420d <printf>
      exit();
    ...
    if(chdir("iputdir") < 0){
     ...
     161:	a1 54 65 00 00       	mov    0x6554,%eax
     166:	c7 44 24 04 82 46 00 	movl   $0x4682,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 97 40 00 00       	call   420d <printf>
      exit();
    ...
    if(unlink("../iputdir") < 0){
     ...
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 54 65 00 00       	mov    0x6554,%eax
     190:	c7 44 24 04 2c 46 00 	movl   $0x462c,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 6d 40 00 00       	call   420d <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 54 65 00 00       	mov    0x6554,%eax
     1b4:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 49 40 00 00       	call   420d <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 54 65 00 00       	mov    0x6554,%eax
     1d1:	c7 44 24 04 a8 46 00 	movl   $0x46a8,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 2c 40 00 00       	call   420d <printf>
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 54 65 00 00       	mov    0x6554,%eax
     1f6:	c7 44 24 04 bd 46 00 	movl   $0x46bd,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 07 40 00 00       	call   420d <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 54 65 00 00       	mov    0x6554,%eax
     21e:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 df 3f 00 00       	call   420d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     256:	a1 54 65 00 00       	mov    0x6554,%eax
     25b:	c7 44 24 04 d4 46 00 	movl   $0x46d4,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 a2 3f 00 00       	call   420d <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     291:	a1 54 65 00 00       	mov    0x6554,%eax
     296:	c7 44 24 04 f8 46 00 	movl   $0x46f8,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 67 3f 00 00       	call   420d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 54 65 00 00       	mov    0x6554,%eax
     2b5:	c7 44 24 04 07 47 00 	movl   $0x4707,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 48 3f 00 00       	call   420d <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 54 65 00 00       	mov    0x6554,%eax
     2d2:	c7 44 24 04 19 47 00 	movl   $0x4719,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 2b 3f 00 00       	call   420d <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 54 65 00 00       	mov    0x6554,%eax
     304:	c7 44 24 04 24 47 00 	movl   $0x4724,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 f9 3e 00 00       	call   420d <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 54 65 00 00       	mov    0x6554,%eax
     37d:	c7 44 24 04 70 47 00 	movl   $0x4770,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 80 3e 00 00       	call   420d <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 54 65 00 00       	mov    0x6554,%eax
     3af:	c7 44 24 04 87 47 00 	movl   $0x4787,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 4e 3e 00 00       	call   420d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 54 65 00 00       	mov    0x6554,%eax
     3d0:	c7 44 24 04 a2 47 00 	movl   $0x47a2,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 2d 3e 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     405:	a1 54 65 00 00       	mov    0x6554,%eax
     ...
     41c:	e8 ec 3d 00 00       	call   420d <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     446:	a1 54 65 00 00       	mov    0x6554,%eax
     ...
     45d:	e8 ab 3d 00 00       	call   420d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     474:	a1 54 65 00 00       	mov    0x6554,%eax
     479:	c7 44 24 04 20 48 00 	movl   $0x4820,0x4(%esp)
     480:	00 
     481:	89 04 24             	mov    %eax,(%esp)
     484:	e8 84 3d 00 00       	call   420d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49b:	00 
     49c:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b1:	a1 54 65 00 00       	mov    0x6554,%eax
     4b6:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
     4bd:	00 
     4be:	89 04 24             	mov    %eax,(%esp)
     4c1:	e8 47 3d 00 00       	call   420d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4ef:	a1 54 65 00 00       	mov    0x6554,%eax
     4f4:	c7 44 24 04 44 48 00 	movl   $0x4844,0x4(%esp)
     4fb:	00 
     4fc:	89 04 24             	mov    %eax,(%esp)
     4ff:	e8 09 3d 00 00       	call   420d <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     509:	a1 54 65 00 00       	mov    0x6554,%eax
     50e:	c7 44 24 04 5f 48 00 	movl   $0x485f,0x4(%esp)
     515:	00 
     516:	89 04 24             	mov    %eax,(%esp)
     519:	e8 ef 3c 00 00       	call   420d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     529:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53b:	a1 54 65 00 00       	mov    0x6554,%eax
     540:	c7 44 24 04 72 48 00 	movl   $0x4872,0x4(%esp)
     547:	00 
     548:	89 04 24             	mov    %eax,(%esp)
     54b:	e8 bd 3c 00 00       	call   420d <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     555:	a1 54 65 00 00       	mov    0x6554,%eax
     55a:	c7 44 24 04 7f 48 00 	movl   $0x487f,0x4(%esp)
     561:	00 
     562:	89 04 24             	mov    %eax,(%esp)
     565:	e8 a3 3c 00 00       	call   420d <printf>
    exit();
     56a:	e8 59 3a 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "small file test ok\n");
     56f:	a1 54 65 00 00       	mov    0x6554,%eax
     574:	c7 44 24 04 94 48 00 	movl   $0x4894,0x4(%esp)
     57b:	00 
     57c:	89 04 24             	mov    %eax,(%esp)
     57f:	e8 89 3c 00 00       	call   420d <printf>
}
     584:	c9                   	leave  
     585:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58c:	a1 54 65 00 00       	mov    0x6554,%eax
     591:	c7 44 24 04 a8 48 00 	movl   $0x48a8,0x4(%esp)
     598:	00 
     599:	89 04 24             	mov    %eax,(%esp)
     59c:	e8 6c 3c 00 00       	call   420d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a1:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a8:	00 
     5a9:	c7 04 24 b8 48 00 00 	movl   $0x48b8,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5be:	a1 54 65 00 00       	mov    0x6554,%eax
     5c3:	c7 44 24 04 bc 48 00 	movl   $0x48bc,0x4(%esp)
     5ca:	00 
     5cb:	89 04 24             	mov    %eax,(%esp)
     5ce:	e8 3a 3c 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60d:	a1 54 65 00 00       	mov    0x6554,%eax
     612:	8b 55 f4             	mov    -0xc(%ebp),%edx
     615:	89 54 24 08          	mov    %edx,0x8(%esp)
     619:	c7 44 24 04 d6 48 00 	movl   $0x48d6,0x4(%esp)
     620:	00 
     621:	89 04 24             	mov    %eax,(%esp)
     624:	e8 e4 3b 00 00       	call   420d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64d:	00 
     64e:	c7 04 24 b8 48 00 00 	movl   $0x48b8,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     663:	a1 54 65 00 00       	mov    0x6554,%eax
     668:	c7 44 24 04 f4 48 00 	movl   $0x48f4,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 95 3b 00 00       	call   420d <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b1:	a1 54 65 00 00       	mov    0x6554,%eax
     6b6:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6b9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bd:	c7 44 24 04 0d 49 00 	movl   $0x490d,0x4(%esp)
     6c4:	00 
     6c5:	89 04 24             	mov    %eax,(%esp)
     6c8:	e8 40 3b 00 00       	call   420d <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6de:	c7 04 24 b8 48 00 00 	movl   $0x48b8,(%esp)
     ...
     6fd:	a1 54 65 00 00       	mov    0x6554,%eax
     702:	8b 55 f4             	mov    -0xc(%ebp),%edx
     705:	89 54 24 08          	mov    %edx,0x8(%esp)
     709:	c7 44 24 04 2a 49 00 	movl   $0x492a,0x4(%esp)
     710:	00 
     711:	89 04 24             	mov    %eax,(%esp)
     714:	e8 f4 3a 00 00       	call   420d <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     75e:	a1 54 65 00 00       	mov    0x6554,%eax
     763:	c7 44 24 04 5c 49 00 	movl   $0x495c,0x4(%esp)
     76a:	00 
     76b:	89 04 24             	mov    %eax,(%esp)
     76e:	e8 9a 3a 00 00       	call   420d <printf>
    exit();
     773:	e8 50 38 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "big files ok\n");
     778:	a1 54 65 00 00       	mov    0x6554,%eax
     77d:	c7 44 24 04 6f 49 00 	movl   $0x496f,0x4(%esp)
     784:	00 
     785:	89 04 24             	mov    %eax,(%esp)
     788:	e8 80 3a 00 00       	call   420d <printf>
}
     78d:	c9                   	leave  
     78e:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     795:	a1 54 65 00 00       	mov    0x6554,%eax
     79a:	c7 44 24 04 80 49 00 	movl   $0x4980,0x4(%esp)
     7a1:	00 
     7a2:	89 04 24             	mov    %eax,(%esp)
     7a5:	e8 63 3a 00 00       	call   420d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     82e:	a1 54 65 00 00       	mov    0x6554,%eax
     833:	c7 44 24 04 a8 49 00 	movl   $0x49a8,0x4(%esp)
     83a:	00 
     83b:	89 04 24             	mov    %eax,(%esp)
     83e:	e8 ca 39 00 00       	call   420d <printf>
}
     843:	c9                   	leave  
     844:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84b:	a1 54 65 00 00       	mov    0x6554,%eax
     850:	c7 44 24 04 ce 49 00 	movl   $0x49ce,0x4(%esp)
     857:	00 
     858:	89 04 24             	mov    %eax,(%esp)
     85b:	e8 ad 39 00 00       	call   420d <printf>

  if(mkdir("dir0") < 0){
     860:	c7 04 24 da 49 00 00 	movl   $0x49da,(%esp)
     867:	e8 c4 37 00 00       	call   4030 <mkdir>
     86c:	85 c0                	test   %eax,%eax
     86e:	79 1a                	jns    88a <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     870:	a1 54 65 00 00       	mov    0x6554,%eax
     875:	c7 44 24 04 fd 45 00 	movl   $0x45fd,0x4(%esp)
     87c:	00 
     87d:	89 04 24             	mov    %eax,(%esp)
     880:	e8 88 39 00 00       	call   420d <printf>
    exit();
     885:	e8 3e 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("dir0") < 0){
     88a:	c7 04 24 da 49 00 00 	movl   $0x49da,(%esp)
     891:	e8 a2 37 00 00       	call   4038 <chdir>
     896:	85 c0                	test   %eax,%eax
     898:	79 1a                	jns    8b4 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89a:	a1 54 65 00 00       	mov    0x6554,%eax
     89f:	c7 44 24 04 df 49 00 	movl   $0x49df,0x4(%esp)
     8a6:	00 
     8a7:	89 04 24             	mov    %eax,(%esp)
     8aa:	e8 5e 39 00 00       	call   420d <printf>
    exit();
     8af:	e8 14 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("..") < 0){
     8b4:	c7 04 24 f2 49 00 00 	movl   $0x49f2,(%esp)
     8bb:	e8 78 37 00 00       	call   4038 <chdir>
     8c0:	85 c0                	test   %eax,%eax
     8c2:	79 1a                	jns    8de <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c4:	a1 54 65 00 00       	mov    0x6554,%eax
     8c9:	c7 44 24 04 f5 49 00 	movl   $0x49f5,0x4(%esp)
     8d0:	00 
     8d1:	89 04 24             	mov    %eax,(%esp)
     8d4:	e8 34 39 00 00       	call   420d <printf>
    exit();
     8d9:	e8 ea 36 00 00       	call   3fc8 <exit>
  }

  if(unlink("dir0") < 0){
     8de:	c7 04 24 da 49 00 00 	movl   $0x49da,(%esp)
     8e5:	e8 2e 37 00 00       	call   4018 <unlink>
     8ea:	85 c0                	test   %eax,%eax
     8ec:	79 1a                	jns    908 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8ee:	a1 54 65 00 00       	mov    0x6554,%eax
     8f3:	c7 44 24 04 06 4a 00 	movl   $0x4a06,0x4(%esp)
     8fa:	00 
     8fb:	89 04 24             	mov    %eax,(%esp)
     8fe:	e8 0a 39 00 00       	call   420d <printf>
    exit();
     903:	e8 c0 36 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     908:	a1 54 65 00 00       	mov    0x6554,%eax
     90d:	c7 44 24 04 1a 4a 00 	movl   $0x4a1a,0x4(%esp)
     914:	00 
     915:	89 04 24             	mov    %eax,(%esp)
     918:	e8 f0 38 00 00       	call   420d <printf>
}
     91d:	c9                   	leave  
     91e:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     925:	a1 54 65 00 00       	mov    0x6554,%eax
     92a:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
     931:	00 
     932:	89 04 24             	mov    %eax,(%esp)
     935:	e8 d3 38 00 00       	call   420d <printf>
  if(exec("echo", echoargv) < 0){
     93a:	c7 44 24 04 40 65 00 	movl   $0x6540,0x4(%esp)
     941:	00 
     942:	c7 04 24 d4 45 00 00 	movl   $0x45d4,(%esp)
     949:	e8 b2 36 00 00       	call   4000 <exec>
     94e:	85 c0                	test   %eax,%eax
     950:	79 1a                	jns    96c <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     952:	a1 54 65 00 00       	mov    0x6554,%eax
     957:	c7 44 24 04 34 4a 00 	movl   $0x4a34,0x4(%esp)
     95e:	00 
     95f:	89 04 24             	mov    %eax,(%esp)
     962:	e8 a6 38 00 00       	call   420d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     983:	c7 44 24 04 46 4a 00 	movl   $0x4a46,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 76 38 00 00       	call   420d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a14:	c7 44 24 04 55 4a 00 	movl   $0x4a55,0x4(%esp)
     a1b:	00 
     a1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a23:	e8 e5 37 00 00       	call   420d <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a88:	c7 44 24 04 63 4a 00 	movl   $0x4a63,0x4(%esp)
     a8f:	00 
     a90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a97:	e8 71 37 00 00       	call   420d <printf>
    ...
    if(total != 5 * 1033){
     ...
     b02:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
     b09:	00 
     b0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b11:	e8 f7 36 00 00       	call   420d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2b:	c7 44 24 04 97 4a 00 	movl   $0x4a97,0x4(%esp)
     b32:	00 
     b33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3a:	e8 ce 36 00 00       	call   420d <printf>
    ...
    printf(1, "fork() failed\n");
     b41:	c7 44 24 04 88 4a 00 	movl   $0x4a88,0x4(%esp)
     b48:	00 
     b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b50:	e8 b8 36 00 00       	call   420d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b62:	c7 44 24 04 a1 4a 00 	movl   $0x4aa1,0x4(%esp)
     b69:	00 
     b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b71:	e8 97 36 00 00       	call   420d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc4:	00 
     bc5:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
     bcc:	00 
     ...
     bda:	c7 44 24 04 ad 4a 00 	movl   $0x4aad,0x4(%esp)
     be1:	00 
     be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     be9:	e8 1f 36 00 00       	call   420d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c26:	c7 44 24 04 c1 4a 00 	movl   $0x4ac1,0x4(%esp)
     c2d:	00 
     c2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c35:	e8 d3 35 00 00       	call   420d <printf>
  ...
  printf(1, "kill... ");
     c47:	c7 44 24 04 d4 4a 00 	movl   $0x4ad4,0x4(%esp)
     c4e:	00 
     c4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c56:	e8 b2 35 00 00       	call   420d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7c:	c7 44 24 04 dd 4a 00 	movl   $0x4add,0x4(%esp)
     c83:	00 
     c84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8b:	e8 7d 35 00 00       	call   420d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c9f:	c7 44 24 04 e6 4a 00 	movl   $0x4ae6,0x4(%esp)
     ca6:	00 
     ca7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cae:	e8 5a 35 00 00       	call   420d <printf>
}
     cb3:	c9                   	leave  
     cb4:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd0:	79 16                	jns    ce8 <exitwait+0x33>
      printf(1, "fork failed\n");
     cd2:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
     cd9:	00 
     cda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce1:	e8 27 35 00 00       	call   420d <printf>
      return;
    ...
    if(pid){
     ...
     cf8:	c7 44 24 04 f2 4a 00 	movl   $0x4af2,0x4(%esp)
     cff:	00 
     d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d07:	e8 01 35 00 00       	call   420d <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d1c:	c7 44 24 04 02 4b 00 	movl   $0x4b02,0x4(%esp)
     d23:	00 
     d24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2b:	e8 dd 34 00 00       	call   420d <printf>
}
     d30:	c9                   	leave  
     d31:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d38:	c7 44 24 04 0f 4b 00 	movl   $0x4b0f,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 c1 34 00 00       	call   420d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d84:	e8 6c 37 00 00       	call   44f5 <malloc>
    ...
    while(m1){
     ...
     da2:	e8 15 36 00 00       	call   43bc <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df2:	e8 c5 35 00 00       	call   43bc <free>
    printf(1, "mem ok\n");
     df7:	c7 44 24 04 33 4b 00 	movl   $0x4b33,0x4(%esp)
     dfe:	00 
     dff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e06:	e8 02 34 00 00       	call   420d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e1d:	c7 44 24 04 3b 4b 00 	movl   $0x4b3b,0x4(%esp)
     e24:	00 
     e25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2c:	e8 dc 33 00 00       	call   420d <printf>

  unlink("sharedfd");
     e31:	c7 04 24 4a 4b 00 00 	movl   $0x4b4a,(%esp)
     e38:	e8 db 31 00 00       	call   4018 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e3d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e44:	00 
     e45:	c7 04 24 4a 4b 00 00 	movl   $0x4b4a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5a:	c7 44 24 04 54 4b 00 	movl   $0x4b54,0x4(%esp)
     e61:	00 
     e62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e69:	e8 9f 33 00 00       	call   420d <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	c7 44 24 04 80 4b 00 	movl   $0x4b80,0x4(%esp)
     ed3:	00 
     ed4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edb:	e8 2d 33 00 00       	call   420d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f10:	00 
     f11:	c7 04 24 4a 4b 00 00 	movl   $0x4b4a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f26:	c7 44 24 04 a0 4b 00 	movl   $0x4ba0,0x4(%esp)
     f2d:	00 
     f2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f35:	e8 d3 32 00 00       	call   420d <printf>
    return;
  ...
  unlink("sharedfd");
     fb2:	c7 04 24 4a 4b 00 00 	movl   $0x4b4a,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd0:	c7 44 24 04 cb 4b 00 	movl   $0x4bcb,0x4(%esp)
     fd7:	00 
     fd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdf:	e8 29 32 00 00       	call   420d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ff4:	c7 44 24 04 d8 4b 00 	movl   $0x4bd8,0x4(%esp)
     ffb:	00 
     ffc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1003:	e8 05 32 00 00       	call   420d <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    101b:	bb 54 4c 00 00       	mov    $0x4c54,%ebx
  ...
  printf(1, "fourfiles test\n");
    102d:	c7 44 24 04 ed 4b 00 	movl   $0x4bed,0x4(%esp)
    1034:	00 
    1035:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103c:	e8 cc 31 00 00       	call   420d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106e:	79 19                	jns    1089 <fourfiles+0x7a>
      printf(1, "fork failed\n");
    1070:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    1077:	00 
    1078:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    107f:	e8 89 31 00 00       	call   420d <printf>
      exit();
    ...
    10af:	c7 44 24 04 fd 4b 00 	movl   $0x4bfd,0x4(%esp)
    10b6:	00 
    10b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10be:	e8 4a 31 00 00       	call   420d <printf>
        exit();
    ...
    111d:	c7 44 24 04 0c 4c 00 	movl   $0x4c0c,0x4(%esp)
    1124:	00 
    1125:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    112c:	e8 dc 30 00 00       	call   420d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11bb:	74 19                	je     11d6 <fourfiles+0x1c7>
          printf(1, "wrong char\n");
    11bd:	c7 44 24 04 1d 4c 00 	movl   $0x4c1d,0x4(%esp)
    11c4:	00 
    11c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11cc:	e8 3c 30 00 00       	call   420d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1226:	c7 44 24 04 29 4c 00 	movl   $0x4c29,0x4(%esp)
    122d:	00 
    122e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1235:	e8 d3 2f 00 00       	call   420d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1257:	c7 44 24 04 3a 4c 00 	movl   $0x4c3a,0x4(%esp)
    125e:	00 
    125f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1266:	e8 a2 2f 00 00       	call   420d <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1279:	c7 44 24 04 64 4c 00 	movl   $0x4c64,0x4(%esp)
    1280:	00 
    1281:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1288:	e8 80 2f 00 00       	call   420d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12a5:	79 19                	jns    12c0 <createdelete+0x4d>
      printf(1, "fork failed\n");
    12a7:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    12ae:	00 
    12af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b6:	e8 52 2f 00 00       	call   420d <printf>
      exit();
    ...
    1306:	79 19                	jns    1321 <createdelete+0xae>
          printf(1, "create failed\n");
    1308:	c7 44 24 04 fd 4b 00 	movl   $0x4bfd,0x4(%esp)
    130f:	00 
    1310:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1317:	e8 f1 2e 00 00       	call   420d <printf>
          exit();
    ...
    135d:	c7 44 24 04 f8 46 00 	movl   $0x46f8,0x4(%esp)
    1364:	00 
    1365:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    136c:	e8 9c 2e 00 00       	call   420d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1415:	c7 44 24 04 78 4c 00 	movl   $0x4c78,0x4(%esp)
    141c:	00 
    141d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1424:	e8 e4 2d 00 00       	call   420d <printf>
        exit();
    ...
    1447:	c7 44 24 04 9c 4c 00 	movl   $0x4c9c,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 b2 2d 00 00       	call   420d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14cc:	c7 44 24 04 bc 4c 00 	movl   $0x4cbc,0x4(%esp)
    14d3:	00 
    14d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14db:	e8 2d 2d 00 00       	call   420d <printf>
}
    14e0:	c9                   	leave  
    14e1:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14e8:	c7 44 24 04 cd 4c 00 	movl   $0x4ccd,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f7:	e8 11 2d 00 00       	call   420d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    14fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1503:	00 
    1504:	c7 04 24 de 4c 00 00 	movl   $0x4cde,(%esp)
  ...
  if(fd < 0){
    ...
    1519:	c7 44 24 04 e9 4c 00 	movl   $0x4ce9,0x4(%esp)
    1520:	00 
    1521:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1528:	e8 e0 2c 00 00       	call   420d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1539:	00 
    153a:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    1541:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    155f:	00 
    1560:	c7 04 24 de 4c 00 00 	movl   $0x4cde,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1614:	c7 44 24 04 3f 4d 00 	movl   $0x4d3f,0x4(%esp)
    161b:	00 
    161c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1623:	e8 e5 2b 00 00       	call   420d <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1636:	c7 44 24 04 56 4d 00 	movl   $0x4d56,0x4(%esp)
    163d:	00 
    163e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1645:	e8 c3 2b 00 00       	call   420d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    166f:	c7 44 24 04 6d 4d 00 	movl   $0x4d6d,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 8a 2b 00 00       	call   420d <printf>
    exit();
  ...
  unlink("unlinkread");
    1693:	c7 04 24 de 4c 00 00 	movl   $0x4cde,(%esp)
    169a:	e8 79 29 00 00       	call   4018 <unlink>
  printf(1, "unlinkread ok\n");
    169f:	c7 44 24 04 86 4d 00 	movl   $0x4d86,0x4(%esp)
    16a6:	00 
    16a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ae:	e8 5a 2b 00 00       	call   420d <printf>
}
    16b3:	c9                   	leave  
    16b4:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16bb:	c7 44 24 04 95 4d 00 	movl   $0x4d95,0x4(%esp)
    16c2:	00 
    16c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ca:	e8 3e 2b 00 00       	call   420d <printf>

  unlink("lf1");
    16cf:	c7 04 24 9f 4d 00 00 	movl   $0x4d9f,(%esp)
    16d6:	e8 3d 29 00 00       	call   4018 <unlink>
  unlink("lf2");
    16db:	c7 04 24 a3 4d 00 00 	movl   $0x4da3,(%esp)
    16e2:	e8 31 29 00 00       	call   4018 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16e7:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    16ee:	00 
    16ef:	c7 04 24 9f 4d 00 00 	movl   $0x4d9f,(%esp)
  ...
  if(fd < 0){
    ...
    1704:	c7 44 24 04 a7 4d 00 	movl   $0x4da7,0x4(%esp)
    170b:	00 
    170c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1713:	e8 f5 2a 00 00       	call   420d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1724:	00 
    1725:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    172c:	00 
    ...
    173d:	c7 44 24 04 ba 4d 00 	movl   $0x4dba,0x4(%esp)
    1744:	00 
    1745:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    174c:	e8 bc 2a 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 a3 4d 00 00 	movl   $0x4da3,(%esp)
  ...
  if(fd < 0){
    ...
    17ec:	c7 44 24 04 09 4e 00 	movl   $0x4e09,0x4(%esp)
    17f3:	00 
    17f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17fb:	e8 0d 2a 00 00       	call   420d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1825:	c7 44 24 04 1a 4e 00 	movl   $0x4e1a,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1834:	e8 d4 29 00 00       	call   420d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1849:	c7 44 24 04 a3 4d 00 	movl   $0x4da3,0x4(%esp)
    1850:	00 
    1851:	c7 04 24 a3 4d 00 00 	movl   $0x4da3,(%esp)
    1858:	e8 cb 27 00 00       	call   4028 <link>
    185d:	85 c0                	test   %eax,%eax
    185f:	78 19                	js     187a <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1861:	c7 44 24 04 2b 4e 00 	movl   $0x4e2b,0x4(%esp)
    1868:	00 
    1869:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1870:	e8 98 29 00 00       	call   420d <printf>
    exit();
    1875:	e8 4e 27 00 00       	call   3fc8 <exit>
  }

  unlink("lf2");
    187a:	c7 04 24 a3 4d 00 00 	movl   $0x4da3,(%esp)
    1881:	e8 92 27 00 00       	call   4018 <unlink>
  if(link("lf2", "lf1") >= 0){
    1886:	c7 44 24 04 9f 4d 00 	movl   $0x4d9f,0x4(%esp)
    188d:	00 
    188e:	c7 04 24 a3 4d 00 00 	movl   $0x4da3,(%esp)
    1895:	e8 8e 27 00 00       	call   4028 <link>
    189a:	85 c0                	test   %eax,%eax
    189c:	78 19                	js     18b7 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    189e:	c7 44 24 04 4c 4e 00 	movl   $0x4e4c,0x4(%esp)
    18a5:	00 
    18a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18ad:	e8 5b 29 00 00       	call   420d <printf>
    exit();
    18b2:	e8 11 27 00 00       	call   3fc8 <exit>
  }

  if(link(".", "lf1") >= 0){
    18b7:	c7 44 24 04 9f 4d 00 	movl   $0x4d9f,0x4(%esp)
    18be:	00 
    18bf:	c7 04 24 6f 4e 00 00 	movl   $0x4e6f,(%esp)
    18c6:	e8 5d 27 00 00       	call   4028 <link>
    18cb:	85 c0                	test   %eax,%eax
    18cd:	78 19                	js     18e8 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18cf:	c7 44 24 04 71 4e 00 	movl   $0x4e71,0x4(%esp)
    18d6:	00 
    18d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18de:	e8 2a 29 00 00       	call   420d <printf>
    exit();
    18e3:	e8 e0 26 00 00       	call   3fc8 <exit>
  }

  printf(1, "linktest ok\n");
    18e8:	c7 44 24 04 8d 4e 00 	movl   $0x4e8d,0x4(%esp)
    18ef:	00 
    18f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f7:	e8 11 29 00 00       	call   420d <printf>
}
    18fc:	c9                   	leave  
    18fd:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1904:	c7 44 24 04 9a 4e 00 	movl   $0x4e9a,0x4(%esp)
    190b:	00 
    190c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1913:	e8 f5 28 00 00       	call   420d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1967:	c7 04 24 aa 4e 00 00 	movl   $0x4eaa,(%esp)
    ...
    1994:	c7 04 24 aa 4e 00 00 	movl   $0x4eaa,(%esp)
    ...
    19c5:	c7 44 24 04 ad 4e 00 	movl   $0x4ead,0x4(%esp)
    19cc:	00 
    19cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19d4:	e8 34 28 00 00       	call   420d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a28:	00 
    1a29:	c7 04 24 6f 4e 00 00 	movl   $0x4e6f,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1a87:	c7 44 24 04 c9 4e 00 	movl   $0x4ec9,0x4(%esp)
    1a8e:	00 
    1a8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a96:	e8 72 27 00 00       	call   420d <printf>
        exit();
    ...
    1ab8:	c7 44 24 04 e2 4e 00 	movl   $0x4ee2,0x4(%esp)
    1abf:	00 
    1ac0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ac7:	e8 41 27 00 00       	call   420d <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b12:	c7 44 24 04 00 4f 00 	movl   $0x4f00,0x4(%esp)
    1b19:	00 
    1b1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b21:	e8 e7 26 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b4c:	79 19                	jns    1b67 <concreate+0x269>
      printf(1, "fork failed\n");
    1b4e:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    1b55:	00 
    1b56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b5d:	e8 ab 26 00 00       	call   420d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1c4d:	c7 44 24 04 31 4f 00 	movl   $0x4f31,0x4(%esp)
    1c54:	00 
    1c55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c5c:	e8 ac 25 00 00       	call   420d <printf>
}
    1c61:	c9                   	leave  
    1c62:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1c69:	c7 44 24 04 3f 4f 00 	movl   $0x4f3f,0x4(%esp)
    1c70:	00 
    1c71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c78:	e8 90 25 00 00       	call   420d <printf>

  unlink("x");
    1c7d:	c7 04 24 ab 4a 00 00 	movl   $0x4aab,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1c97:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    1c9e:	00 
    1c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca6:	e8 62 25 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d24:	00 
    1d25:	c7 04 24 ab 4a 00 00 	movl   $0x4aab,(%esp)
    ...
    1d4f:	75 16                	jne    1d67 <linkunlink+0x104>
      link("cat", "x");
    1d51:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
    1d58:	00 
    1d59:	c7 04 24 50 4f 00 00 	movl   $0x4f50,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d92:	c7 44 24 04 54 4f 00 	movl   $0x4f54,0x4(%esp)
    1d99:	00 
    1d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da1:	e8 67 24 00 00       	call   420d <printf>
}
    1da6:	c9                   	leave  
    1da7:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dae:	c7 44 24 04 63 4f 00 	movl   $0x4f63,0x4(%esp)
    1db5:	00 
    1db6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dbd:	e8 4b 24 00 00       	call   420d <printf>
  unlink("bd");
    1dc2:	c7 04 24 70 4f 00 00 	movl   $0x4f70,(%esp)
    1dc9:	e8 4a 22 00 00       	call   4018 <unlink>

  fd = open("bd", O_CREATE);
    1dce:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1dd5:	00 
    1dd6:	c7 04 24 70 4f 00 00 	movl   $0x4f70,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 73 4f 00 	movl   $0x4f73,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 0e 24 00 00       	call   420d <printf>
    exit();
  ...
  unlink("bd");
    1e86:	c7 04 24 70 4f 00 00 	movl   $0x4f70,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1edc:	c7 44 24 04 9d 4f 00 	movl   $0x4f9d,0x4(%esp)
    1ee3:	00 
    1ee4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eeb:	e8 1d 23 00 00       	call   420d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f01:	c7 44 24 04 b2 4f 00 	movl   $0x4fb2,0x4(%esp)
    1f08:	00 
    1f09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f10:	e8 f8 22 00 00       	call   420d <printf>
}
    1f15:	c9                   	leave  
    1f16:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f1d:	c7 44 24 04 bd 4f 00 	movl   $0x4fbd,0x4(%esp)
    1f24:	00 
    1f25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f2c:	e8 dc 22 00 00       	call   420d <printf>

  unlink("ff");
    1f31:	c7 04 24 ca 4f 00 00 	movl   $0x4fca,(%esp)
    1f38:	e8 db 20 00 00       	call   4018 <unlink>
  if(mkdir("dd") != 0){
    1f3d:	c7 04 24 cd 4f 00 00 	movl   $0x4fcd,(%esp)
    1f44:	e8 e7 20 00 00       	call   4030 <mkdir>
    1f49:	85 c0                	test   %eax,%eax
    1f4b:	74 19                	je     1f66 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f4d:	c7 44 24 04 d0 4f 00 	movl   $0x4fd0,0x4(%esp)
    1f54:	00 
    1f55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5c:	e8 ac 22 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f6d:	00 
    1f6e:	c7 04 24 e8 4f 00 00 	movl   $0x4fe8,(%esp)
  ...
  if(fd < 0){
    ...
    1f83:	c7 44 24 04 ee 4f 00 	movl   $0x4fee,0x4(%esp)
    1f8a:	00 
    1f8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f92:	e8 76 22 00 00       	call   420d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1fa3:	00 
    1fa4:	c7 44 24 04 ca 4f 00 	movl   $0x4fca,0x4(%esp)
    1fab:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    201b:	00 
    201c:	c7 04 24 4c 50 00 00 	movl   $0x504c,(%esp)
  ...
  if(fd < 0){
    ...
    2031:	c7 44 24 04 55 50 00 	movl   $0x5055,0x4(%esp)
    2038:	00 
    2039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2040:	e8 c8 21 00 00       	call   420d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    2051:	00 
    2052:	c7 44 24 04 6d 50 00 	movl   $0x506d,0x4(%esp)
    2059:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2077:	00 
    2078:	c7 04 24 70 50 00 00 	movl   $0x5070,(%esp)
  ...
  if(fd < 0){
    ...
    208d:	c7 44 24 04 7c 50 00 	movl   $0x507c,0x4(%esp)
    2094:	00 
    2095:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    209c:	e8 6c 21 00 00       	call   420d <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    20d3:	c7 44 24 04 95 50 00 	movl   $0x5095,0x4(%esp)
    20da:	00 
    20db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20e2:	e8 26 21 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    222d:	00 
    222e:	c7 04 24 b0 50 00 00 	movl   $0x50b0,(%esp)
  ...
  if(fd < 0){
    ...
    2243:	c7 44 24 04 7a 51 00 	movl   $0x517a,0x4(%esp)
    224a:	00 
    224b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2252:	e8 b6 1f 00 00       	call   420d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    227c:	c7 44 24 04 92 51 00 	movl   $0x5192,0x4(%esp)
    2283:	00 
    2284:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228b:	e8 7d 1f 00 00       	call   420d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2661:	c7 44 24 04 0c 54 00 	movl   $0x540c,0x4(%esp)
    2668:	00 
    2669:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2670:	e8 98 1b 00 00       	call   420d <printf>

  unlink("bigwrite");
    2675:	c7 04 24 1b 54 00 00 	movl   $0x541b,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2694:	00 
    2695:	c7 04 24 1b 54 00 00 	movl   $0x541b,(%esp)
    ...
    26aa:	c7 44 24 04 24 54 00 	movl   $0x5424,0x4(%esp)
    26b1:	00 
    26b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b9:	e8 4f 1b 00 00       	call   420d <printf>
      exit();
    ...
    26ff:	c7 44 24 04 3c 54 00 	movl   $0x543c,0x4(%esp)
    2706:	00 
    2707:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270e:	e8 fa 1a 00 00       	call   420d <printf>
        exit();
    ...
    unlink("bigwrite");
    272c:	c7 04 24 1b 54 00 00 	movl   $0x541b,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    274c:	c7 44 24 04 4e 54 00 	movl   $0x544e,0x4(%esp)
    2753:	00 
    2754:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275b:	e8 ad 1a 00 00       	call   420d <printf>
}
    2760:	c9                   	leave  
    2761:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2768:	c7 44 24 04 5b 54 00 	movl   $0x545b,0x4(%esp)
    276f:	00 
    2770:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2777:	e8 91 1a 00 00       	call   420d <printf>

  unlink("bigfile");
    277c:	c7 04 24 69 54 00 00 	movl   $0x5469,(%esp)
    2783:	e8 90 18 00 00       	call   4018 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2788:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    278f:	00 
    2790:	c7 04 24 69 54 00 00 	movl   $0x5469,(%esp)
  ...
  if(fd < 0){
    ...
    27a5:	c7 44 24 04 71 54 00 	movl   $0x5471,0x4(%esp)
    27ac:	00 
    27ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27b4:	e8 54 1a 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2804:	c7 44 24 04 87 54 00 	movl   $0x5487,0x4(%esp)
    280b:	00 
    280c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2813:	e8 f5 19 00 00       	call   420d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    2838:	00 
    2839:	c7 04 24 69 54 00 00 	movl   $0x5469,(%esp)
  ...
  if(fd < 0){
    ...
    284e:	c7 44 24 04 9d 54 00 	movl   $0x549d,0x4(%esp)
    2855:	00 
    2856:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    285d:	e8 ab 19 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2899:	c7 44 24 04 b2 54 00 	movl   $0x54b2,0x4(%esp)
    28a0:	00 
    28a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28a8:	e8 60 19 00 00       	call   420d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    28dc:	c7 44 24 04 c7 54 00 	movl   $0x54c7,0x4(%esp)
    28e3:	00 
    28e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28eb:	e8 1d 19 00 00       	call   420d <printf>
      exit();
    ...
    2923:	74 19                	je     293e <bigfile+0x1dc>
      printf(1, "read bigfile wrong data\n");
    2925:	c7 44 24 04 db 54 00 	movl   $0x54db,0x4(%esp)
    292c:	00 
    292d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2934:	e8 d4 18 00 00       	call   420d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    294c:	c7 44 24 04 f4 54 00 	movl   $0x54f4,0x4(%esp)
    2953:	00 
    2954:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    295b:	e8 ad 18 00 00       	call   420d <printf>
    exit();
    2960:	e8 63 16 00 00       	call   3fc8 <exit>
  }
  unlink("bigfile");
    2965:	c7 04 24 69 54 00 00 	movl   $0x5469,(%esp)
    296c:	e8 a7 16 00 00       	call   4018 <unlink>

  printf(1, "bigfile test ok\n");
    2971:	c7 44 24 04 0e 55 00 	movl   $0x550e,0x4(%esp)
    2978:	00 
    2979:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2980:	e8 88 18 00 00       	call   420d <printf>
}
    2985:	c9                   	leave  
    2986:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29fa:	00 
    29fb:	c7 04 24 ac 55 00 00 	movl   $0x55ac,(%esp)
  ...
  if(fd < 0){
    ...
    2a10:	c7 44 24 04 dc 55 00 	movl   $0x55dc,0x4(%esp)
    2a17:	00 
    2a18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a1f:	e8 e9 17 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a3b:	00 
    2a3c:	c7 04 24 1c 56 00 00 	movl   $0x561c,(%esp)
  ...
  if(fd < 0){
    ...
    2a51:	c7 44 24 04 4c 56 00 	movl   $0x564c,0x4(%esp)
    2a58:	00 
    2a59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a60:	e8 a8 17 00 00       	call   420d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2c5b:	c7 44 24 04 e3 57 00 	movl   $0x57e3,0x4(%esp)
    2c62:	00 
    2c63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6a:	e8 9e 15 00 00       	call   420d <printf>

  fd = open("dirfile", O_CREATE);
    2c6f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2c76:	00 
    2c77:	c7 04 24 f0 57 00 00 	movl   $0x57f0,(%esp)
  ...
  if(fd < 0){
    ...
    2c8c:	c7 44 24 04 f8 57 00 	movl   $0x57f8,0x4(%esp)
    2c93:	00 
    2c94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9b:	e8 6d 15 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce0:	00 
    2ce1:	c7 04 24 29 58 00 00 	movl   $0x5829,(%esp)
  ...
  if(fd >= 0){
    ...
    2cf6:	c7 44 24 04 34 58 00 	movl   $0x5834,0x4(%esp)
    2cfd:	00 
    2cfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d05:	e8 03 15 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d16:	00 
    2d17:	c7 04 24 29 58 00 00 	movl   $0x5829,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2df8:	00 
    2df9:	c7 04 24 6f 4e 00 00 	movl   $0x4e6f,(%esp)
  ...
  if(fd >= 0){
    ...
    2e0e:	c7 44 24 04 cc 58 00 	movl   $0x58cc,0x4(%esp)
    2e15:	00 
    2e16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e1d:	e8 eb 13 00 00       	call   420d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2e5d:	c7 44 24 04 eb 58 00 	movl   $0x58eb,0x4(%esp)
    2e64:	00 
    2e65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6c:	e8 9c 13 00 00       	call   420d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2e81:	c7 44 24 04 ff 58 00 	movl   $0x58ff,0x4(%esp)
    2e88:	00 
    2e89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e90:	e8 78 13 00 00       	call   420d <printf>
}
    2e95:	c9                   	leave  
    2e96:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2e9d:	c7 44 24 04 0f 59 00 	movl   $0x590f,0x4(%esp)
    2ea4:	00 
    2ea5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2eac:	e8 5c 13 00 00       	call   420d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f5e:	00 
    2f5f:	c7 04 24 4f 59 00 00 	movl   $0x594f,(%esp)
    ...
    unlink("xx");
    2f7f:	c7 04 24 4f 59 00 00 	movl   $0x594f,(%esp)
  ...
  chdir("/");
    2f98:	c7 04 24 46 46 00 00 	movl   $0x4646,(%esp)
    2f9f:	e8 94 10 00 00       	call   4038 <chdir>
  printf(1, "empty file name OK\n");
    2fa4:	c7 44 24 04 52 59 00 	movl   $0x5952,0x4(%esp)
    2fab:	00 
    2fac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fb3:	e8 55 12 00 00       	call   420d <printf>
}
    2fb8:	c9                   	leave  
    2fb9:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2fc0:	c7 44 24 04 66 59 00 	movl   $0x5966,0x4(%esp)
    2fc7:	00 
    2fc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fcf:	e8 39 12 00 00       	call   420d <printf>
    ...
    2ff3:	e8 d0 0f 00 00       	call   3fc8 <exit>
{
  ...
  if(n == 1000){
    ...
    300d:	c7 44 24 04 74 59 00 	movl   $0x5974,0x4(%esp)
    3014:	00 
    3015:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    301c:	e8 ec 11 00 00       	call   420d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3031:	c7 44 24 04 96 59 00 	movl   $0x5996,0x4(%esp)
    3038:	00 
    3039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3040:	e8 c8 11 00 00       	call   420d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    305d:	c7 44 24 04 aa 59 00 	movl   $0x59aa,0x4(%esp)
    3064:	00 
    3065:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    306c:	e8 9c 11 00 00       	call   420d <printf>
    exit();
    3071:	e8 52 0f 00 00       	call   3fc8 <exit>
  }

  printf(1, "fork test OK\n");
    3076:	c7 44 24 04 bd 59 00 	movl   $0x59bd,0x4(%esp)
    307d:	00 
    307e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3085:	e8 83 11 00 00       	call   420d <printf>
}
    308a:	c9                   	leave  
    308b:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3096:	a1 54 65 00 00       	mov    0x6554,%eax
    309b:	c7 44 24 04 cb 59 00 	movl   $0x59cb,0x4(%esp)
    30a2:	00 
    30a3:	89 04 24             	mov    %eax,(%esp)
    30a6:	e8 62 11 00 00       	call   420d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    30e9:	a1 54 65 00 00       	mov    0x6554,%eax
    ...
    3103:	c7 44 24 04 d6 59 00 	movl   $0x59d6,0x4(%esp)
    310a:	00 
    310b:	89 04 24             	mov    %eax,(%esp)
    310e:	e8 fa 10 00 00       	call   420d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    313f:	a1 54 65 00 00       	mov    0x6554,%eax
    3144:	c7 44 24 04 f1 59 00 	movl   $0x59f1,0x4(%esp)
    314b:	00 
    314c:	89 04 24             	mov    %eax,(%esp)
    314f:	e8 b9 10 00 00       	call   420d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3180:	a1 54 65 00 00       	mov    0x6554,%eax
    3185:	c7 44 24 04 08 5a 00 	movl   $0x5a08,0x4(%esp)
    318c:	00 
    318d:	89 04 24             	mov    %eax,(%esp)
    3190:	e8 78 10 00 00       	call   420d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    31de:	a1 54 65 00 00       	mov    0x6554,%eax
    31e3:	c7 44 24 04 24 5a 00 	movl   $0x5a24,0x4(%esp)
    31ea:	00 
    31eb:	89 04 24             	mov    %eax,(%esp)
    31ee:	e8 1a 10 00 00       	call   420d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3229:	a1 54 65 00 00       	mov    0x6554,%eax
    322e:	c7 44 24 04 62 5a 00 	movl   $0x5a62,0x4(%esp)
    3235:	00 
    3236:	89 04 24             	mov    %eax,(%esp)
    3239:	e8 cf 0f 00 00       	call   420d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    325f:	a1 54 65 00 00       	mov    0x6554,%eax
    ...
    3272:	c7 44 24 04 80 5a 00 	movl   $0x5a80,0x4(%esp)
    3279:	00 
    327a:	89 04 24             	mov    %eax,(%esp)
    327d:	e8 8b 0f 00 00       	call   420d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    32c6:	a1 54 65 00 00       	mov    0x6554,%eax
    ...
    32d9:	c7 44 24 04 b8 5a 00 	movl   $0x5ab8,0x4(%esp)
    32e0:	00 
    32e1:	89 04 24             	mov    %eax,(%esp)
    32e4:	e8 24 0f 00 00       	call   420d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    32f7:	a1 54 65 00 00       	mov    0x6554,%eax
    32fc:	c7 44 24 04 e0 5a 00 	movl   $0x5ae0,0x4(%esp)
    3303:	00 
    3304:	89 04 24             	mov    %eax,(%esp)
    3307:	e8 01 0f 00 00       	call   420d <printf>
    exit();
  ...
  if(c != a){
    ...
    3346:	a1 54 65 00 00       	mov    0x6554,%eax
    ...
    3359:	c7 44 24 04 10 5b 00 	movl   $0x5b10,0x4(%esp)
    3360:	00 
    3361:	89 04 24             	mov    %eax,(%esp)
    3364:	e8 a4 0e 00 00       	call   420d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    338b:	79 1a                	jns    33a7 <sbrktest+0x31b>
      printf(stdout, "fork failed\n");
    338d:	a1 54 65 00 00       	mov    0x6554,%eax
    3392:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    3399:	00 
    339a:	89 04 24             	mov    %eax,(%esp)
    339d:	e8 6b 0e 00 00       	call   420d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    340d:	c7 44 24 04 46 4a 00 	movl   $0x4a46,0x4(%esp)
    3414:	00 
    3415:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    341c:	e8 ec 0d 00 00       	call   420d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3470:	00 
    3471:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
    3478:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    350f:	a1 54 65 00 00       	mov    0x6554,%eax
    3514:	c7 44 24 04 4a 5b 00 	movl   $0x5b4a,0x4(%esp)
    351b:	00 
    351c:	89 04 24             	mov    %eax,(%esp)
    351f:	e8 e9 0c 00 00       	call   420d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3555:	a1 54 65 00 00       	mov    0x6554,%eax
    355a:	c7 44 24 04 65 5b 00 	movl   $0x5b65,0x4(%esp)
    3561:	00 
    3562:	89 04 24             	mov    %eax,(%esp)
    3565:	e8 a3 0c 00 00       	call   420d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    359b:	a1 54 65 00 00       	mov    0x6554,%eax
    35a0:	c7 44 24 04 73 5b 00 	movl   $0x5b73,0x4(%esp)
    35a7:	00 
    35a8:	89 04 24             	mov    %eax,(%esp)
    35ab:	e8 5d 0c 00 00       	call   420d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    360d:	c7 04 24 82 5b 00 00 	movl   $0x5b82,(%esp)
    3614:	e8 0f 0a 00 00       	call   4028 <link>
    3619:	83 f8 ff             	cmp    $0xffffffff,%eax
    361c:	74 1a                	je     3638 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    361e:	a1 54 65 00 00       	mov    0x6554,%eax
    3623:	c7 44 24 04 8d 5b 00 	movl   $0x5b8d,0x4(%esp)
    362a:	00 
    362b:	89 04 24             	mov    %eax,(%esp)
    362e:	e8 da 0b 00 00       	call   420d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    364b:	a1 54 65 00 00       	mov    0x6554,%eax
    3650:	c7 44 24 04 a6 5b 00 	movl   $0x5ba6,0x4(%esp)
    3657:	00 
    3658:	89 04 24             	mov    %eax,(%esp)
    365b:	e8 ad 0b 00 00       	call   420d <printf>
}
    3660:	c9                   	leave  
    3661:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3668:	a1 54 65 00 00       	mov    0x6554,%eax
    366d:	c7 44 24 04 b3 5b 00 	movl   $0x5bb3,0x4(%esp)
    3674:	00 
    3675:	89 04 24             	mov    %eax,(%esp)
    3678:	e8 90 0b 00 00       	call   420d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3694:	a1 54 65 00 00       	mov    0x6554,%eax
    3699:	c7 44 24 04 bd 5b 00 	movl   $0x5bbd,0x4(%esp)
    36a0:	00 
    36a1:	89 04 24             	mov    %eax,(%esp)
    36a4:	e8 64 0b 00 00       	call   420d <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    36bb:	a1 54 65 00 00       	mov    0x6554,%eax
    36c0:	c7 44 24 04 ce 5b 00 	movl   $0x5bce,0x4(%esp)
    36c7:	00 
    36c8:	89 04 24             	mov    %eax,(%esp)
    36cb:	e8 3d 0b 00 00       	call   420d <printf>
}
    36d0:	c9                   	leave  
    36d1:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    36d8:	c7 04 24 db 5b 00 00 	movl   $0x5bdb,(%esp)
  ...
  if(pid == 0){
    ...
    3702:	c7 04 85 80 65 00 00 	movl   $0x5be8,0x6580(,%eax,4)
    3709:	e8 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3720:	a1 54 65 00 00       	mov    0x6554,%eax
    3725:	c7 44 24 04 c5 5c 00 	movl   $0x5cc5,0x4(%esp)
    372c:	00 
    372d:	89 04 24             	mov    %eax,(%esp)
    3730:	e8 d8 0a 00 00       	call   420d <printf>
    exec("echo", args);
    3735:	c7 44 24 04 80 65 00 	movl   $0x6580,0x4(%esp)
    373c:	00 
    373d:	c7 04 24 d4 45 00 00 	movl   $0x45d4,(%esp)
    3744:	e8 b7 08 00 00       	call   4000 <exec>
    printf(stdout, "bigarg test ok\n");
    3749:	a1 54 65 00 00       	mov    0x6554,%eax
    374e:	c7 44 24 04 d2 5c 00 	movl   $0x5cd2,0x4(%esp)
    3755:	00 
    3756:	89 04 24             	mov    %eax,(%esp)
    3759:	e8 af 0a 00 00       	call   420d <printf>
    fd = open("bigarg-ok", O_CREATE);
    375e:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3765:	00 
    3766:	c7 04 24 db 5b 00 00 	movl   $0x5bdb,(%esp)
    ...
    378b:	a1 54 65 00 00       	mov    0x6554,%eax
    3790:	c7 44 24 04 e2 5c 00 	movl   $0x5ce2,0x4(%esp)
    3797:	00 
    3798:	89 04 24             	mov    %eax,(%esp)
    379b:	e8 6d 0a 00 00       	call   420d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    37b1:	00 
    37b2:	c7 04 24 db 5b 00 00 	movl   $0x5bdb,(%esp)
  ...
  if(fd < 0){
    ...
    37c7:	a1 54 65 00 00       	mov    0x6554,%eax
    37cc:	c7 44 24 04 fb 5c 00 	movl   $0x5cfb,0x4(%esp)
    37d3:	00 
    37d4:	89 04 24             	mov    %eax,(%esp)
    37d7:	e8 31 0a 00 00       	call   420d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    37ec:	c7 04 24 db 5b 00 00 	movl   $0x5bdb,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3808:	c7 44 24 04 10 5d 00 	movl   $0x5d10,0x4(%esp)
    380f:	00 
    3810:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3817:	e8 f1 09 00 00       	call   420d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    390c:	c7 44 24 04 1d 5d 00 	movl   $0x5d1d,0x4(%esp)
    3913:	00 
    3914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    391b:	e8 ed 08 00 00       	call   420d <printf>
    ...
    3943:	c7 44 24 04 29 5d 00 	movl   $0x5d29,0x4(%esp)
    394a:	00 
    394b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3952:	e8 b6 08 00 00       	call   420d <printf>
      break;
    ...
    398f:	c7 44 24 04 39 5d 00 	movl   $0x5d39,0x4(%esp)
    3996:	00 
    3997:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399e:	e8 6a 08 00 00       	call   420d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3aca:	c7 44 24 04 49 5d 00 	movl   $0x5d49,0x4(%esp)
    3ad1:	00 
    3ad2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ad9:	e8 2f 07 00 00       	call   420d <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3af4:	c7 44 24 04 5f 5d 00 	movl   $0x5d5f,0x4(%esp)
    3afb:	00 
    3afc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b03:	e8 05 07 00 00       	call   420d <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b38:	c7 44 24 04 6c 5d 00 	movl   $0x5d6c,0x4(%esp)
    3b3f:	00 
    3b40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b47:	e8 c1 06 00 00       	call   420d <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b57:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
    3b5e:	00 
    3b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b66:	e8 a2 06 00 00       	call   420d <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3b75:	c7 44 24 04 8d 5d 00 	movl   $0x5d8d,0x4(%esp)
    3b7c:	00 
    3b7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b84:	e8 84 06 00 00       	call   420d <printf>
}
    3b89:	c9                   	leave  
    3b8a:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3b98:	00 
    3b99:	c7 04 24 9c 5d 00 00 	movl   $0x5d9c,(%esp)
  ...
  if (fd < 0) {
    ...
    3bae:	c7 44 24 04 a1 5d 00 	movl   $0x5da1,0x4(%esp)
    3bb5:	00 
    3bb6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bbd:	e8 4b 06 00 00       	call   420d <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3bf6:	c7 44 24 04 ae 5d 00 	movl   $0x5dae,0x4(%esp)
    3bfd:	00 
    3bfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c05:	e8 03 06 00 00       	call   420d <printf>
}
    3c0a:	c9                   	leave  
    3c0b:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c0f:	8b 15 58 65 00 00    	mov    0x6558,%edx
    ...
    3c4a:	a3 58 65 00 00       	mov    %eax,0x6558
  return randstate;
    3c4f:	a1 58 65 00 00       	mov    0x6558,%eax
}
    3c54:	5d                   	pop    %ebp
    3c55:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cab:	00 
    3cac:	c7 04 24 d3 5d 00 00 	movl   $0x5dd3,(%esp)
...
putc(int fd, char c)
{
    ...
    4133:	83 ec 18             	sub    $0x18,%esp
    4136:	8b 45 0c             	mov    0xc(%ebp),%eax
    4139:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    413c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    4143:	00 
    4144:	8d 45 f4             	lea    -0xc(%ebp),%eax
    4147:	89 44 24 04          	mov    %eax,0x4(%esp)
    414b:	8b 45 08             	mov    0x8(%ebp),%eax
    414e:	89 04 24             	mov    %eax,(%esp)
    4151:	e8 92 fe ff ff       	call   3fe8 <write>
}
    4156:	c9                   	leave  
    4157:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    4160:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    4167:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    416b:	74 17                	je     4184 <printint+0x2c>
    416d:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4171:	79 11                	jns    4184 <printint+0x2c>
    neg = 1;
    4173:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    417a:	8b 45 0c             	mov    0xc(%ebp),%eax
    417d:	f7 d8                	neg    %eax
    417f:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4182:	eb 06                	jmp    418a <printint+0x32>
  } else {
    x = xx;
    4184:	8b 45 0c             	mov    0xc(%ebp),%eax
    4187:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    418a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4191:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4194:	8d 41 01             	lea    0x1(%ecx),%eax
    4197:	89 45 f4             	mov    %eax,-0xc(%ebp)
    419a:	8b 5d 10             	mov    0x10(%ebp),%ebx
    419d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    41a0:	ba 00 00 00 00       	mov    $0x0,%edx
    41a5:	f7 f3                	div    %ebx
    41a7:	89 d0                	mov    %edx,%eax
    41a9:	8a 80 5c 65 00 00    	mov    0x655c(%eax),%al
    41af:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    41b3:	8b 75 10             	mov    0x10(%ebp),%esi
    41b6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    41b9:	ba 00 00 00 00       	mov    $0x0,%edx
    41be:	f7 f6                	div    %esi
    41c0:	89 45 ec             	mov    %eax,-0x14(%ebp)
    41c3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41c7:	75 c8                	jne    4191 <printint+0x39>
  if(neg)
    41c9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    41cd:	74 10                	je     41df <printint+0x87>
    buf[i++] = '-';
    41cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41d2:	8d 50 01             	lea    0x1(%eax),%edx
    41d5:	89 55 f4             	mov    %edx,-0xc(%ebp)
    41d8:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    41dd:	eb 1e                	jmp    41fd <printint+0xa5>
    41df:	eb 1c                	jmp    41fd <printint+0xa5>
    putc(fd, buf[i]);
    41e1:	8d 55 dc             	lea    -0x24(%ebp),%edx
    41e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41e7:	01 d0                	add    %edx,%eax
    41e9:	8a 00                	mov    (%eax),%al
    41eb:	0f be c0             	movsbl %al,%eax
    41ee:	89 44 24 04          	mov    %eax,0x4(%esp)
    41f2:	8b 45 08             	mov    0x8(%ebp),%eax
    41f5:	89 04 24             	mov    %eax,(%esp)
    41f8:	e8 33 ff ff ff       	call   4130 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    41fd:	ff 4d f4             	decl   -0xc(%ebp)
    4200:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4204:	79 db                	jns    41e1 <printint+0x89>
    putc(fd, buf[i]);
}
    4206:	83 c4 30             	add    $0x30,%esp
    4209:	5b                   	pop    %ebx
    420a:	5e                   	pop    %esi
    420b:	5d                   	pop    %ebp
    420c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4210:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4213:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    421a:	8d 45 0c             	lea    0xc(%ebp),%eax
    421d:	83 c0 04             	add    $0x4,%eax
    4220:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4223:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    422a:	e9 77 01 00 00       	jmp    43a6 <printf+0x199>
    c = fmt[i] & 0xff;
    422f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4232:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4235:	01 d0                	add    %edx,%eax
    4237:	8a 00                	mov    (%eax),%al
    4239:	0f be c0             	movsbl %al,%eax
    423c:	25 ff 00 00 00       	and    $0xff,%eax
    4241:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    4244:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4248:	75 2c                	jne    4276 <printf+0x69>
      if(c == '%'){
    424a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    424e:	75 0c                	jne    425c <printf+0x4f>
        state = '%';
    4250:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    4257:	e9 47 01 00 00       	jmp    43a3 <printf+0x196>
      } else {
        putc(fd, c);
    ...
    426c:	e8 bf fe ff ff       	call   4130 <putc>
    4271:	e9 2d 01 00 00       	jmp    43a3 <printf+0x196>
      }
    } else if(state == '%'){
    4276:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    427a:	0f 85 23 01 00 00    	jne    43a3 <printf+0x196>
      if(c == 'd'){
    4280:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    4284:	75 2d                	jne    42b3 <printf+0xa6>
        printint(fd, *ap, 10, 1);
    4286:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4289:	8b 00                	mov    (%eax),%eax
    428b:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4292:	00 
    4293:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    429a:	00 
    429b:	89 44 24 04          	mov    %eax,0x4(%esp)
    429f:	8b 45 08             	mov    0x8(%ebp),%eax
    42a2:	89 04 24             	mov    %eax,(%esp)
    42a5:	e8 ae fe ff ff       	call   4158 <printint>
        ap++;
    42aa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42ae:	e9 e9 00 00 00       	jmp    439c <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    42b3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    42b7:	74 06                	je     42bf <printf+0xb2>
    42b9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    42bd:	75 2d                	jne    42ec <printf+0xdf>
        printint(fd, *ap, 16, 0);
    42bf:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42c2:	8b 00                	mov    (%eax),%eax
    42c4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    42cb:	00 
    42cc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    42d3:	00 
    42d4:	89 44 24 04          	mov    %eax,0x4(%esp)
    42d8:	8b 45 08             	mov    0x8(%ebp),%eax
    42db:	89 04 24             	mov    %eax,(%esp)
    42de:	e8 75 fe ff ff       	call   4158 <printint>
        ap++;
    42e3:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42e7:	e9 b0 00 00 00       	jmp    439c <printf+0x18f>
      } else if(c == 's'){
    42ec:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    42f0:	75 42                	jne    4334 <printf+0x127>
        s = (char*)*ap;
    42f2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42f5:	8b 00                	mov    (%eax),%eax
    42f7:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    42fa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    42fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4302:	75 09                	jne    430d <printf+0x100>
          s = "(null)";
    4304:	c7 45 f4 0e 5e 00 00 	movl   $0x5e0e,-0xc(%ebp)
        while(*s != 0){
    430b:	eb 1c                	jmp    4329 <printf+0x11c>
    430d:	eb 1a                	jmp    4329 <printf+0x11c>
          putc(fd, *s);
    430f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4312:	8a 00                	mov    (%eax),%al
    4314:	0f be c0             	movsbl %al,%eax
    4317:	89 44 24 04          	mov    %eax,0x4(%esp)
    431b:	8b 45 08             	mov    0x8(%ebp),%eax
    431e:	89 04 24             	mov    %eax,(%esp)
    4321:	e8 0a fe ff ff       	call   4130 <putc>
          s++;
    4326:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    432c:	8a 00                	mov    (%eax),%al
    432e:	84 c0                	test   %al,%al
    4330:	75 dd                	jne    430f <printf+0x102>
    4332:	eb 68                	jmp    439c <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4334:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4338:	75 1d                	jne    4357 <printf+0x14a>
        putc(fd, *ap);
    433a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    434c:	e8 df fd ff ff       	call   4130 <putc>
        ap++;
    4351:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4355:	eb 45                	jmp    439c <printf+0x18f>
      } else if(c == '%'){
    4357:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    435b:	75 17                	jne    4374 <printf+0x167>
        putc(fd, c);
    435d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4360:	0f be c0             	movsbl %al,%eax
    4363:	89 44 24 04          	mov    %eax,0x4(%esp)
    4367:	8b 45 08             	mov    0x8(%ebp),%eax
    436a:	89 04 24             	mov    %eax,(%esp)
    436d:	e8 be fd ff ff       	call   4130 <putc>
    4372:	eb 28                	jmp    439c <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    4374:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    437b:	00 
    437c:	8b 45 08             	mov    0x8(%ebp),%eax
    437f:	89 04 24             	mov    %eax,(%esp)
    4382:	e8 a9 fd ff ff       	call   4130 <putc>
        putc(fd, c);
    4387:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    438a:	0f be c0             	movsbl %al,%eax
    438d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4391:	8b 45 08             	mov    0x8(%ebp),%eax
    4394:	89 04 24             	mov    %eax,(%esp)
    4397:	e8 94 fd ff ff       	call   4130 <putc>
      }
      state = 0;
    439c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    43a3:	ff 45 f0             	incl   -0x10(%ebp)
    43a6:	8b 55 0c             	mov    0xc(%ebp),%edx
    43a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43ac:	01 d0                	add    %edx,%eax
    43ae:	8a 00                	mov    (%eax),%al
    43b0:	84 c0                	test   %al,%al
    43b2:	0f 85 77 fe ff ff    	jne    422f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
{
    43bc:	55                   	push   %ebp
    43bd:	89 e5                	mov    %esp,%ebp
    43bf:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    43c2:	8b 45 08             	mov    0x8(%ebp),%eax
    43c5:	83 e8 08             	sub    $0x8,%eax
    43c8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    43cb:	a1 08 66 00 00       	mov    0x6608,%eax
    43d0:	89 45 fc             	mov    %eax,-0x4(%ebp)
    43d3:	eb 24                	jmp    43f9 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    43d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d8:	8b 00                	mov    (%eax),%eax
    43da:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43dd:	77 12                	ja     43f1 <free+0x35>
    43df:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43e2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43e5:	77 24                	ja     440b <free+0x4f>
    43e7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43ea:	8b 00                	mov    (%eax),%eax
    43ec:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43ef:	77 1a                	ja     440b <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    43fc:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43ff:	76 d4                	jbe    43d5 <free+0x19>
    4401:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4404:	8b 00                	mov    (%eax),%eax
    4406:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4409:	76 ca                	jbe    43d5 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    440b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    440e:	8b 40 04             	mov    0x4(%eax),%eax
    4411:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4418:	8b 45 f8             	mov    -0x8(%ebp),%eax
    441b:	01 c2                	add    %eax,%edx
    441d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4420:	8b 00                	mov    (%eax),%eax
    4422:	39 c2                	cmp    %eax,%edx
    4424:	75 24                	jne    444a <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    4426:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4429:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    443f:	8b 00                	mov    (%eax),%eax
    4441:	8b 10                	mov    (%eax),%edx
    4443:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4446:	89 10                	mov    %edx,(%eax)
    4448:	eb 0a                	jmp    4454 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    444a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    444d:	8b 10                	mov    (%eax),%edx
    444f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4452:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4454:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4457:	8b 40 04             	mov    0x4(%eax),%eax
    445a:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4461:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4464:	01 d0                	add    %edx,%eax
    4466:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4469:	75 20                	jne    448b <free+0xcf>
    p->s.size += bp->s.size;
    446b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    446e:	8b 50 04             	mov    0x4(%eax),%edx
    4471:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4474:	8b 40 04             	mov    0x4(%eax),%eax
    4477:	01 c2                	add    %eax,%edx
    4479:	8b 45 fc             	mov    -0x4(%ebp),%eax
    447c:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    447f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4482:	8b 10                	mov    (%eax),%edx
    4484:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4487:	89 10                	mov    %edx,(%eax)
    4489:	eb 08                	jmp    4493 <free+0xd7>
  } else
    p->s.ptr = bp;
    448b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    448e:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4491:	89 10                	mov    %edx,(%eax)
  freep = p;
    4493:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4496:	a3 08 66 00 00       	mov    %eax,0x6608
}
    449b:	c9                   	leave  
    449c:	c3                   	ret    
...
{
    449d:	55                   	push   %ebp
    449e:	89 e5                	mov    %esp,%ebp
    44a0:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    44a3:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    44aa:	77 07                	ja     44b3 <morecore+0x16>
    nu = 4096;
    44ac:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    44b3:	8b 45 08             	mov    0x8(%ebp),%eax
    44b6:	c1 e0 03             	shl    $0x3,%eax
    44b9:	89 04 24             	mov    %eax,(%esp)
    44bc:	e8 8f fb ff ff       	call   4050 <sbrk>
    44c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    44c4:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    44c8:	75 07                	jne    44d1 <morecore+0x34>
    return 0;
    44ca:	b8 00 00 00 00       	mov    $0x0,%eax
    44cf:	eb 22                	jmp    44f3 <morecore+0x56>
  hp = (Header*)p;
    44d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    44d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44da:	8b 55 08             	mov    0x8(%ebp),%edx
    44dd:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    44e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44e3:	83 c0 08             	add    $0x8,%eax
    44e6:	89 04 24             	mov    %eax,(%esp)
    44e9:	e8 ce fe ff ff       	call   43bc <free>
  return freep;
    44ee:	a1 08 66 00 00       	mov    0x6608,%eax
}
    44f3:	c9                   	leave  
    44f4:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    44f8:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    44fb:	8b 45 08             	mov    0x8(%ebp),%eax
    44fe:	83 c0 07             	add    $0x7,%eax
    4501:	c1 e8 03             	shr    $0x3,%eax
    4504:	40                   	inc    %eax
    4505:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4508:	a1 08 66 00 00       	mov    0x6608,%eax
    450d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4510:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4514:	75 23                	jne    4539 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    4516:	c7 45 f0 00 66 00 00 	movl   $0x6600,-0x10(%ebp)
    451d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4520:	a3 08 66 00 00       	mov    %eax,0x6608
    4525:	a1 08 66 00 00       	mov    0x6608,%eax
    452a:	a3 00 66 00 00       	mov    %eax,0x6600
    base.s.size = 0;
    452f:	c7 05 04 66 00 00 00 	movl   $0x0,0x6604
    4536:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4547:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    454a:	72 4d                	jb     4599 <malloc+0xa4>
      if(p->s.size == nunits)
    454c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    454f:	8b 40 04             	mov    0x4(%eax),%eax
    4552:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4555:	75 0c                	jne    4563 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    4557:	8b 45 f4             	mov    -0xc(%ebp),%eax
    455a:	8b 10                	mov    (%eax),%edx
    455c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    455f:	89 10                	mov    %edx,(%eax)
    4561:	eb 26                	jmp    4589 <malloc+0x94>
      else {
        p->s.size -= nunits;
    4563:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4566:	8b 40 04             	mov    0x4(%eax),%eax
    4569:	2b 45 ec             	sub    -0x14(%ebp),%eax
    456c:	89 c2                	mov    %eax,%edx
    ...
    457d:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4580:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4583:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4586:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4589:	8b 45 f0             	mov    -0x10(%ebp),%eax
    458c:	a3 08 66 00 00       	mov    %eax,0x6608
      return (void*)(p + 1);
    4591:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4594:	83 c0 08             	add    $0x8,%eax
    4597:	eb 38                	jmp    45d1 <malloc+0xdc>
    }
    if(p == freep)
    4599:	a1 08 66 00 00       	mov    0x6608,%eax
    459e:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    45a1:	75 1b                	jne    45be <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    45a3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    45a6:	89 04 24             	mov    %eax,(%esp)
    45a9:	e8 ef fe ff ff       	call   449d <morecore>
    45ae:	89 45 f4             	mov    %eax,-0xc(%ebp)
    45b1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    45b5:	75 07                	jne    45be <malloc+0xc9>
        return 0;
    45b7:	b8 00 00 00 00       	mov    $0x0,%eax
    45bc:	eb 13                	jmp    45d1 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    45c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    45c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45c7:	8b 00                	mov    (%eax),%eax
    45c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    45cc:	e9 70 ff ff ff       	jmp    4541 <malloc+0x4c>
}
    45d1:	c9                   	leave  
    45d2:	c3                   	ret    
