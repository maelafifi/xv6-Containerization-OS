...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 4c 65 00 00       	mov    0x654c,%eax
       b:	c7 44 24 04 e2 45 00 	movl   $0x45e2,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 ea 41 00 00       	call   4205 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 ed 45 00 00 	movl   $0x45ed,(%esp)
      22:	e8 09 40 00 00       	call   4030 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 4c 65 00 00       	mov    0x654c,%eax
      30:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 c5 41 00 00       	call   4205 <printf>
    exit();
      40:	e8 83 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 ed 45 00 00 	movl   $0x45ed,(%esp)
      4c:	e8 e7 3f 00 00       	call   4038 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 4c 65 00 00       	mov    0x654c,%eax
      5a:	c7 44 24 04 03 46 00 	movl   $0x4603,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 9b 41 00 00       	call   4205 <printf>
    exit();
      6a:	e8 59 3f 00 00       	call   3fc8 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 19 46 00 00 	movl   $0x4619,(%esp)
      76:	e8 9d 3f 00 00       	call   4018 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 4c 65 00 00       	mov    0x654c,%eax
      84:	c7 44 24 04 24 46 00 	movl   $0x4624,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 71 41 00 00       	call   4205 <printf>
    exit();
      94:	e8 2f 3f 00 00       	call   3fc8 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 3e 46 00 00 	movl   $0x463e,(%esp)
      a0:	e8 93 3f 00 00       	call   4038 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 4c 65 00 00       	mov    0x654c,%eax
      ae:	c7 44 24 04 40 46 00 	movl   $0x4640,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 47 41 00 00       	call   4205 <printf>
    exit();
      be:	e8 05 3f 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 4c 65 00 00       	mov    0x654c,%eax
      c8:	c7 44 24 04 50 46 00 	movl   $0x4650,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 2d 41 00 00       	call   4205 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 4c 65 00 00       	mov    0x654c,%eax
      e5:	c7 44 24 04 5e 46 00 	movl   $0x465e,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 10 41 00 00       	call   4205 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 4c 65 00 00       	mov    0x654c,%eax
     108:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 ed 40 00 00       	call   4205 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 ed 45 00 00 	movl   $0x45ed,(%esp)
     12e:	e8 fd 3e 00 00       	call   4030 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 4c 65 00 00       	mov    0x654c,%eax
     13c:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 b9 40 00 00       	call   4205 <printf>
      exit();
     14c:	e8 77 3e 00 00       	call   3fc8 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 ed 45 00 00 	movl   $0x45ed,(%esp)
     158:	e8 db 3e 00 00       	call   4038 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 4c 65 00 00       	mov    0x654c,%eax
     166:	c7 44 24 04 7a 46 00 	movl   $0x467a,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 8f 40 00 00       	call   4205 <printf>
      exit();
     176:	e8 4d 3e 00 00       	call   3fc8 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 19 46 00 00 	movl   $0x4619,(%esp)
     182:	e8 91 3e 00 00       	call   4018 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 4c 65 00 00       	mov    0x654c,%eax
     190:	c7 44 24 04 24 46 00 	movl   $0x4624,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 65 40 00 00       	call   4205 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 4c 65 00 00       	mov    0x654c,%eax
     1b4:	c7 44 24 04 8e 46 00 	movl   $0x468e,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 41 40 00 00       	call   4205 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 4c 65 00 00       	mov    0x654c,%eax
     1d1:	c7 44 24 04 a0 46 00 	movl   $0x46a0,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 24 40 00 00       	call   4205 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 af 46 00 00 	movl   $0x46af,(%esp)
     1e8:	e8 43 3e 00 00       	call   4030 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 4c 65 00 00       	mov    0x654c,%eax
     1f6:	c7 44 24 04 b5 46 00 	movl   $0x46b5,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 ff 3f 00 00       	call   4205 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 4c 65 00 00       	mov    0x654c,%eax
     21e:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 d7 3f 00 00       	call   4205 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 af 46 00 00 	movl   $0x46af,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 4c 65 00 00       	mov    0x654c,%eax
     25b:	c7 44 24 04 cc 46 00 	movl   $0x46cc,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 9a 3f 00 00       	call   4205 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 af 46 00 00 	movl   $0x46af,(%esp)
     288:	e8 8b 3d 00 00       	call   4018 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 4c 65 00 00       	mov    0x654c,%eax
     296:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 5f 3f 00 00       	call   4205 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 4c 65 00 00       	mov    0x654c,%eax
     2b5:	c7 44 24 04 ff 46 00 	movl   $0x46ff,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 40 3f 00 00       	call   4205 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 4c 65 00 00       	mov    0x654c,%eax
     2d2:	c7 44 24 04 11 47 00 	movl   $0x4711,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 23 3f 00 00       	call   4205 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 cc 45 00 00 	movl   $0x45cc,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 4c 65 00 00       	mov    0x654c,%eax
     304:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 f1 3e 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 2f 47 00 00 	movl   $0x472f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 4c 65 00 00       	mov    0x654c,%eax
     346:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 af 3e 00 00       	call   4205 <printf>
    exit();
     356:	e8 6d 3c 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 4c 65 00 00       	mov    0x654c,%eax
     360:	c7 44 24 04 5a 47 00 	movl   $0x475a,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 95 3e 00 00       	call   4205 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 4c 65 00 00       	mov    0x654c,%eax
     37d:	c7 44 24 04 68 47 00 	movl   $0x4768,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 78 3e 00 00       	call   4205 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 79 47 00 00 	movl   $0x4779,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 4c 65 00 00       	mov    0x654c,%eax
     3af:	c7 44 24 04 7f 47 00 	movl   $0x477f,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 46 3e 00 00       	call   4205 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 4c 65 00 00       	mov    0x654c,%eax
     3d0:	c7 44 24 04 9a 47 00 	movl   $0x479a,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 25 3e 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 b6 47 00 	movl   $0x47b6,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 4c 65 00 00       	mov    0x654c,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 c4 47 00 	movl   $0x47c4,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 e4 3d 00 00       	call   4205 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 e8 47 00 	movl   $0x47e8,0x4(%esp)
     435:	00 
     ...
     446:	a1 4c 65 00 00       	mov    0x654c,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 f4 47 00 	movl   $0x47f4,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 a3 3d 00 00       	call   4205 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     474:	a1 4c 65 00 00       	mov    0x654c,%eax
     479:	c7 44 24 04 18 48 00 	movl   $0x4818,0x4(%esp)
     480:	00 
     481:	89 04 24             	mov    %eax,(%esp)
     484:	e8 7c 3d 00 00       	call   4205 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49b:	00 
     49c:	c7 04 24 79 47 00 00 	movl   $0x4779,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b1:	a1 4c 65 00 00       	mov    0x654c,%eax
     4b6:	c7 44 24 04 23 48 00 	movl   $0x4823,0x4(%esp)
     4bd:	00 
     4be:	89 04 24             	mov    %eax,(%esp)
     4c1:	e8 3f 3d 00 00       	call   4205 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4ef:	a1 4c 65 00 00       	mov    0x654c,%eax
     4f4:	c7 44 24 04 3c 48 00 	movl   $0x483c,0x4(%esp)
     4fb:	00 
     4fc:	89 04 24             	mov    %eax,(%esp)
     4ff:	e8 01 3d 00 00       	call   4205 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     509:	a1 4c 65 00 00       	mov    0x654c,%eax
     50e:	c7 44 24 04 57 48 00 	movl   $0x4857,0x4(%esp)
     515:	00 
     516:	89 04 24             	mov    %eax,(%esp)
     519:	e8 e7 3c 00 00       	call   4205 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     529:	c7 04 24 79 47 00 00 	movl   $0x4779,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53b:	a1 4c 65 00 00       	mov    0x654c,%eax
     540:	c7 44 24 04 6a 48 00 	movl   $0x486a,0x4(%esp)
     547:	00 
     548:	89 04 24             	mov    %eax,(%esp)
     54b:	e8 b5 3c 00 00       	call   4205 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     555:	a1 4c 65 00 00       	mov    0x654c,%eax
     55a:	c7 44 24 04 77 48 00 	movl   $0x4877,0x4(%esp)
     561:	00 
     562:	89 04 24             	mov    %eax,(%esp)
     565:	e8 9b 3c 00 00       	call   4205 <printf>
    exit();
     56a:	e8 59 3a 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "small file test ok\n");
     56f:	a1 4c 65 00 00       	mov    0x654c,%eax
     574:	c7 44 24 04 8c 48 00 	movl   $0x488c,0x4(%esp)
     57b:	00 
     57c:	89 04 24             	mov    %eax,(%esp)
     57f:	e8 81 3c 00 00       	call   4205 <printf>
}
     584:	c9                   	leave  
     585:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58c:	a1 4c 65 00 00       	mov    0x654c,%eax
     591:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
     598:	00 
     599:	89 04 24             	mov    %eax,(%esp)
     59c:	e8 64 3c 00 00       	call   4205 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a1:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a8:	00 
     5a9:	c7 04 24 b0 48 00 00 	movl   $0x48b0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5be:	a1 4c 65 00 00       	mov    0x654c,%eax
     5c3:	c7 44 24 04 b4 48 00 	movl   $0x48b4,0x4(%esp)
     5ca:	00 
     5cb:	89 04 24             	mov    %eax,(%esp)
     5ce:	e8 32 3c 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60d:	a1 4c 65 00 00       	mov    0x654c,%eax
     612:	8b 55 f4             	mov    -0xc(%ebp),%edx
     615:	89 54 24 08          	mov    %edx,0x8(%esp)
     619:	c7 44 24 04 ce 48 00 	movl   $0x48ce,0x4(%esp)
     620:	00 
     621:	89 04 24             	mov    %eax,(%esp)
     624:	e8 dc 3b 00 00       	call   4205 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64d:	00 
     64e:	c7 04 24 b0 48 00 00 	movl   $0x48b0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     663:	a1 4c 65 00 00       	mov    0x654c,%eax
     668:	c7 44 24 04 ec 48 00 	movl   $0x48ec,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 8d 3b 00 00       	call   4205 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b1:	a1 4c 65 00 00       	mov    0x654c,%eax
     6b6:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6b9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bd:	c7 44 24 04 05 49 00 	movl   $0x4905,0x4(%esp)
     6c4:	00 
     6c5:	89 04 24             	mov    %eax,(%esp)
     6c8:	e8 38 3b 00 00       	call   4205 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6de:	c7 04 24 b0 48 00 00 	movl   $0x48b0,(%esp)
     ...
     6fd:	a1 4c 65 00 00       	mov    0x654c,%eax
     702:	8b 55 f4             	mov    -0xc(%ebp),%edx
     705:	89 54 24 08          	mov    %edx,0x8(%esp)
     709:	c7 44 24 04 22 49 00 	movl   $0x4922,0x4(%esp)
     710:	00 
     711:	89 04 24             	mov    %eax,(%esp)
     714:	e8 ec 3a 00 00       	call   4205 <printf>
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     75e:	a1 4c 65 00 00       	mov    0x654c,%eax
     763:	c7 44 24 04 54 49 00 	movl   $0x4954,0x4(%esp)
     76a:	00 
     76b:	89 04 24             	mov    %eax,(%esp)
     76e:	e8 92 3a 00 00       	call   4205 <printf>
    exit();
     773:	e8 50 38 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "big files ok\n");
     778:	a1 4c 65 00 00       	mov    0x654c,%eax
     77d:	c7 44 24 04 67 49 00 	movl   $0x4967,0x4(%esp)
     784:	00 
     785:	89 04 24             	mov    %eax,(%esp)
     788:	e8 78 3a 00 00       	call   4205 <printf>
}
     78d:	c9                   	leave  
     78e:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     795:	a1 4c 65 00 00       	mov    0x654c,%eax
     79a:	c7 44 24 04 78 49 00 	movl   $0x4978,0x4(%esp)
     7a1:	00 
     7a2:	89 04 24             	mov    %eax,(%esp)
     7a5:	e8 5b 3a 00 00       	call   4205 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     82e:	a1 4c 65 00 00       	mov    0x654c,%eax
     833:	c7 44 24 04 a0 49 00 	movl   $0x49a0,0x4(%esp)
     83a:	00 
     83b:	89 04 24             	mov    %eax,(%esp)
     83e:	e8 c2 39 00 00       	call   4205 <printf>
}
     843:	c9                   	leave  
     844:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84b:	a1 4c 65 00 00       	mov    0x654c,%eax
     850:	c7 44 24 04 c6 49 00 	movl   $0x49c6,0x4(%esp)
     857:	00 
     858:	89 04 24             	mov    %eax,(%esp)
     85b:	e8 a5 39 00 00       	call   4205 <printf>

  if(mkdir("dir0") < 0){
     860:	c7 04 24 d2 49 00 00 	movl   $0x49d2,(%esp)
     867:	e8 c4 37 00 00       	call   4030 <mkdir>
     86c:	85 c0                	test   %eax,%eax
     86e:	79 1a                	jns    88a <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     870:	a1 4c 65 00 00       	mov    0x654c,%eax
     875:	c7 44 24 04 f5 45 00 	movl   $0x45f5,0x4(%esp)
     87c:	00 
     87d:	89 04 24             	mov    %eax,(%esp)
     880:	e8 80 39 00 00       	call   4205 <printf>
    exit();
     885:	e8 3e 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("dir0") < 0){
     88a:	c7 04 24 d2 49 00 00 	movl   $0x49d2,(%esp)
     891:	e8 a2 37 00 00       	call   4038 <chdir>
     896:	85 c0                	test   %eax,%eax
     898:	79 1a                	jns    8b4 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89a:	a1 4c 65 00 00       	mov    0x654c,%eax
     89f:	c7 44 24 04 d7 49 00 	movl   $0x49d7,0x4(%esp)
     8a6:	00 
     8a7:	89 04 24             	mov    %eax,(%esp)
     8aa:	e8 56 39 00 00       	call   4205 <printf>
    exit();
     8af:	e8 14 37 00 00       	call   3fc8 <exit>
  }

  if(chdir("..") < 0){
     8b4:	c7 04 24 ea 49 00 00 	movl   $0x49ea,(%esp)
     8bb:	e8 78 37 00 00       	call   4038 <chdir>
     8c0:	85 c0                	test   %eax,%eax
     8c2:	79 1a                	jns    8de <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c4:	a1 4c 65 00 00       	mov    0x654c,%eax
     8c9:	c7 44 24 04 ed 49 00 	movl   $0x49ed,0x4(%esp)
     8d0:	00 
     8d1:	89 04 24             	mov    %eax,(%esp)
     8d4:	e8 2c 39 00 00       	call   4205 <printf>
    exit();
     8d9:	e8 ea 36 00 00       	call   3fc8 <exit>
  }

  if(unlink("dir0") < 0){
     8de:	c7 04 24 d2 49 00 00 	movl   $0x49d2,(%esp)
     8e5:	e8 2e 37 00 00       	call   4018 <unlink>
     8ea:	85 c0                	test   %eax,%eax
     8ec:	79 1a                	jns    908 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8ee:	a1 4c 65 00 00       	mov    0x654c,%eax
     8f3:	c7 44 24 04 fe 49 00 	movl   $0x49fe,0x4(%esp)
     8fa:	00 
     8fb:	89 04 24             	mov    %eax,(%esp)
     8fe:	e8 02 39 00 00       	call   4205 <printf>
    exit();
     903:	e8 c0 36 00 00       	call   3fc8 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     908:	a1 4c 65 00 00       	mov    0x654c,%eax
     90d:	c7 44 24 04 12 4a 00 	movl   $0x4a12,0x4(%esp)
     914:	00 
     915:	89 04 24             	mov    %eax,(%esp)
     918:	e8 e8 38 00 00       	call   4205 <printf>
}
     91d:	c9                   	leave  
     91e:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     925:	a1 4c 65 00 00       	mov    0x654c,%eax
     92a:	c7 44 24 04 21 4a 00 	movl   $0x4a21,0x4(%esp)
     931:	00 
     932:	89 04 24             	mov    %eax,(%esp)
     935:	e8 cb 38 00 00       	call   4205 <printf>
  if(exec("echo", echoargv) < 0){
     93a:	c7 44 24 04 38 65 00 	movl   $0x6538,0x4(%esp)
     941:	00 
     942:	c7 04 24 cc 45 00 00 	movl   $0x45cc,(%esp)
     949:	e8 b2 36 00 00       	call   4000 <exec>
     94e:	85 c0                	test   %eax,%eax
     950:	79 1a                	jns    96c <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     952:	a1 4c 65 00 00       	mov    0x654c,%eax
     957:	c7 44 24 04 2c 4a 00 	movl   $0x4a2c,0x4(%esp)
     95e:	00 
     95f:	89 04 24             	mov    %eax,(%esp)
     962:	e8 9e 38 00 00       	call   4205 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     983:	c7 44 24 04 3e 4a 00 	movl   $0x4a3e,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 6e 38 00 00       	call   4205 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a14:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
     a1b:	00 
     a1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a23:	e8 dd 37 00 00       	call   4205 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a88:	c7 44 24 04 5b 4a 00 	movl   $0x4a5b,0x4(%esp)
     a8f:	00 
     a90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a97:	e8 69 37 00 00       	call   4205 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b02:	c7 44 24 04 69 4a 00 	movl   $0x4a69,0x4(%esp)
     b09:	00 
     b0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b11:	e8 ef 36 00 00       	call   4205 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2b:	c7 44 24 04 8f 4a 00 	movl   $0x4a8f,0x4(%esp)
     b32:	00 
     b33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3a:	e8 c6 36 00 00       	call   4205 <printf>
    ...
    printf(1, "fork() failed\n");
     b41:	c7 44 24 04 80 4a 00 	movl   $0x4a80,0x4(%esp)
     b48:	00 
     b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b50:	e8 b0 36 00 00       	call   4205 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b62:	c7 44 24 04 99 4a 00 	movl   $0x4a99,0x4(%esp)
     b69:	00 
     b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b71:	e8 8f 36 00 00       	call   4205 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc4:	00 
     bc5:	c7 44 24 04 a3 4a 00 	movl   $0x4aa3,0x4(%esp)
     bcc:	00 
     ...
     bda:	c7 44 24 04 a5 4a 00 	movl   $0x4aa5,0x4(%esp)
     be1:	00 
     be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     be9:	e8 17 36 00 00       	call   4205 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c26:	c7 44 24 04 b9 4a 00 	movl   $0x4ab9,0x4(%esp)
     c2d:	00 
     c2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c35:	e8 cb 35 00 00       	call   4205 <printf>
  ...
  printf(1, "kill... ");
     c47:	c7 44 24 04 cc 4a 00 	movl   $0x4acc,0x4(%esp)
     c4e:	00 
     c4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c56:	e8 aa 35 00 00       	call   4205 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7c:	c7 44 24 04 d5 4a 00 	movl   $0x4ad5,0x4(%esp)
     c83:	00 
     c84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8b:	e8 75 35 00 00       	call   4205 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c9f:	c7 44 24 04 de 4a 00 	movl   $0x4ade,0x4(%esp)
     ca6:	00 
     ca7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cae:	e8 52 35 00 00       	call   4205 <printf>
}
     cb3:	c9                   	leave  
     cb4:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd0:	79 16                	jns    ce8 <exitwait+0x33>
      printf(1, "fork failed\n");
     cd2:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
     cd9:	00 
     cda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce1:	e8 1f 35 00 00       	call   4205 <printf>
      return;
    ...
    if(pid){
     ...
     cf8:	c7 44 24 04 ea 4a 00 	movl   $0x4aea,0x4(%esp)
     cff:	00 
     d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d07:	e8 f9 34 00 00       	call   4205 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d1c:	c7 44 24 04 fa 4a 00 	movl   $0x4afa,0x4(%esp)
     d23:	00 
     d24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2b:	e8 d5 34 00 00       	call   4205 <printf>
}
     d30:	c9                   	leave  
     d31:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d38:	c7 44 24 04 07 4b 00 	movl   $0x4b07,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 b9 34 00 00       	call   4205 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d84:	e8 64 37 00 00       	call   44ed <malloc>
    ...
    while(m1){
     ...
     da2:	e8 0d 36 00 00       	call   43b4 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df2:	e8 bd 35 00 00       	call   43b4 <free>
    printf(1, "mem ok\n");
     df7:	c7 44 24 04 2b 4b 00 	movl   $0x4b2b,0x4(%esp)
     dfe:	00 
     dff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e06:	e8 fa 33 00 00       	call   4205 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e1d:	c7 44 24 04 33 4b 00 	movl   $0x4b33,0x4(%esp)
     e24:	00 
     e25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2c:	e8 d4 33 00 00       	call   4205 <printf>

  unlink("sharedfd");
     e31:	c7 04 24 42 4b 00 00 	movl   $0x4b42,(%esp)
     e38:	e8 db 31 00 00       	call   4018 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e3d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e44:	00 
     e45:	c7 04 24 42 4b 00 00 	movl   $0x4b42,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5a:	c7 44 24 04 4c 4b 00 	movl   $0x4b4c,0x4(%esp)
     e61:	00 
     e62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e69:	e8 97 33 00 00       	call   4205 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	c7 44 24 04 78 4b 00 	movl   $0x4b78,0x4(%esp)
     ed3:	00 
     ed4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edb:	e8 25 33 00 00       	call   4205 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f10:	00 
     f11:	c7 04 24 42 4b 00 00 	movl   $0x4b42,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f26:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
     f2d:	00 
     f2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f35:	e8 cb 32 00 00       	call   4205 <printf>
    return;
  ...
  unlink("sharedfd");
     fb2:	c7 04 24 42 4b 00 00 	movl   $0x4b42,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd0:	c7 44 24 04 c3 4b 00 	movl   $0x4bc3,0x4(%esp)
     fd7:	00 
     fd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdf:	e8 21 32 00 00       	call   4205 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ff4:	c7 44 24 04 d0 4b 00 	movl   $0x4bd0,0x4(%esp)
     ffb:	00 
     ffc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1003:	e8 fd 31 00 00       	call   4205 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    101b:	bb 4c 4c 00 00       	mov    $0x4c4c,%ebx
  ...
  printf(1, "fourfiles test\n");
    102d:	c7 44 24 04 e5 4b 00 	movl   $0x4be5,0x4(%esp)
    1034:	00 
    1035:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103c:	e8 c4 31 00 00       	call   4205 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106e:	79 19                	jns    1089 <fourfiles+0x7a>
      printf(1, "fork failed\n");
    1070:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    1077:	00 
    1078:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    107f:	e8 81 31 00 00       	call   4205 <printf>
      exit();
    ...
    10af:	c7 44 24 04 f5 4b 00 	movl   $0x4bf5,0x4(%esp)
    10b6:	00 
    10b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10be:	e8 42 31 00 00       	call   4205 <printf>
        exit();
    ...
    111d:	c7 44 24 04 04 4c 00 	movl   $0x4c04,0x4(%esp)
    1124:	00 
    1125:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    112c:	e8 d4 30 00 00       	call   4205 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11bb:	74 19                	je     11d6 <fourfiles+0x1c7>
          printf(1, "wrong char\n");
    11bd:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    11c4:	00 
    11c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11cc:	e8 34 30 00 00       	call   4205 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1226:	c7 44 24 04 21 4c 00 	movl   $0x4c21,0x4(%esp)
    122d:	00 
    122e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1235:	e8 cb 2f 00 00       	call   4205 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1257:	c7 44 24 04 32 4c 00 	movl   $0x4c32,0x4(%esp)
    125e:	00 
    125f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1266:	e8 9a 2f 00 00       	call   4205 <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1279:	c7 44 24 04 5c 4c 00 	movl   $0x4c5c,0x4(%esp)
    1280:	00 
    1281:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1288:	e8 78 2f 00 00       	call   4205 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12a5:	79 19                	jns    12c0 <createdelete+0x4d>
      printf(1, "fork failed\n");
    12a7:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    12ae:	00 
    12af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b6:	e8 4a 2f 00 00       	call   4205 <printf>
      exit();
    ...
    1306:	79 19                	jns    1321 <createdelete+0xae>
          printf(1, "create failed\n");
    1308:	c7 44 24 04 f5 4b 00 	movl   $0x4bf5,0x4(%esp)
    130f:	00 
    1310:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1317:	e8 e9 2e 00 00       	call   4205 <printf>
          exit();
    ...
    135d:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
    1364:	00 
    1365:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    136c:	e8 94 2e 00 00       	call   4205 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1415:	c7 44 24 04 70 4c 00 	movl   $0x4c70,0x4(%esp)
    141c:	00 
    141d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1424:	e8 dc 2d 00 00       	call   4205 <printf>
        exit();
    ...
    1447:	c7 44 24 04 94 4c 00 	movl   $0x4c94,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 aa 2d 00 00       	call   4205 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14cc:	c7 44 24 04 b4 4c 00 	movl   $0x4cb4,0x4(%esp)
    14d3:	00 
    14d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14db:	e8 25 2d 00 00       	call   4205 <printf>
}
    14e0:	c9                   	leave  
    14e1:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14e8:	c7 44 24 04 c5 4c 00 	movl   $0x4cc5,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f7:	e8 09 2d 00 00       	call   4205 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    14fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1503:	00 
    1504:	c7 04 24 d6 4c 00 00 	movl   $0x4cd6,(%esp)
  ...
  if(fd < 0){
    ...
    1519:	c7 44 24 04 e1 4c 00 	movl   $0x4ce1,0x4(%esp)
    1520:	00 
    1521:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1528:	e8 d8 2c 00 00       	call   4205 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1539:	00 
    153a:	c7 44 24 04 fb 4c 00 	movl   $0x4cfb,0x4(%esp)
    1541:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    155f:	00 
    1560:	c7 04 24 d6 4c 00 00 	movl   $0x4cd6,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1614:	c7 44 24 04 37 4d 00 	movl   $0x4d37,0x4(%esp)
    161b:	00 
    161c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1623:	e8 dd 2b 00 00       	call   4205 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1636:	c7 44 24 04 4e 4d 00 	movl   $0x4d4e,0x4(%esp)
    163d:	00 
    163e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1645:	e8 bb 2b 00 00       	call   4205 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    166f:	c7 44 24 04 65 4d 00 	movl   $0x4d65,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 82 2b 00 00       	call   4205 <printf>
    exit();
  ...
  unlink("unlinkread");
    1693:	c7 04 24 d6 4c 00 00 	movl   $0x4cd6,(%esp)
    169a:	e8 79 29 00 00       	call   4018 <unlink>
  printf(1, "unlinkread ok\n");
    169f:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    16a6:	00 
    16a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ae:	e8 52 2b 00 00       	call   4205 <printf>
}
    16b3:	c9                   	leave  
    16b4:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16bb:	c7 44 24 04 8d 4d 00 	movl   $0x4d8d,0x4(%esp)
    16c2:	00 
    16c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16ca:	e8 36 2b 00 00       	call   4205 <printf>

  unlink("lf1");
    16cf:	c7 04 24 97 4d 00 00 	movl   $0x4d97,(%esp)
    16d6:	e8 3d 29 00 00       	call   4018 <unlink>
  unlink("lf2");
    16db:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
    16e2:	e8 31 29 00 00       	call   4018 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16e7:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    16ee:	00 
    16ef:	c7 04 24 97 4d 00 00 	movl   $0x4d97,(%esp)
  ...
  if(fd < 0){
    ...
    1704:	c7 44 24 04 9f 4d 00 	movl   $0x4d9f,0x4(%esp)
    170b:	00 
    170c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1713:	e8 ed 2a 00 00       	call   4205 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1724:	00 
    1725:	c7 44 24 04 fb 4c 00 	movl   $0x4cfb,0x4(%esp)
    172c:	00 
    ...
    173d:	c7 44 24 04 b2 4d 00 	movl   $0x4db2,0x4(%esp)
    1744:	00 
    1745:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    174c:	e8 b4 2a 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
  ...
  if(fd < 0){
    ...
    17ec:	c7 44 24 04 01 4e 00 	movl   $0x4e01,0x4(%esp)
    17f3:	00 
    17f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17fb:	e8 05 2a 00 00       	call   4205 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1825:	c7 44 24 04 12 4e 00 	movl   $0x4e12,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1834:	e8 cc 29 00 00       	call   4205 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1849:	c7 44 24 04 9b 4d 00 	movl   $0x4d9b,0x4(%esp)
    1850:	00 
    1851:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
    1858:	e8 cb 27 00 00       	call   4028 <link>
    185d:	85 c0                	test   %eax,%eax
    185f:	78 19                	js     187a <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1861:	c7 44 24 04 23 4e 00 	movl   $0x4e23,0x4(%esp)
    1868:	00 
    1869:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1870:	e8 90 29 00 00       	call   4205 <printf>
    exit();
    1875:	e8 4e 27 00 00       	call   3fc8 <exit>
  }

  unlink("lf2");
    187a:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
    1881:	e8 92 27 00 00       	call   4018 <unlink>
  if(link("lf2", "lf1") >= 0){
    1886:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    188d:	00 
    188e:	c7 04 24 9b 4d 00 00 	movl   $0x4d9b,(%esp)
    1895:	e8 8e 27 00 00       	call   4028 <link>
    189a:	85 c0                	test   %eax,%eax
    189c:	78 19                	js     18b7 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    189e:	c7 44 24 04 44 4e 00 	movl   $0x4e44,0x4(%esp)
    18a5:	00 
    18a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18ad:	e8 53 29 00 00       	call   4205 <printf>
    exit();
    18b2:	e8 11 27 00 00       	call   3fc8 <exit>
  }

  if(link(".", "lf1") >= 0){
    18b7:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    18be:	00 
    18bf:	c7 04 24 67 4e 00 00 	movl   $0x4e67,(%esp)
    18c6:	e8 5d 27 00 00       	call   4028 <link>
    18cb:	85 c0                	test   %eax,%eax
    18cd:	78 19                	js     18e8 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18cf:	c7 44 24 04 69 4e 00 	movl   $0x4e69,0x4(%esp)
    18d6:	00 
    18d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18de:	e8 22 29 00 00       	call   4205 <printf>
    exit();
    18e3:	e8 e0 26 00 00       	call   3fc8 <exit>
  }

  printf(1, "linktest ok\n");
    18e8:	c7 44 24 04 85 4e 00 	movl   $0x4e85,0x4(%esp)
    18ef:	00 
    18f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f7:	e8 09 29 00 00       	call   4205 <printf>
}
    18fc:	c9                   	leave  
    18fd:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1904:	c7 44 24 04 92 4e 00 	movl   $0x4e92,0x4(%esp)
    190b:	00 
    190c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1913:	e8 ed 28 00 00       	call   4205 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1967:	c7 04 24 a2 4e 00 00 	movl   $0x4ea2,(%esp)
    ...
    1994:	c7 04 24 a2 4e 00 00 	movl   $0x4ea2,(%esp)
    ...
    19c5:	c7 44 24 04 a5 4e 00 	movl   $0x4ea5,0x4(%esp)
    19cc:	00 
    19cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19d4:	e8 2c 28 00 00       	call   4205 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a28:	00 
    1a29:	c7 04 24 67 4e 00 00 	movl   $0x4e67,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1a87:	c7 44 24 04 c1 4e 00 	movl   $0x4ec1,0x4(%esp)
    1a8e:	00 
    1a8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a96:	e8 6a 27 00 00       	call   4205 <printf>
        exit();
    ...
    1ab8:	c7 44 24 04 da 4e 00 	movl   $0x4eda,0x4(%esp)
    1abf:	00 
    1ac0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ac7:	e8 39 27 00 00       	call   4205 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b12:	c7 44 24 04 f8 4e 00 	movl   $0x4ef8,0x4(%esp)
    1b19:	00 
    1b1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b21:	e8 df 26 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b4c:	79 19                	jns    1b67 <concreate+0x269>
      printf(1, "fork failed\n");
    1b4e:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    1b55:	00 
    1b56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b5d:	e8 a3 26 00 00       	call   4205 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1c4d:	c7 44 24 04 29 4f 00 	movl   $0x4f29,0x4(%esp)
    1c54:	00 
    1c55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c5c:	e8 a4 25 00 00       	call   4205 <printf>
}
    1c61:	c9                   	leave  
    1c62:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1c69:	c7 44 24 04 37 4f 00 	movl   $0x4f37,0x4(%esp)
    1c70:	00 
    1c71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c78:	e8 88 25 00 00       	call   4205 <printf>

  unlink("x");
    1c7d:	c7 04 24 a3 4a 00 00 	movl   $0x4aa3,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1c97:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    1c9e:	00 
    1c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca6:	e8 5a 25 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d24:	00 
    1d25:	c7 04 24 a3 4a 00 00 	movl   $0x4aa3,(%esp)
    ...
    1d4f:	75 16                	jne    1d67 <linkunlink+0x104>
      link("cat", "x");
    1d51:	c7 44 24 04 a3 4a 00 	movl   $0x4aa3,0x4(%esp)
    1d58:	00 
    1d59:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
    1d60:	e8 c3 22 00 00       	call   4028 <link>
    1d65:	eb 0c                	jmp    1d73 <linkunlink+0x110>
    } else {
      unlink("x");
    1d67:	c7 04 24 a3 4a 00 00 	movl   $0x4aa3,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d92:	c7 44 24 04 4c 4f 00 	movl   $0x4f4c,0x4(%esp)
    1d99:	00 
    1d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da1:	e8 5f 24 00 00       	call   4205 <printf>
}
    1da6:	c9                   	leave  
    1da7:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dae:	c7 44 24 04 5b 4f 00 	movl   $0x4f5b,0x4(%esp)
    1db5:	00 
    1db6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dbd:	e8 43 24 00 00       	call   4205 <printf>
  unlink("bd");
    1dc2:	c7 04 24 68 4f 00 00 	movl   $0x4f68,(%esp)
    1dc9:	e8 4a 22 00 00       	call   4018 <unlink>

  fd = open("bd", O_CREATE);
    1dce:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1dd5:	00 
    1dd6:	c7 04 24 68 4f 00 00 	movl   $0x4f68,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 6b 4f 00 	movl   $0x4f6b,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 06 24 00 00       	call   4205 <printf>
    exit();
  ...
  unlink("bd");
    1e86:	c7 04 24 68 4f 00 00 	movl   $0x4f68,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1edc:	c7 44 24 04 95 4f 00 	movl   $0x4f95,0x4(%esp)
    1ee3:	00 
    1ee4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eeb:	e8 15 23 00 00       	call   4205 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f01:	c7 44 24 04 aa 4f 00 	movl   $0x4faa,0x4(%esp)
    1f08:	00 
    1f09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f10:	e8 f0 22 00 00       	call   4205 <printf>
}
    1f15:	c9                   	leave  
    1f16:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f1d:	c7 44 24 04 b5 4f 00 	movl   $0x4fb5,0x4(%esp)
    1f24:	00 
    1f25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f2c:	e8 d4 22 00 00       	call   4205 <printf>

  unlink("ff");
    1f31:	c7 04 24 c2 4f 00 00 	movl   $0x4fc2,(%esp)
    1f38:	e8 db 20 00 00       	call   4018 <unlink>
  if(mkdir("dd") != 0){
    1f3d:	c7 04 24 c5 4f 00 00 	movl   $0x4fc5,(%esp)
    1f44:	e8 e7 20 00 00       	call   4030 <mkdir>
    1f49:	85 c0                	test   %eax,%eax
    1f4b:	74 19                	je     1f66 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f4d:	c7 44 24 04 c8 4f 00 	movl   $0x4fc8,0x4(%esp)
    1f54:	00 
    1f55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5c:	e8 a4 22 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f6d:	00 
    1f6e:	c7 04 24 e0 4f 00 00 	movl   $0x4fe0,(%esp)
  ...
  if(fd < 0){
    ...
    1f83:	c7 44 24 04 e6 4f 00 	movl   $0x4fe6,0x4(%esp)
    1f8a:	00 
    1f8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f92:	e8 6e 22 00 00       	call   4205 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1fa3:	00 
    1fa4:	c7 44 24 04 c2 4f 00 	movl   $0x4fc2,0x4(%esp)
    1fab:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    201b:	00 
    201c:	c7 04 24 44 50 00 00 	movl   $0x5044,(%esp)
  ...
  if(fd < 0){
    ...
    2031:	c7 44 24 04 4d 50 00 	movl   $0x504d,0x4(%esp)
    2038:	00 
    2039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2040:	e8 c0 21 00 00       	call   4205 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    2051:	00 
    2052:	c7 44 24 04 65 50 00 	movl   $0x5065,0x4(%esp)
    2059:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2077:	00 
    2078:	c7 04 24 68 50 00 00 	movl   $0x5068,(%esp)
  ...
  if(fd < 0){
    ...
    208d:	c7 44 24 04 74 50 00 	movl   $0x5074,0x4(%esp)
    2094:	00 
    2095:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    209c:	e8 64 21 00 00       	call   4205 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    20d3:	c7 44 24 04 8d 50 00 	movl   $0x508d,0x4(%esp)
    20da:	00 
    20db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20e2:	e8 1e 21 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    222d:	00 
    222e:	c7 04 24 a8 50 00 00 	movl   $0x50a8,(%esp)
  ...
  if(fd < 0){
    ...
    2243:	c7 44 24 04 72 51 00 	movl   $0x5172,0x4(%esp)
    224a:	00 
    224b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2252:	e8 ae 1f 00 00       	call   4205 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    227c:	c7 44 24 04 8a 51 00 	movl   $0x518a,0x4(%esp)
    2283:	00 
    2284:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228b:	e8 75 1f 00 00       	call   4205 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2661:	c7 44 24 04 04 54 00 	movl   $0x5404,0x4(%esp)
    2668:	00 
    2669:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2670:	e8 90 1b 00 00       	call   4205 <printf>

  unlink("bigwrite");
    2675:	c7 04 24 13 54 00 00 	movl   $0x5413,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2694:	00 
    2695:	c7 04 24 13 54 00 00 	movl   $0x5413,(%esp)
    ...
    26aa:	c7 44 24 04 1c 54 00 	movl   $0x541c,0x4(%esp)
    26b1:	00 
    26b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b9:	e8 47 1b 00 00       	call   4205 <printf>
      exit();
    ...
    26ff:	c7 44 24 04 34 54 00 	movl   $0x5434,0x4(%esp)
    2706:	00 
    2707:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270e:	e8 f2 1a 00 00       	call   4205 <printf>
        exit();
    ...
    unlink("bigwrite");
    272c:	c7 04 24 13 54 00 00 	movl   $0x5413,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    274c:	c7 44 24 04 46 54 00 	movl   $0x5446,0x4(%esp)
    2753:	00 
    2754:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275b:	e8 a5 1a 00 00       	call   4205 <printf>
}
    2760:	c9                   	leave  
    2761:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2768:	c7 44 24 04 53 54 00 	movl   $0x5453,0x4(%esp)
    276f:	00 
    2770:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2777:	e8 89 1a 00 00       	call   4205 <printf>

  unlink("bigfile");
    277c:	c7 04 24 61 54 00 00 	movl   $0x5461,(%esp)
    2783:	e8 90 18 00 00       	call   4018 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2788:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    278f:	00 
    2790:	c7 04 24 61 54 00 00 	movl   $0x5461,(%esp)
  ...
  if(fd < 0){
    ...
    27a5:	c7 44 24 04 69 54 00 	movl   $0x5469,0x4(%esp)
    27ac:	00 
    27ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27b4:	e8 4c 1a 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2804:	c7 44 24 04 7f 54 00 	movl   $0x547f,0x4(%esp)
    280b:	00 
    280c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2813:	e8 ed 19 00 00       	call   4205 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    2838:	00 
    2839:	c7 04 24 61 54 00 00 	movl   $0x5461,(%esp)
  ...
  if(fd < 0){
    ...
    284e:	c7 44 24 04 95 54 00 	movl   $0x5495,0x4(%esp)
    2855:	00 
    2856:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    285d:	e8 a3 19 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2899:	c7 44 24 04 aa 54 00 	movl   $0x54aa,0x4(%esp)
    28a0:	00 
    28a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28a8:	e8 58 19 00 00       	call   4205 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    28dc:	c7 44 24 04 bf 54 00 	movl   $0x54bf,0x4(%esp)
    28e3:	00 
    28e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28eb:	e8 15 19 00 00       	call   4205 <printf>
      exit();
    ...
    2923:	74 19                	je     293e <bigfile+0x1dc>
      printf(1, "read bigfile wrong data\n");
    2925:	c7 44 24 04 d3 54 00 	movl   $0x54d3,0x4(%esp)
    292c:	00 
    292d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2934:	e8 cc 18 00 00       	call   4205 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    294c:	c7 44 24 04 ec 54 00 	movl   $0x54ec,0x4(%esp)
    2953:	00 
    2954:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    295b:	e8 a5 18 00 00       	call   4205 <printf>
    exit();
    2960:	e8 63 16 00 00       	call   3fc8 <exit>
  }
  unlink("bigfile");
    2965:	c7 04 24 61 54 00 00 	movl   $0x5461,(%esp)
    296c:	e8 a7 16 00 00       	call   4018 <unlink>

  printf(1, "bigfile test ok\n");
    2971:	c7 44 24 04 06 55 00 	movl   $0x5506,0x4(%esp)
    2978:	00 
    2979:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2980:	e8 80 18 00 00       	call   4205 <printf>
}
    2985:	c9                   	leave  
    2986:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29fa:	00 
    29fb:	c7 04 24 a4 55 00 00 	movl   $0x55a4,(%esp)
  ...
  if(fd < 0){
    ...
    2a10:	c7 44 24 04 d4 55 00 	movl   $0x55d4,0x4(%esp)
    2a17:	00 
    2a18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a1f:	e8 e1 17 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a3b:	00 
    2a3c:	c7 04 24 14 56 00 00 	movl   $0x5614,(%esp)
  ...
  if(fd < 0){
    ...
    2a51:	c7 44 24 04 44 56 00 	movl   $0x5644,0x4(%esp)
    2a58:	00 
    2a59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a60:	e8 a0 17 00 00       	call   4205 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2c5b:	c7 44 24 04 db 57 00 	movl   $0x57db,0x4(%esp)
    2c62:	00 
    2c63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6a:	e8 96 15 00 00       	call   4205 <printf>

  fd = open("dirfile", O_CREATE);
    2c6f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2c76:	00 
    2c77:	c7 04 24 e8 57 00 00 	movl   $0x57e8,(%esp)
  ...
  if(fd < 0){
    ...
    2c8c:	c7 44 24 04 f0 57 00 	movl   $0x57f0,0x4(%esp)
    2c93:	00 
    2c94:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9b:	e8 65 15 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce0:	00 
    2ce1:	c7 04 24 21 58 00 00 	movl   $0x5821,(%esp)
  ...
  if(fd >= 0){
    ...
    2cf6:	c7 44 24 04 2c 58 00 	movl   $0x582c,0x4(%esp)
    2cfd:	00 
    2cfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d05:	e8 fb 14 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d16:	00 
    2d17:	c7 04 24 21 58 00 00 	movl   $0x5821,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2df8:	00 
    2df9:	c7 04 24 67 4e 00 00 	movl   $0x4e67,(%esp)
  ...
  if(fd >= 0){
    ...
    2e0e:	c7 44 24 04 c4 58 00 	movl   $0x58c4,0x4(%esp)
    2e15:	00 
    2e16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e1d:	e8 e3 13 00 00       	call   4205 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2e5d:	c7 44 24 04 e3 58 00 	movl   $0x58e3,0x4(%esp)
    2e64:	00 
    2e65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6c:	e8 94 13 00 00       	call   4205 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2e81:	c7 44 24 04 f7 58 00 	movl   $0x58f7,0x4(%esp)
    2e88:	00 
    2e89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e90:	e8 70 13 00 00       	call   4205 <printf>
}
    2e95:	c9                   	leave  
    2e96:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2e9d:	c7 44 24 04 07 59 00 	movl   $0x5907,0x4(%esp)
    2ea4:	00 
    2ea5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2eac:	e8 54 13 00 00       	call   4205 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f5e:	00 
    2f5f:	c7 04 24 47 59 00 00 	movl   $0x5947,(%esp)
    ...
    unlink("xx");
    2f7f:	c7 04 24 47 59 00 00 	movl   $0x5947,(%esp)
  ...
  chdir("/");
    2f98:	c7 04 24 3e 46 00 00 	movl   $0x463e,(%esp)
    2f9f:	e8 94 10 00 00       	call   4038 <chdir>
  printf(1, "empty file name OK\n");
    2fa4:	c7 44 24 04 4a 59 00 	movl   $0x594a,0x4(%esp)
    2fab:	00 
    2fac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fb3:	e8 4d 12 00 00       	call   4205 <printf>
}
    2fb8:	c9                   	leave  
    2fb9:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2fc0:	c7 44 24 04 5e 59 00 	movl   $0x595e,0x4(%esp)
    2fc7:	00 
    2fc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fcf:	e8 31 12 00 00       	call   4205 <printf>
    ...
    2ff3:	e8 d0 0f 00 00       	call   3fc8 <exit>
{
  ...
  if(n == 1000){
    ...
    300d:	c7 44 24 04 6c 59 00 	movl   $0x596c,0x4(%esp)
    3014:	00 
    3015:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    301c:	e8 e4 11 00 00       	call   4205 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3031:	c7 44 24 04 8e 59 00 	movl   $0x598e,0x4(%esp)
    3038:	00 
    3039:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3040:	e8 c0 11 00 00       	call   4205 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    305d:	c7 44 24 04 a2 59 00 	movl   $0x59a2,0x4(%esp)
    3064:	00 
    3065:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    306c:	e8 94 11 00 00       	call   4205 <printf>
    exit();
    3071:	e8 52 0f 00 00       	call   3fc8 <exit>
  }

  printf(1, "fork test OK\n");
    3076:	c7 44 24 04 b5 59 00 	movl   $0x59b5,0x4(%esp)
    307d:	00 
    307e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3085:	e8 7b 11 00 00       	call   4205 <printf>
}
    308a:	c9                   	leave  
    308b:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3096:	a1 4c 65 00 00       	mov    0x654c,%eax
    309b:	c7 44 24 04 c3 59 00 	movl   $0x59c3,0x4(%esp)
    30a2:	00 
    30a3:	89 04 24             	mov    %eax,(%esp)
    30a6:	e8 5a 11 00 00       	call   4205 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    30e9:	a1 4c 65 00 00       	mov    0x654c,%eax
    ...
    3103:	c7 44 24 04 ce 59 00 	movl   $0x59ce,0x4(%esp)
    310a:	00 
    310b:	89 04 24             	mov    %eax,(%esp)
    310e:	e8 f2 10 00 00       	call   4205 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    313f:	a1 4c 65 00 00       	mov    0x654c,%eax
    3144:	c7 44 24 04 e9 59 00 	movl   $0x59e9,0x4(%esp)
    314b:	00 
    314c:	89 04 24             	mov    %eax,(%esp)
    314f:	e8 b1 10 00 00       	call   4205 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3180:	a1 4c 65 00 00       	mov    0x654c,%eax
    3185:	c7 44 24 04 00 5a 00 	movl   $0x5a00,0x4(%esp)
    318c:	00 
    318d:	89 04 24             	mov    %eax,(%esp)
    3190:	e8 70 10 00 00       	call   4205 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    31de:	a1 4c 65 00 00       	mov    0x654c,%eax
    31e3:	c7 44 24 04 1c 5a 00 	movl   $0x5a1c,0x4(%esp)
    31ea:	00 
    31eb:	89 04 24             	mov    %eax,(%esp)
    31ee:	e8 12 10 00 00       	call   4205 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3229:	a1 4c 65 00 00       	mov    0x654c,%eax
    322e:	c7 44 24 04 5a 5a 00 	movl   $0x5a5a,0x4(%esp)
    3235:	00 
    3236:	89 04 24             	mov    %eax,(%esp)
    3239:	e8 c7 0f 00 00       	call   4205 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    325f:	a1 4c 65 00 00       	mov    0x654c,%eax
    ...
    3272:	c7 44 24 04 78 5a 00 	movl   $0x5a78,0x4(%esp)
    3279:	00 
    327a:	89 04 24             	mov    %eax,(%esp)
    327d:	e8 83 0f 00 00       	call   4205 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    32c6:	a1 4c 65 00 00       	mov    0x654c,%eax
    ...
    32d9:	c7 44 24 04 b0 5a 00 	movl   $0x5ab0,0x4(%esp)
    32e0:	00 
    32e1:	89 04 24             	mov    %eax,(%esp)
    32e4:	e8 1c 0f 00 00       	call   4205 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    32f7:	a1 4c 65 00 00       	mov    0x654c,%eax
    32fc:	c7 44 24 04 d8 5a 00 	movl   $0x5ad8,0x4(%esp)
    3303:	00 
    3304:	89 04 24             	mov    %eax,(%esp)
    3307:	e8 f9 0e 00 00       	call   4205 <printf>
    exit();
  ...
  if(c != a){
    ...
    3346:	a1 4c 65 00 00       	mov    0x654c,%eax
    ...
    3359:	c7 44 24 04 08 5b 00 	movl   $0x5b08,0x4(%esp)
    3360:	00 
    3361:	89 04 24             	mov    %eax,(%esp)
    3364:	e8 9c 0e 00 00       	call   4205 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    338b:	79 1a                	jns    33a7 <sbrktest+0x31b>
      printf(stdout, "fork failed\n");
    338d:	a1 4c 65 00 00       	mov    0x654c,%eax
    3392:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    3399:	00 
    339a:	89 04 24             	mov    %eax,(%esp)
    339d:	e8 63 0e 00 00       	call   4205 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    340d:	c7 44 24 04 3e 4a 00 	movl   $0x4a3e,0x4(%esp)
    3414:	00 
    3415:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    341c:	e8 e4 0d 00 00       	call   4205 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3470:	00 
    3471:	c7 44 24 04 a3 4a 00 	movl   $0x4aa3,0x4(%esp)
    3478:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    350f:	a1 4c 65 00 00       	mov    0x654c,%eax
    3514:	c7 44 24 04 42 5b 00 	movl   $0x5b42,0x4(%esp)
    351b:	00 
    351c:	89 04 24             	mov    %eax,(%esp)
    351f:	e8 e1 0c 00 00       	call   4205 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3555:	a1 4c 65 00 00       	mov    0x654c,%eax
    355a:	c7 44 24 04 5d 5b 00 	movl   $0x5b5d,0x4(%esp)
    3561:	00 
    3562:	89 04 24             	mov    %eax,(%esp)
    3565:	e8 9b 0c 00 00       	call   4205 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    359b:	a1 4c 65 00 00       	mov    0x654c,%eax
    35a0:	c7 44 24 04 6b 5b 00 	movl   $0x5b6b,0x4(%esp)
    35a7:	00 
    35a8:	89 04 24             	mov    %eax,(%esp)
    35ab:	e8 55 0c 00 00       	call   4205 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    360d:	c7 04 24 7a 5b 00 00 	movl   $0x5b7a,(%esp)
    3614:	e8 0f 0a 00 00       	call   4028 <link>
    3619:	83 f8 ff             	cmp    $0xffffffff,%eax
    361c:	74 1a                	je     3638 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    361e:	a1 4c 65 00 00       	mov    0x654c,%eax
    3623:	c7 44 24 04 85 5b 00 	movl   $0x5b85,0x4(%esp)
    362a:	00 
    362b:	89 04 24             	mov    %eax,(%esp)
    362e:	e8 d2 0b 00 00       	call   4205 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    364b:	a1 4c 65 00 00       	mov    0x654c,%eax
    3650:	c7 44 24 04 9e 5b 00 	movl   $0x5b9e,0x4(%esp)
    3657:	00 
    3658:	89 04 24             	mov    %eax,(%esp)
    365b:	e8 a5 0b 00 00       	call   4205 <printf>
}
    3660:	c9                   	leave  
    3661:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3668:	a1 4c 65 00 00       	mov    0x654c,%eax
    366d:	c7 44 24 04 ab 5b 00 	movl   $0x5bab,0x4(%esp)
    3674:	00 
    3675:	89 04 24             	mov    %eax,(%esp)
    3678:	e8 88 0b 00 00       	call   4205 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3694:	a1 4c 65 00 00       	mov    0x654c,%eax
    3699:	c7 44 24 04 b5 5b 00 	movl   $0x5bb5,0x4(%esp)
    36a0:	00 
    36a1:	89 04 24             	mov    %eax,(%esp)
    36a4:	e8 5c 0b 00 00       	call   4205 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    36bb:	a1 4c 65 00 00       	mov    0x654c,%eax
    36c0:	c7 44 24 04 c6 5b 00 	movl   $0x5bc6,0x4(%esp)
    36c7:	00 
    36c8:	89 04 24             	mov    %eax,(%esp)
    36cb:	e8 35 0b 00 00       	call   4205 <printf>
}
    36d0:	c9                   	leave  
    36d1:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    36d8:	c7 04 24 d3 5b 00 00 	movl   $0x5bd3,(%esp)
  ...
  if(pid == 0){
    ...
    3702:	c7 04 85 80 65 00 00 	movl   $0x5be0,0x6580(,%eax,4)
    3709:	e0 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3720:	a1 4c 65 00 00       	mov    0x654c,%eax
    3725:	c7 44 24 04 bd 5c 00 	movl   $0x5cbd,0x4(%esp)
    372c:	00 
    372d:	89 04 24             	mov    %eax,(%esp)
    3730:	e8 d0 0a 00 00       	call   4205 <printf>
    exec("echo", args);
    3735:	c7 44 24 04 80 65 00 	movl   $0x6580,0x4(%esp)
    373c:	00 
    373d:	c7 04 24 cc 45 00 00 	movl   $0x45cc,(%esp)
    3744:	e8 b7 08 00 00       	call   4000 <exec>
    printf(stdout, "bigarg test ok\n");
    3749:	a1 4c 65 00 00       	mov    0x654c,%eax
    374e:	c7 44 24 04 ca 5c 00 	movl   $0x5cca,0x4(%esp)
    3755:	00 
    3756:	89 04 24             	mov    %eax,(%esp)
    3759:	e8 a7 0a 00 00       	call   4205 <printf>
    fd = open("bigarg-ok", O_CREATE);
    375e:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3765:	00 
    3766:	c7 04 24 d3 5b 00 00 	movl   $0x5bd3,(%esp)
    ...
    378b:	a1 4c 65 00 00       	mov    0x654c,%eax
    3790:	c7 44 24 04 da 5c 00 	movl   $0x5cda,0x4(%esp)
    3797:	00 
    3798:	89 04 24             	mov    %eax,(%esp)
    379b:	e8 65 0a 00 00       	call   4205 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    37b1:	00 
    37b2:	c7 04 24 d3 5b 00 00 	movl   $0x5bd3,(%esp)
  ...
  if(fd < 0){
    ...
    37c7:	a1 4c 65 00 00       	mov    0x654c,%eax
    37cc:	c7 44 24 04 f3 5c 00 	movl   $0x5cf3,0x4(%esp)
    37d3:	00 
    37d4:	89 04 24             	mov    %eax,(%esp)
    37d7:	e8 29 0a 00 00       	call   4205 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    37ec:	c7 04 24 d3 5b 00 00 	movl   $0x5bd3,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3808:	c7 44 24 04 08 5d 00 	movl   $0x5d08,0x4(%esp)
    380f:	00 
    3810:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3817:	e8 e9 09 00 00       	call   4205 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    390c:	c7 44 24 04 15 5d 00 	movl   $0x5d15,0x4(%esp)
    3913:	00 
    3914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    391b:	e8 e5 08 00 00       	call   4205 <printf>
    ...
    3943:	c7 44 24 04 21 5d 00 	movl   $0x5d21,0x4(%esp)
    394a:	00 
    394b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3952:	e8 ae 08 00 00       	call   4205 <printf>
      break;
    ...
    398f:	c7 44 24 04 31 5d 00 	movl   $0x5d31,0x4(%esp)
    3996:	00 
    3997:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399e:	e8 62 08 00 00       	call   4205 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3aca:	c7 44 24 04 41 5d 00 	movl   $0x5d41,0x4(%esp)
    3ad1:	00 
    3ad2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ad9:	e8 27 07 00 00       	call   4205 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3af4:	c7 44 24 04 57 5d 00 	movl   $0x5d57,0x4(%esp)
    3afb:	00 
    3afc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b03:	e8 fd 06 00 00       	call   4205 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b38:	c7 44 24 04 64 5d 00 	movl   $0x5d64,0x4(%esp)
    3b3f:	00 
    3b40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b47:	e8 b9 06 00 00       	call   4205 <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b57:	c7 44 24 04 6d 46 00 	movl   $0x466d,0x4(%esp)
    3b5e:	00 
    3b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b66:	e8 9a 06 00 00       	call   4205 <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3b75:	c7 44 24 04 85 5d 00 	movl   $0x5d85,0x4(%esp)
    3b7c:	00 
    3b7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b84:	e8 7c 06 00 00       	call   4205 <printf>
}
    3b89:	c9                   	leave  
    3b8a:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3b98:	00 
    3b99:	c7 04 24 94 5d 00 00 	movl   $0x5d94,(%esp)
  ...
  if (fd < 0) {
    ...
    3bae:	c7 44 24 04 99 5d 00 	movl   $0x5d99,0x4(%esp)
    3bb5:	00 
    3bb6:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bbd:	e8 43 06 00 00       	call   4205 <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3bf6:	c7 44 24 04 a6 5d 00 	movl   $0x5da6,0x4(%esp)
    3bfd:	00 
    3bfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c05:	e8 fb 05 00 00       	call   4205 <printf>
}
    3c0a:	c9                   	leave  
    3c0b:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c0f:	8b 15 50 65 00 00    	mov    0x6550,%edx
    ...
    3c4a:	a3 50 65 00 00       	mov    %eax,0x6550
  return randstate;
    3c4f:	a1 50 65 00 00       	mov    0x6550,%eax
}
    3c54:	5d                   	pop    %ebp
    3c55:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cab:	00 
    3cac:	c7 04 24 cb 5d 00 00 	movl   $0x5dcb,(%esp)
...
putc(int fd, char c)
{
    ...
    412b:	83 ec 18             	sub    $0x18,%esp
    412e:	8b 45 0c             	mov    0xc(%ebp),%eax
    4131:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    4134:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    413b:	00 
    413c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    413f:	89 44 24 04          	mov    %eax,0x4(%esp)
    4143:	8b 45 08             	mov    0x8(%ebp),%eax
    4146:	89 04 24             	mov    %eax,(%esp)
    4149:	e8 9a fe ff ff       	call   3fe8 <write>
}
    414e:	c9                   	leave  
    414f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    4158:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    415f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    4163:	74 17                	je     417c <printint+0x2c>
    4165:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4169:	79 11                	jns    417c <printint+0x2c>
    neg = 1;
    416b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    4172:	8b 45 0c             	mov    0xc(%ebp),%eax
    4175:	f7 d8                	neg    %eax
    4177:	89 45 ec             	mov    %eax,-0x14(%ebp)
    417a:	eb 06                	jmp    4182 <printint+0x32>
  } else {
    x = xx;
    417c:	8b 45 0c             	mov    0xc(%ebp),%eax
    417f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    4182:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4189:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    418c:	8d 41 01             	lea    0x1(%ecx),%eax
    418f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4192:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4195:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4198:	ba 00 00 00 00       	mov    $0x0,%edx
    419d:	f7 f3                	div    %ebx
    419f:	89 d0                	mov    %edx,%eax
    41a1:	8a 80 54 65 00 00    	mov    0x6554(%eax),%al
    41a7:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    41ab:	8b 75 10             	mov    0x10(%ebp),%esi
    41ae:	8b 45 ec             	mov    -0x14(%ebp),%eax
    41b1:	ba 00 00 00 00       	mov    $0x0,%edx
    41b6:	f7 f6                	div    %esi
    41b8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    41bb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41bf:	75 c8                	jne    4189 <printint+0x39>
  if(neg)
    41c1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    41c5:	74 10                	je     41d7 <printint+0x87>
    buf[i++] = '-';
    41c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41ca:	8d 50 01             	lea    0x1(%eax),%edx
    41cd:	89 55 f4             	mov    %edx,-0xc(%ebp)
    41d0:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    41d5:	eb 1e                	jmp    41f5 <printint+0xa5>
    41d7:	eb 1c                	jmp    41f5 <printint+0xa5>
    putc(fd, buf[i]);
    41d9:	8d 55 dc             	lea    -0x24(%ebp),%edx
    41dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41df:	01 d0                	add    %edx,%eax
    41e1:	8a 00                	mov    (%eax),%al
    41e3:	0f be c0             	movsbl %al,%eax
    41e6:	89 44 24 04          	mov    %eax,0x4(%esp)
    41ea:	8b 45 08             	mov    0x8(%ebp),%eax
    41ed:	89 04 24             	mov    %eax,(%esp)
    41f0:	e8 33 ff ff ff       	call   4128 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    41f5:	ff 4d f4             	decl   -0xc(%ebp)
    41f8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    41fc:	79 db                	jns    41d9 <printint+0x89>
    putc(fd, buf[i]);
}
    41fe:	83 c4 30             	add    $0x30,%esp
    4201:	5b                   	pop    %ebx
    4202:	5e                   	pop    %esi
    4203:	5d                   	pop    %ebp
    4204:	c3                   	ret    
...
{
    4205:	55                   	push   %ebp
    4206:	89 e5                	mov    %esp,%ebp
    4208:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
    4212:	8d 45 0c             	lea    0xc(%ebp),%eax
    4215:	83 c0 04             	add    $0x4,%eax
    4218:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    421b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4222:	e9 77 01 00 00       	jmp    439e <printf+0x199>
    c = fmt[i] & 0xff;
    4227:	8b 55 0c             	mov    0xc(%ebp),%edx
    422a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    422d:	01 d0                	add    %edx,%eax
    422f:	8a 00                	mov    (%eax),%al
    4231:	0f be c0             	movsbl %al,%eax
    4234:	25 ff 00 00 00       	and    $0xff,%eax
    4239:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    423c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4240:	75 2c                	jne    426e <printf+0x69>
      if(c == '%'){
    4242:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4246:	75 0c                	jne    4254 <printf+0x4f>
        state = '%';
    4248:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    424f:	e9 47 01 00 00       	jmp    439b <printf+0x196>
      } else {
        putc(fd, c);
    4254:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4257:	0f be c0             	movsbl %al,%eax
    425a:	89 44 24 04          	mov    %eax,0x4(%esp)
    425e:	8b 45 08             	mov    0x8(%ebp),%eax
    4261:	89 04 24             	mov    %eax,(%esp)
    4264:	e8 bf fe ff ff       	call   4128 <putc>
    4269:	e9 2d 01 00 00       	jmp    439b <printf+0x196>
      }
    } else if(state == '%'){
    426e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4272:	0f 85 23 01 00 00    	jne    439b <printf+0x196>
      if(c == 'd'){
    4278:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    427c:	75 2d                	jne    42ab <printf+0xa6>
        printint(fd, *ap, 10, 1);
    427e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4281:	8b 00                	mov    (%eax),%eax
    4283:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    428a:	00 
    428b:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4292:	00 
    4293:	89 44 24 04          	mov    %eax,0x4(%esp)
    4297:	8b 45 08             	mov    0x8(%ebp),%eax
    429a:	89 04 24             	mov    %eax,(%esp)
    429d:	e8 ae fe ff ff       	call   4150 <printint>
        ap++;
    42a2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42a6:	e9 e9 00 00 00       	jmp    4394 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
    42ab:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    42af:	74 06                	je     42b7 <printf+0xb2>
    42b1:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    42b5:	75 2d                	jne    42e4 <printf+0xdf>
        printint(fd, *ap, 16, 0);
    42b7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42ba:	8b 00                	mov    (%eax),%eax
    42bc:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    42c3:	00 
    42c4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    42cb:	00 
    42cc:	89 44 24 04          	mov    %eax,0x4(%esp)
    42d0:	8b 45 08             	mov    0x8(%ebp),%eax
    42d3:	89 04 24             	mov    %eax,(%esp)
    42d6:	e8 75 fe ff ff       	call   4150 <printint>
        ap++;
    42db:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42df:	e9 b0 00 00 00       	jmp    4394 <printf+0x18f>
      } else if(c == 's'){
    42e4:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    42e8:	75 42                	jne    432c <printf+0x127>
        s = (char*)*ap;
    42ea:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42ed:	8b 00                	mov    (%eax),%eax
    42ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    42f2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    42f6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    42fa:	75 09                	jne    4305 <printf+0x100>
          s = "(null)";
    42fc:	c7 45 f4 06 5e 00 00 	movl   $0x5e06,-0xc(%ebp)
        while(*s != 0){
    4303:	eb 1c                	jmp    4321 <printf+0x11c>
    4305:	eb 1a                	jmp    4321 <printf+0x11c>
          putc(fd, *s);
    4307:	8b 45 f4             	mov    -0xc(%ebp),%eax
    430a:	8a 00                	mov    (%eax),%al
    430c:	0f be c0             	movsbl %al,%eax
    430f:	89 44 24 04          	mov    %eax,0x4(%esp)
    4313:	8b 45 08             	mov    0x8(%ebp),%eax
    4316:	89 04 24             	mov    %eax,(%esp)
    4319:	e8 0a fe ff ff       	call   4128 <putc>
          s++;
    431e:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    4324:	8a 00                	mov    (%eax),%al
    4326:	84 c0                	test   %al,%al
    4328:	75 dd                	jne    4307 <printf+0x102>
    432a:	eb 68                	jmp    4394 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    432c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4330:	75 1d                	jne    434f <printf+0x14a>
        putc(fd, *ap);
    4332:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4335:	8b 00                	mov    (%eax),%eax
    4337:	0f be c0             	movsbl %al,%eax
    433a:	89 44 24 04          	mov    %eax,0x4(%esp)
    433e:	8b 45 08             	mov    0x8(%ebp),%eax
    4341:	89 04 24             	mov    %eax,(%esp)
    4344:	e8 df fd ff ff       	call   4128 <putc>
        ap++;
    4349:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    434d:	eb 45                	jmp    4394 <printf+0x18f>
      } else if(c == '%'){
    434f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4353:	75 17                	jne    436c <printf+0x167>
        putc(fd, c);
    4355:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4358:	0f be c0             	movsbl %al,%eax
    435b:	89 44 24 04          	mov    %eax,0x4(%esp)
    435f:	8b 45 08             	mov    0x8(%ebp),%eax
    4362:	89 04 24             	mov    %eax,(%esp)
    4365:	e8 be fd ff ff       	call   4128 <putc>
    436a:	eb 28                	jmp    4394 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    436c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4373:	00 
    4374:	8b 45 08             	mov    0x8(%ebp),%eax
    4377:	89 04 24             	mov    %eax,(%esp)
    437a:	e8 a9 fd ff ff       	call   4128 <putc>
        putc(fd, c);
    437f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4382:	0f be c0             	movsbl %al,%eax
    4385:	89 44 24 04          	mov    %eax,0x4(%esp)
    4389:	8b 45 08             	mov    0x8(%ebp),%eax
    438c:	89 04 24             	mov    %eax,(%esp)
    438f:	e8 94 fd ff ff       	call   4128 <putc>
      }
      state = 0;
    4394:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    439b:	ff 45 f0             	incl   -0x10(%ebp)
    439e:	8b 55 0c             	mov    0xc(%ebp),%edx
    43a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43a4:	01 d0                	add    %edx,%eax
    43a6:	8a 00                	mov    (%eax),%al
    43a8:	84 c0                	test   %al,%al
    43aa:	0f 85 77 fe ff ff    	jne    4227 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    43b7:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    43ba:	8b 45 08             	mov    0x8(%ebp),%eax
    43bd:	83 e8 08             	sub    $0x8,%eax
    43c0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    43c3:	a1 08 66 00 00       	mov    0x6608,%eax
    43c8:	89 45 fc             	mov    %eax,-0x4(%ebp)
    43cb:	eb 24                	jmp    43f1 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    43cd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d0:	8b 00                	mov    (%eax),%eax
    43d2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43d5:	77 12                	ja     43e9 <free+0x35>
    43d7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43da:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43dd:	77 24                	ja     4403 <free+0x4f>
    43df:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43e2:	8b 00                	mov    (%eax),%eax
    43e4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43e7:	77 1a                	ja     4403 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    43ee:	89 45 fc             	mov    %eax,-0x4(%ebp)
    43f1:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43f4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    43f7:	76 d4                	jbe    43cd <free+0x19>
    43f9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43fc:	8b 00                	mov    (%eax),%eax
    43fe:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4401:	76 ca                	jbe    43cd <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    4403:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4406:	8b 40 04             	mov    0x4(%eax),%eax
    4409:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4410:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4413:	01 c2                	add    %eax,%edx
    4415:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4418:	8b 00                	mov    (%eax),%eax
    441a:	39 c2                	cmp    %eax,%edx
    441c:	75 24                	jne    4442 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    441e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4421:	8b 50 04             	mov    0x4(%eax),%edx
    4424:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4427:	8b 00                	mov    (%eax),%eax
    ...
    4439:	8b 10                	mov    (%eax),%edx
    443b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    443e:	89 10                	mov    %edx,(%eax)
    4440:	eb 0a                	jmp    444c <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    4442:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4445:	8b 10                	mov    (%eax),%edx
    4447:	8b 45 f8             	mov    -0x8(%ebp),%eax
    444a:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    444c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    444f:	8b 40 04             	mov    0x4(%eax),%eax
    4452:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4459:	8b 45 fc             	mov    -0x4(%ebp),%eax
    445c:	01 d0                	add    %edx,%eax
    445e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4461:	75 20                	jne    4483 <free+0xcf>
    p->s.size += bp->s.size;
    4463:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4466:	8b 50 04             	mov    0x4(%eax),%edx
    4469:	8b 45 f8             	mov    -0x8(%ebp),%eax
    446c:	8b 40 04             	mov    0x4(%eax),%eax
    446f:	01 c2                	add    %eax,%edx
    4471:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4474:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4477:	8b 45 f8             	mov    -0x8(%ebp),%eax
    447a:	8b 10                	mov    (%eax),%edx
    447c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    447f:	89 10                	mov    %edx,(%eax)
    4481:	eb 08                	jmp    448b <free+0xd7>
  } else
    p->s.ptr = bp;
    4483:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4486:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4489:	89 10                	mov    %edx,(%eax)
  freep = p;
    448b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    448e:	a3 08 66 00 00       	mov    %eax,0x6608
}
    4493:	c9                   	leave  
    4494:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    4498:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    449b:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    44a2:	77 07                	ja     44ab <morecore+0x16>
    nu = 4096;
    44a4:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    44ab:	8b 45 08             	mov    0x8(%ebp),%eax
    44ae:	c1 e0 03             	shl    $0x3,%eax
    44b1:	89 04 24             	mov    %eax,(%esp)
    44b4:	e8 97 fb ff ff       	call   4050 <sbrk>
    44b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    44bc:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    44c0:	75 07                	jne    44c9 <morecore+0x34>
    return 0;
    44c2:	b8 00 00 00 00       	mov    $0x0,%eax
    44c7:	eb 22                	jmp    44eb <morecore+0x56>
  hp = (Header*)p;
    44c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44cc:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    44cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44d2:	8b 55 08             	mov    0x8(%ebp),%edx
    44d5:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    44d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44db:	83 c0 08             	add    $0x8,%eax
    44de:	89 04 24             	mov    %eax,(%esp)
    44e1:	e8 ce fe ff ff       	call   43b4 <free>
  return freep;
    44e6:	a1 08 66 00 00       	mov    0x6608,%eax
}
    44eb:	c9                   	leave  
    44ec:	c3                   	ret    
...
{
    44ed:	55                   	push   %ebp
    44ee:	89 e5                	mov    %esp,%ebp
    44f0:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    44f3:	8b 45 08             	mov    0x8(%ebp),%eax
    44f6:	83 c0 07             	add    $0x7,%eax
    44f9:	c1 e8 03             	shr    $0x3,%eax
    44fc:	40                   	inc    %eax
    44fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4500:	a1 08 66 00 00       	mov    0x6608,%eax
    4505:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4508:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    450c:	75 23                	jne    4531 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    450e:	c7 45 f0 00 66 00 00 	movl   $0x6600,-0x10(%ebp)
    4515:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4518:	a3 08 66 00 00       	mov    %eax,0x6608
    451d:	a1 08 66 00 00       	mov    0x6608,%eax
    4522:	a3 00 66 00 00       	mov    %eax,0x6600
    base.s.size = 0;
    4527:	c7 05 04 66 00 00 00 	movl   $0x0,0x6604
    452e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    453c:	8b 40 04             	mov    0x4(%eax),%eax
    453f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4542:	72 4d                	jb     4591 <malloc+0xa4>
      if(p->s.size == nunits)
    4544:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4547:	8b 40 04             	mov    0x4(%eax),%eax
    454a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    454d:	75 0c                	jne    455b <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    454f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4552:	8b 10                	mov    (%eax),%edx
    4554:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4557:	89 10                	mov    %edx,(%eax)
    4559:	eb 26                	jmp    4581 <malloc+0x94>
      else {
        p->s.size -= nunits;
    455b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    455e:	8b 40 04             	mov    0x4(%eax),%eax
    4561:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4564:	89 c2                	mov    %eax,%edx
    4566:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4569:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    456c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    456f:	8b 40 04             	mov    0x4(%eax),%eax
    4572:	c1 e0 03             	shl    $0x3,%eax
    4575:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4578:	8b 45 f4             	mov    -0xc(%ebp),%eax
    457b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    457e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4581:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4584:	a3 08 66 00 00       	mov    %eax,0x6608
      return (void*)(p + 1);
    4589:	8b 45 f4             	mov    -0xc(%ebp),%eax
    458c:	83 c0 08             	add    $0x8,%eax
    458f:	eb 38                	jmp    45c9 <malloc+0xdc>
    }
    if(p == freep)
    4591:	a1 08 66 00 00       	mov    0x6608,%eax
    4596:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4599:	75 1b                	jne    45b6 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    459b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    459e:	89 04 24             	mov    %eax,(%esp)
    45a1:	e8 ef fe ff ff       	call   4495 <morecore>
    45a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    45a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    45ad:	75 07                	jne    45b6 <malloc+0xc9>
        return 0;
    45af:	b8 00 00 00 00       	mov    $0x0,%eax
    45b4:	eb 13                	jmp    45c9 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    45b9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    45bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45bf:	8b 00                	mov    (%eax),%eax
    45c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    45c4:	e9 70 ff ff ff       	jmp    4539 <malloc+0x4c>
}
    45c9:	c9                   	leave  
    45ca:	c3                   	ret    
